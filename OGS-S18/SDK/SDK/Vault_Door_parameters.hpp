...
public:
	...
	struct FVector                                CallFunc_VLerp_ReturnValue_1;                      // 0x00DC(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FRotator                               CallFunc_RLerp_ReturnValue_1;                      // 0x00E8(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor)
	struct FHitResult                             CallFunc_K2_SetRelativeLocationAndRotation_SweepHitResult; // 0x00F4(0x0088)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
};
...
static_assert(sizeof(Vault_Door_C_ExecuteUbergraph_Vault_Door) == 0x000180, "Wrong size on Vault_Door_C_ExecuteUbergraph_Vault_Door");
...
static_assert(offsetof(Vault_Door_C_ExecuteUbergraph_Vault_Door, CallFunc_VLerp_ReturnValue_1) == 0x0000DC, "Member 'Vault_Door_C_ExecuteUbergraph_Vault_Door::CallFunc_VLerp_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Vault_Door_C_ExecuteUbergraph_Vault_Door, CallFunc_RLerp_ReturnValue_1) == 0x0000E8, "Member 'Vault_Door_C_ExecuteUbergraph_Vault_Door::CallFunc_RLerp_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Vault_Door_C_ExecuteUbergraph_Vault_Door, CallFunc_K2_SetRelativeLocationAndRotation_SweepHitResult) == 0x0000F4, "Member 'Vault_Door_C_ExecuteUbergraph_Vault_Door::CallFunc_K2_SetRelativeLocationAndRotation_SweepHitResult' has a wrong offset!");
