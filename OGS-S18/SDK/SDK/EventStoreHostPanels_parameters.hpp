...
public:
	...
	class UCommonButtonBase*                      CallFunc_GetTabButtonBaseByID_ReturnValue;         // 0x0028(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	EFortItemType                                 CallFunc_GetType_ReturnValue;                      // 0x0033(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_IsSchematic_ReturnValue;                  // 0x0036(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(offsetof(EventStoreHostPanels_C_Setup_Details_Panels, CallFunc_GetTabButtonBaseByID_ReturnValue) == 0x000028, "Member 'EventStoreHostPanels_C_Setup_Details_Panels::CallFunc_GetTabButtonBaseByID_ReturnValue' has a wrong offset!");
static_assert(offsetof(EventStoreHostPanels_C_Setup_Details_Panels, CallFunc_IsValid_ReturnValue) == 0x000030, "Member 'EventStoreHostPanels_C_Setup_Details_Panels::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(EventStoreHostPanels_C_Setup_Details_Panels, CallFunc_GetVisibility_ReturnValue) == 0x000031, "Member 'EventStoreHostPanels_C_Setup_Details_Panels::CallFunc_GetVisibility_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(EventStoreHostPanels_C_Setup_Details_Panels, CallFunc_GetType_ReturnValue) == 0x000033, "Member 'EventStoreHostPanels_C_Setup_Details_Panels::CallFunc_GetType_ReturnValue' has a wrong offset!");
static_assert(offsetof(EventStoreHostPanels_C_Setup_Details_Panels, K2Node_SwitchEnum_CmpSuccess) == 0x000034, "Member 'EventStoreHostPanels_C_Setup_Details_Panels::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(EventStoreHostPanels_C_Setup_Details_Panels, CallFunc_IsValid_ReturnValue_1) == 0x000035, "Member 'EventStoreHostPanels_C_Setup_Details_Panels::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(EventStoreHostPanels_C_Setup_Details_Panels, CallFunc_IsSchematic_ReturnValue) == 0x000036, "Member 'EventStoreHostPanels_C_Setup_Details_Panels::CallFunc_IsSchematic_ReturnValue' has a wrong offset!");
...
// Function EventStoreHostPanels.EventStoreHostPanels_C.BndEvt__DetailPanelTabList_K2Node_ComponentBoundEvent_0_OnTabButtonCreation__DelegateSignature
// 0x0010 (0x0010 - 0x0000)
struct EventStoreHostPanels_C_BndEvt__DetailPanelTabList_K2Node_ComponentBoundEvent_0_OnTabButtonCreation__DelegateSignature final
{
public:
...
static_assert(alignof(EventStoreHostPanels_C_BndEvt__DetailPanelTabList_K2Node_ComponentBoundEvent_0_OnTabButtonCreation__DelegateSignature) == 0x000008, "Wrong alignment on EventStoreHostPanels_C_BndEvt__DetailPanelTabList_K2Node_ComponentBoundEvent_0_OnTabButtonCreation__DelegateSignature");
static_assert(sizeof(EventStoreHostPanels_C_BndEvt__DetailPanelTabList_K2Node_ComponentBoundEvent_0_OnTabButtonCreation__DelegateSignature) == 0x000010, "Wrong size on EventStoreHostPanels_C_BndEvt__DetailPanelTabList_K2Node_ComponentBoundEvent_0_OnTabButtonCreation__DelegateSignature");
static_assert(offsetof(EventStoreHostPanels_C_BndEvt__DetailPanelTabList_K2Node_ComponentBoundEvent_0_OnTabButtonCreation__DelegateSignature, TabId) == 0x000000, "Member 'EventStoreHostPanels_C_BndEvt__DetailPanelTabList_K2Node_ComponentBoundEvent_0_OnTabButtonCreation__DelegateSignature::TabId' has a wrong offset!");
static_assert(offsetof(EventStoreHostPanels_C_BndEvt__DetailPanelTabList_K2Node_ComponentBoundEvent_0_OnTabButtonCreation__DelegateSignature, TabButton) == 0x000008, "Member 'EventStoreHostPanels_C_BndEvt__DetailPanelTabList_K2Node_ComponentBoundEvent_0_OnTabButtonCreation__DelegateSignature::TabButton' has a wrong offset!");
...
public:
	...
	class UFortItemDetailsHostPanel*              K2Node_DynamicCast_AsFort_Item_Details_Host_Panel_1; // 0x0050(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(EventStoreHostPanels_C_ExecuteUbergraph_EventStoreHostPanels, K2Node_ComponentBoundEvent_TabId) == 0x000004, "Member 'EventStoreHostPanels_C_ExecuteUbergraph_EventStoreHostPanels::K2Node_ComponentBoundEvent_TabId' has a wrong offset!");
...
static_assert(offsetof(EventStoreHostPanels_C_ExecuteUbergraph_EventStoreHostPanels, K2Node_DynamicCast_bSuccess_1) == 0x000040, "Member 'EventStoreHostPanels_C_ExecuteUbergraph_EventStoreHostPanels::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
...
static_assert(offsetof(EventStoreHostPanels_C_ExecuteUbergraph_EventStoreHostPanels, K2Node_DynamicCast_AsFort_Item_Details_Host_Panel_1) == 0x000050, "Member 'EventStoreHostPanels_C_ExecuteUbergraph_EventStoreHostPanels::K2Node_DynamicCast_AsFort_Item_Details_Host_Panel_1' has a wrong offset!");
