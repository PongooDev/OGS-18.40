...
static_assert(sizeof(UProgressModalWidget_C) == 0x000590, "Wrong size on UProgressModalWidget_C");
static_assert(offsetof(UProgressModalWidget_C, UberGraphFrame) == 0x000580, "Member 'UProgressModalWidget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UProgressModalWidget_C, Lightbox) == 0x000588, "Member 'UProgressModalWidget_C::Lightbox' has a wrong offset!");
