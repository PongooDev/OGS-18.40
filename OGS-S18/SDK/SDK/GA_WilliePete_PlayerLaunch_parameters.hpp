...
public:
	...
	struct FHitResult                             K2Node_CustomEvent_Hit_1;                          // 0x00B4(0x0088)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
	bool                                          CallFunc_K2_CommitAbility_ReturnValue;             // 0x013C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_GetIsHoldingObject_ReturnValue;           // 0x013D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	TDelegate<void(const struct FGameplayTag& NotifyTag)> K2Node_CreateDelegate_OutputDelegate_6;            // 0x0150(0x0010)(ZeroConstructor, NoDestructor)
	...
	struct FHitResult                             K2Node_CustomEvent_Hit;                            // 0x02DC(0x0088)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
	TDelegate<void(struct FHitResult& Hit)>       K2Node_CreateDelegate_OutputDelegate_8;            // 0x0364(0x0010)(ZeroConstructor, NoDestructor)
...
static_assert(offsetof(GA_WilliePete_PlayerLaunch_C_ExecuteUbergraph_GA_WilliePete_PlayerLaunch, CallFunc_K2_CommitAbility_ReturnValue) == 0x00013C, "Member 'GA_WilliePete_PlayerLaunch_C_ExecuteUbergraph_GA_WilliePete_PlayerLaunch::CallFunc_K2_CommitAbility_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_WilliePete_PlayerLaunch_C_ExecuteUbergraph_GA_WilliePete_PlayerLaunch, CallFunc_GetIsHoldingObject_ReturnValue) == 0x00013D, "Member 'GA_WilliePete_PlayerLaunch_C_ExecuteUbergraph_GA_WilliePete_PlayerLaunch::CallFunc_GetIsHoldingObject_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_WilliePete_PlayerLaunch_C_ExecuteUbergraph_GA_WilliePete_PlayerLaunch, CallFunc_GetValueAtLevel_ReturnValue) == 0x000140, "Member 'GA_WilliePete_PlayerLaunch_C_ExecuteUbergraph_GA_WilliePete_PlayerLaunch::CallFunc_GetValueAtLevel_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_WilliePete_PlayerLaunch_C_ExecuteUbergraph_GA_WilliePete_PlayerLaunch, CallFunc_MakeVector_ReturnValue) == 0x000144, "Member 'GA_WilliePete_PlayerLaunch_C_ExecuteUbergraph_GA_WilliePete_PlayerLaunch::CallFunc_MakeVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_WilliePete_PlayerLaunch_C_ExecuteUbergraph_GA_WilliePete_PlayerLaunch, K2Node_CreateDelegate_OutputDelegate_6) == 0x000150, "Member 'GA_WilliePete_PlayerLaunch_C_ExecuteUbergraph_GA_WilliePete_PlayerLaunch::K2Node_CreateDelegate_OutputDelegate_6' has a wrong offset!");
static_assert(offsetof(GA_WilliePete_PlayerLaunch_C_ExecuteUbergraph_GA_WilliePete_PlayerLaunch, CallFunc_K2_GetActorLocation_ReturnValue) == 0x000160, "Member 'GA_WilliePete_PlayerLaunch_C_ExecuteUbergraph_GA_WilliePete_PlayerLaunch::CallFunc_K2_GetActorLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_WilliePete_PlayerLaunch_C_ExecuteUbergraph_GA_WilliePete_PlayerLaunch, CallFunc_BreakVector_X) == 0x00016C, "Member 'GA_WilliePete_PlayerLaunch_C_ExecuteUbergraph_GA_WilliePete_PlayerLaunch::CallFunc_BreakVector_X' has a wrong offset!");
static_assert(offsetof(GA_WilliePete_PlayerLaunch_C_ExecuteUbergraph_GA_WilliePete_PlayerLaunch, CallFunc_BreakVector_Y) == 0x000170, "Member 'GA_WilliePete_PlayerLaunch_C_ExecuteUbergraph_GA_WilliePete_PlayerLaunch::CallFunc_BreakVector_Y' has a wrong offset!");
static_assert(offsetof(GA_WilliePete_PlayerLaunch_C_ExecuteUbergraph_GA_WilliePete_PlayerLaunch, CallFunc_BreakVector_Z) == 0x000174, "Member 'GA_WilliePete_PlayerLaunch_C_ExecuteUbergraph_GA_WilliePete_PlayerLaunch::CallFunc_BreakVector_Z' has a wrong offset!");
static_assert(offsetof(GA_WilliePete_PlayerLaunch_C_ExecuteUbergraph_GA_WilliePete_PlayerLaunch, CallFunc_MakeGameplayCueParameters_ReturnValue) == 0x000178, "Member 'GA_WilliePete_PlayerLaunch_C_ExecuteUbergraph_GA_WilliePete_PlayerLaunch::CallFunc_MakeGameplayCueParameters_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(GA_WilliePete_PlayerLaunch_C_ExecuteUbergraph_GA_WilliePete_PlayerLaunch, K2Node_CreateDelegate_OutputDelegate_8) == 0x000364, "Member 'GA_WilliePete_PlayerLaunch_C_ExecuteUbergraph_GA_WilliePete_PlayerLaunch::K2Node_CreateDelegate_OutputDelegate_8' has a wrong offset!");
...
static_assert(sizeof(GA_WilliePete_PlayerLaunch_C_End_Skydive) == 0x000088, "Wrong size on GA_WilliePete_PlayerLaunch_C_End_Skydive");
...
static_assert(offsetof(GA_WilliePete_PlayerLaunch_C_StructureTraceLoop, CallFunc_Less_IntInt_ReturnValue) == 0x0000F0, "Member 'GA_WilliePete_PlayerLaunch_C_StructureTraceLoop::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_WilliePete_PlayerLaunch_C_StructureTraceLoop, CallFunc_BreakHitResult_bBlockingHit) == 0x0000F1, "Member 'GA_WilliePete_PlayerLaunch_C_StructureTraceLoop::CallFunc_BreakHitResult_bBlockingHit' has a wrong offset!");
static_assert(offsetof(GA_WilliePete_PlayerLaunch_C_StructureTraceLoop, CallFunc_BreakHitResult_bInitialOverlap) == 0x0000F2, "Member 'GA_WilliePete_PlayerLaunch_C_StructureTraceLoop::CallFunc_BreakHitResult_bInitialOverlap' has a wrong offset!");
static_assert(offsetof(GA_WilliePete_PlayerLaunch_C_StructureTraceLoop, CallFunc_BreakHitResult_Time) == 0x0000F4, "Member 'GA_WilliePete_PlayerLaunch_C_StructureTraceLoop::CallFunc_BreakHitResult_Time' has a wrong offset!");
static_assert(offsetof(GA_WilliePete_PlayerLaunch_C_StructureTraceLoop, CallFunc_BreakHitResult_Distance) == 0x0000F8, "Member 'GA_WilliePete_PlayerLaunch_C_StructureTraceLoop::CallFunc_BreakHitResult_Distance' has a wrong offset!");
static_assert(offsetof(GA_WilliePete_PlayerLaunch_C_StructureTraceLoop, CallFunc_BreakHitResult_Location) == 0x0000FC, "Member 'GA_WilliePete_PlayerLaunch_C_StructureTraceLoop::CallFunc_BreakHitResult_Location' has a wrong offset!");
static_assert(offsetof(GA_WilliePete_PlayerLaunch_C_StructureTraceLoop, CallFunc_BreakHitResult_ImpactPoint) == 0x000108, "Member 'GA_WilliePete_PlayerLaunch_C_StructureTraceLoop::CallFunc_BreakHitResult_ImpactPoint' has a wrong offset!");
static_assert(offsetof(GA_WilliePete_PlayerLaunch_C_StructureTraceLoop, CallFunc_BreakHitResult_Normal) == 0x000114, "Member 'GA_WilliePete_PlayerLaunch_C_StructureTraceLoop::CallFunc_BreakHitResult_Normal' has a wrong offset!");
static_assert(offsetof(GA_WilliePete_PlayerLaunch_C_StructureTraceLoop, CallFunc_BreakHitResult_ImpactNormal) == 0x000120, "Member 'GA_WilliePete_PlayerLaunch_C_StructureTraceLoop::CallFunc_BreakHitResult_ImpactNormal' has a wrong offset!");
