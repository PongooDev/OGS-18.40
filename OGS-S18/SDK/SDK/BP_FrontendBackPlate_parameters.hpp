...
public:
	...
	class UTexture*                               K2Node_Select_Default_2;                           // 0x0098(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UMaterialInstanceDynamic*               CallFunc_CreateDynamicMaterialInstance_ReturnValue_2; // 0x00A8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(BP_FrontendBackPlate_C_SetBackgroundTexture) == 0x0000B0, "Wrong size on BP_FrontendBackPlate_C_SetBackgroundTexture");
...
static_assert(offsetof(BP_FrontendBackPlate_C_SetBackgroundTexture, CallFunc_Conv_StringToName_ReturnValue_2) == 0x000080, "Member 'BP_FrontendBackPlate_C_SetBackgroundTexture::CallFunc_Conv_StringToName_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_FrontendBackPlate_C_SetBackgroundTexture, CallFunc_CreateDynamicMaterialInstance_ReturnValue) == 0x000088, "Member 'BP_FrontendBackPlate_C_SetBackgroundTexture::CallFunc_CreateDynamicMaterialInstance_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_FrontendBackPlate_C_SetBackgroundTexture, K2Node_Select_Default_1) == 0x000090, "Member 'BP_FrontendBackPlate_C_SetBackgroundTexture::K2Node_Select_Default_1' has a wrong offset!");
static_assert(offsetof(BP_FrontendBackPlate_C_SetBackgroundTexture, K2Node_Select_Default_2) == 0x000098, "Member 'BP_FrontendBackPlate_C_SetBackgroundTexture::K2Node_Select_Default_2' has a wrong offset!");
static_assert(offsetof(BP_FrontendBackPlate_C_SetBackgroundTexture, CallFunc_CreateDynamicMaterialInstance_ReturnValue_1) == 0x0000A0, "Member 'BP_FrontendBackPlate_C_SetBackgroundTexture::CallFunc_CreateDynamicMaterialInstance_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_FrontendBackPlate_C_SetBackgroundTexture, CallFunc_CreateDynamicMaterialInstance_ReturnValue_2) == 0x0000A8, "Member 'BP_FrontendBackPlate_C_SetBackgroundTexture::CallFunc_CreateDynamicMaterialInstance_ReturnValue_2' has a wrong offset!");
...
public:
	...
	TArray<class AActor*>                         CallFunc_SortActorArray_OutSortedActors;           // 0x0058(0x0010)(ReferenceParm)
...
static_assert(offsetof(BP_FrontendBackPlate_C_UserConstructionScript, CallFunc_CreateUniqueMaterialName_UniqueString_2) == 0x000030, "Member 'BP_FrontendBackPlate_C_UserConstructionScript::CallFunc_CreateUniqueMaterialName_UniqueString_2' has a wrong offset!");
static_assert(offsetof(BP_FrontendBackPlate_C_UserConstructionScript, CallFunc_GetAllActorsWithTag_OutActors) == 0x000040, "Member 'BP_FrontendBackPlate_C_UserConstructionScript::CallFunc_GetAllActorsWithTag_OutActors' has a wrong offset!");
static_assert(offsetof(BP_FrontendBackPlate_C_UserConstructionScript, CallFunc_Conv_StringToName_ReturnValue_2) == 0x000050, "Member 'BP_FrontendBackPlate_C_UserConstructionScript::CallFunc_Conv_StringToName_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_FrontendBackPlate_C_UserConstructionScript, CallFunc_SortActorArray_OutSortedActors) == 0x000058, "Member 'BP_FrontendBackPlate_C_UserConstructionScript::CallFunc_SortActorArray_OutSortedActors' has a wrong offset!");
static_assert(offsetof(BP_FrontendBackPlate_C_UserConstructionScript, CallFunc_CreateDynamicMaterialInstance_ReturnValue) == 0x000068, "Member 'BP_FrontendBackPlate_C_UserConstructionScript::CallFunc_CreateDynamicMaterialInstance_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_FrontendBackPlate_C_UserConstructionScript, CallFunc_CreateDynamicMaterialInstance_ReturnValue_1) == 0x000070, "Member 'BP_FrontendBackPlate_C_UserConstructionScript::CallFunc_CreateDynamicMaterialInstance_ReturnValue_1' has a wrong offset!");
