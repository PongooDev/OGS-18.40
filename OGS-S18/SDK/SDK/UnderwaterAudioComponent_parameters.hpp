...
static_assert(offsetof(UnderwaterAudioComponent_C_ExecuteUbergraph_UnderwaterAudioComponent, CallFunc_IsValid_ReturnValue) == 0x000004, "Member 'UnderwaterAudioComponent_C_ExecuteUbergraph_UnderwaterAudioComponent::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(UnderwaterAudioComponent_C_ExecuteUbergraph_UnderwaterAudioComponent, K2Node_CustomEvent_bIsUnderWater) == 0x000018, "Member 'UnderwaterAudioComponent_C_ExecuteUbergraph_UnderwaterAudioComponent::K2Node_CustomEvent_bIsUnderWater' has a wrong offset!");
static_assert(offsetof(UnderwaterAudioComponent_C_ExecuteUbergraph_UnderwaterAudioComponent, K2Node_CustomEvent_DepthUnderwater) == 0x00001C, "Member 'UnderwaterAudioComponent_C_ExecuteUbergraph_UnderwaterAudioComponent::K2Node_CustomEvent_DepthUnderwater' has a wrong offset!");
...
static_assert(offsetof(UnderwaterAudioComponent_C_ExecuteUbergraph_UnderwaterAudioComponent, CallFunc_IsSplitScreen_ReturnValue) == 0x000038, "Member 'UnderwaterAudioComponent_C_ExecuteUbergraph_UnderwaterAudioComponent::CallFunc_IsSplitScreen_ReturnValue' has a wrong offset!");
static_assert(offsetof(UnderwaterAudioComponent_C_ExecuteUbergraph_UnderwaterAudioComponent, K2Node_Event_EndPlayReason) == 0x000039, "Member 'UnderwaterAudioComponent_C_ExecuteUbergraph_UnderwaterAudioComponent::K2Node_Event_EndPlayReason' has a wrong offset!");
