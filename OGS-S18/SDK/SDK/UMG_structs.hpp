...
public:
	...
	bool                                          bLastKnownTickState;                               // 0x0001(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(offsetof(FSequenceTickManagerWidgetData, bIsTicking) == 0x000000, "Member 'FSequenceTickManagerWidgetData::bIsTicking' has a wrong offset!");
static_assert(offsetof(FSequenceTickManagerWidgetData, bLastKnownTickState) == 0x000001, "Member 'FSequenceTickManagerWidgetData::bLastKnownTickState' has a wrong offset!");
