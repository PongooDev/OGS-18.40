...
static_assert(sizeof(UConversationParticipantComponent) == 0x0001B0, "Wrong size on UConversationParticipantComponent");
static_assert(offsetof(UConversationParticipantComponent, ConversationsActive) == 0x00018C, "Member 'UConversationParticipantComponent::ConversationsActive' has a wrong offset!");
static_assert(offsetof(UConversationParticipantComponent, Auth_CurrentConversation) == 0x000190, "Member 'UConversationParticipantComponent::Auth_CurrentConversation' has a wrong offset!");
static_assert(offsetof(UConversationParticipantComponent, Auth_Conversations) == 0x000198, "Member 'UConversationParticipantComponent::Auth_Conversations' has a wrong offset!");
