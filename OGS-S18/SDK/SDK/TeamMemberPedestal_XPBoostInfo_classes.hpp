...
static_assert(sizeof(UTeamMemberPedestal_XPBoostInfo_C) == 0x000C70, "Wrong size on UTeamMemberPedestal_XPBoostInfo_C");
static_assert(offsetof(UTeamMemberPedestal_XPBoostInfo_C, UberGraphFrame) == 0x000C60, "Member 'UTeamMemberPedestal_XPBoostInfo_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UTeamMemberPedestal_XPBoostInfo_C, PrimaryOvr) == 0x000C68, "Member 'UTeamMemberPedestal_XPBoostInfo_C::PrimaryOvr' has a wrong offset!");
