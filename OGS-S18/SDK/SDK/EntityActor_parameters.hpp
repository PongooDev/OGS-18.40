...
static_assert(sizeof(EntityActorCollisionComponent_OnNativeComponentBeginOverlap) == 0x0000A8, "Wrong size on EntityActorCollisionComponent_OnNativeComponentBeginOverlap");
