...
{
public:
	class FText                                   OutsideSafeZoneEliminatedOverlayText;              // 0x0760(0x0018)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(AFortAthenaMutator_PhosphorusWipeout) == 0x000778, "Wrong size on AFortAthenaMutator_PhosphorusWipeout");
static_assert(offsetof(AFortAthenaMutator_PhosphorusWipeout, OutsideSafeZoneEliminatedOverlayText) == 0x000760, "Member 'AFortAthenaMutator_PhosphorusWipeout::OutsideSafeZoneEliminatedOverlayText' has a wrong offset!");
