...
static_assert(sizeof(UFortConversationParticipantComponent) == 0x0001B0, "Wrong size on UFortConversationParticipantComponent");
...
static_assert(sizeof(UFortPlayerConversationComponent) == 0x0003A8, "Wrong size on UFortPlayerConversationComponent");
static_assert(offsetof(UFortPlayerConversationComponent, ConversationParticipantsInRange) == 0x0001B8, "Member 'UFortPlayerConversationComponent::ConversationParticipantsInRange' has a wrong offset!");
static_assert(offsetof(UFortPlayerConversationComponent, DialogWidgetSoftClass) == 0x0001C8, "Member 'UFortPlayerConversationComponent::DialogWidgetSoftClass' has a wrong offset!");
static_assert(offsetof(UFortPlayerConversationComponent, DialogMarkerSoftClass) == 0x0001F0, "Member 'UFortPlayerConversationComponent::DialogMarkerSoftClass' has a wrong offset!");
static_assert(offsetof(UFortPlayerConversationComponent, MobileDialogWidgetSoftClass) == 0x000218, "Member 'UFortPlayerConversationComponent::MobileDialogWidgetSoftClass' has a wrong offset!");
static_assert(offsetof(UFortPlayerConversationComponent, DialogWidgetClass) == 0x000240, "Member 'UFortPlayerConversationComponent::DialogWidgetClass' has a wrong offset!");
static_assert(offsetof(UFortPlayerConversationComponent, DialogMarkerClass) == 0x000248, "Member 'UFortPlayerConversationComponent::DialogMarkerClass' has a wrong offset!");
static_assert(offsetof(UFortPlayerConversationComponent, GreetSphereRadius) == 0x000250, "Member 'UFortPlayerConversationComponent::GreetSphereRadius' has a wrong offset!");
static_assert(offsetof(UFortPlayerConversationComponent, IconVisibilityRadius) == 0x000254, "Member 'UFortPlayerConversationComponent::IconVisibilityRadius' has a wrong offset!");
static_assert(offsetof(UFortPlayerConversationComponent, AbortConversationRange) == 0x000258, "Member 'UFortPlayerConversationComponent::AbortConversationRange' has a wrong offset!");
