...
public:
	...
	TMulticastInlineDelegate<void(class UCommonButtonLegacy* Button, const struct FAthenaCustomizationParams& CustomizationParams)> OnSlotClicked;                                     // 0x02C0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
