...
{
public:
	uint8                                         Pad_760[0xA0];                                     // 0x0760(0x00A0)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FControlRigAnimInstanceProxy) == 0x000010, "Wrong alignment on FControlRigAnimInstanceProxy");
static_assert(sizeof(FControlRigAnimInstanceProxy) == 0x000800, "Wrong size on FControlRigAnimInstanceProxy");
...
static_assert(sizeof(FControlRigLayerInstanceProxy) == 0x000800, "Wrong size on FControlRigLayerInstanceProxy");
...
{
public:
	uint8                                         Pad_A00[0x2B0];                                    // 0x0A00(0x02B0)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(sizeof(FControlRigSequencerAnimInstanceProxy) == 0x000CB0, "Wrong size on FControlRigSequencerAnimInstanceProxy");
