...
static_assert(sizeof(GA_Athena_Lockout_C_ExecuteUbergraph_GA_Athena_Lockout) == 0x000040, "Wrong size on GA_Athena_Lockout_C_ExecuteUbergraph_GA_Athena_Lockout");
...
static_assert(offsetof(GA_Athena_Lockout_C_ExecuteUbergraph_GA_Athena_Lockout, K2Node_SwitchEnum_CmpSuccess) == 0x000020, "Member 'GA_Athena_Lockout_C_ExecuteUbergraph_GA_Athena_Lockout::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(GA_Athena_Lockout_C_ExecuteUbergraph_GA_Athena_Lockout, CallFunc_GetAvatarAsValidFortPlayerPawn_OutExec_1) == 0x000021, "Member 'GA_Athena_Lockout_C_ExecuteUbergraph_GA_Athena_Lockout::CallFunc_GetAvatarAsValidFortPlayerPawn_OutExec_1' has a wrong offset!");
static_assert(offsetof(GA_Athena_Lockout_C_ExecuteUbergraph_GA_Athena_Lockout, CallFunc_GetAvatarAsValidFortPlayerPawn_OutFortPlayerPawn_1) == 0x000028, "Member 'GA_Athena_Lockout_C_ExecuteUbergraph_GA_Athena_Lockout::CallFunc_GetAvatarAsValidFortPlayerPawn_OutFortPlayerPawn_1' has a wrong offset!");
static_assert(offsetof(GA_Athena_Lockout_C_ExecuteUbergraph_GA_Athena_Lockout, K2Node_Event_bWasCancelled) == 0x000030, "Member 'GA_Athena_Lockout_C_ExecuteUbergraph_GA_Athena_Lockout::K2Node_Event_bWasCancelled' has a wrong offset!");
static_assert(offsetof(GA_Athena_Lockout_C_ExecuteUbergraph_GA_Athena_Lockout, K2Node_SwitchEnum_CmpSuccess_1) == 0x000031, "Member 'GA_Athena_Lockout_C_ExecuteUbergraph_GA_Athena_Lockout::K2Node_SwitchEnum_CmpSuccess_1' has a wrong offset!");
static_assert(offsetof(GA_Athena_Lockout_C_ExecuteUbergraph_GA_Athena_Lockout, CallFunc_K2_SetTimerDelegate_ReturnValue) == 0x000038, "Member 'GA_Athena_Lockout_C_ExecuteUbergraph_GA_Athena_Lockout::CallFunc_K2_SetTimerDelegate_ReturnValue' has a wrong offset!");
