...
static_assert(sizeof(UGA_TrapGeneric_C) == 0x000AC8, "Wrong size on UGA_TrapGeneric_C");
...
static_assert(offsetof(UGA_TrapGeneric_C, TargetArray) == 0x000AB8, "Member 'UGA_TrapGeneric_C::TargetArray' has a wrong offset!");
