...
static_assert(sizeof(UJoinServer_C) == 0x000518, "Wrong size on UJoinServer_C");
static_assert(offsetof(UJoinServer_C, UberGraphFrame) == 0x000508, "Member 'UJoinServer_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UJoinServer_C, BuildWatermark) == 0x000510, "Member 'UJoinServer_C::BuildWatermark' has a wrong offset!");
