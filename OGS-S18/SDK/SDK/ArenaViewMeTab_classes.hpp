...
static_assert(sizeof(UArenaViewMeTab_C) == 0x000358, "Wrong size on UArenaViewMeTab_C");
static_assert(offsetof(UArenaViewMeTab_C, UberGraphFrame) == 0x000350, "Member 'UArenaViewMeTab_C::UberGraphFrame' has a wrong offset!");
