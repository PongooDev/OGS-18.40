...
public:
	...
	class UGameplayStateMachineSubsystem*         CachedStateMachineSubSystem;                       // 0x0070(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UGameplayState*                         Hack_StateToDelayProcess;                          // 0x0078(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UGameplayState) == 0x000080, "Wrong size on UGameplayState");
...
static_assert(offsetof(UGameplayState, CachedStateMachineSubSystem) == 0x000070, "Member 'UGameplayState::CachedStateMachineSubSystem' has a wrong offset!");
static_assert(offsetof(UGameplayState, Hack_StateToDelayProcess) == 0x000078, "Member 'UGameplayState::Hack_StateToDelayProcess' has a wrong offset!");
...
{
public:
	bool                                          bPubliclyBroadcast;                                // 0x0080(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bPersistDelegatesOnUnregistration;                 // 0x0081(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_82[0x2];                                       // 0x0082(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTag                           StateMachineId;                                    // 0x0084(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, Net, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_8C[0x4];                                       // 0x008C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FActiveGameplayStateData               ActiveGameplayStateData;                           // 0x0090(0x0018)(Net, Transient, RepNotify, NoDestructor, Protected, NativeAccessSpecifierProtected)
	TArray<struct FGameplayStateSettings>         GameplayStateSettings;                             // 0x00A8(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FGameplayTag                           InitialGameplayStateId;                            // 0x00B8(0x0008)(Edit, DisableEditOnInstance, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UGameplayStateMachine) == 0x0000C0, "Wrong size on UGameplayStateMachine");
static_assert(offsetof(UGameplayStateMachine, bPubliclyBroadcast) == 0x000080, "Member 'UGameplayStateMachine::bPubliclyBroadcast' has a wrong offset!");
static_assert(offsetof(UGameplayStateMachine, bPersistDelegatesOnUnregistration) == 0x000081, "Member 'UGameplayStateMachine::bPersistDelegatesOnUnregistration' has a wrong offset!");
static_assert(offsetof(UGameplayStateMachine, StateMachineId) == 0x000084, "Member 'UGameplayStateMachine::StateMachineId' has a wrong offset!");
static_assert(offsetof(UGameplayStateMachine, ActiveGameplayStateData) == 0x000090, "Member 'UGameplayStateMachine::ActiveGameplayStateData' has a wrong offset!");
static_assert(offsetof(UGameplayStateMachine, GameplayStateSettings) == 0x0000A8, "Member 'UGameplayStateMachine::GameplayStateSettings' has a wrong offset!");
static_assert(offsetof(UGameplayStateMachine, InitialGameplayStateId) == 0x0000B8, "Member 'UGameplayStateMachine::InitialGameplayStateId' has a wrong offset!");
