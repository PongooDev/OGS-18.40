...
static_assert(sizeof(OptionsMenuHeader_C_SetFontSize) == 0x000070, "Wrong size on OptionsMenuHeader_C_SetFontSize");
...
static_assert(offsetof(OptionsMenuHeader_C_SetFontSize, Temp_bool_Variable) == 0x000068, "Member 'OptionsMenuHeader_C_SetFontSize::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(OptionsMenuHeader_C_SetFontSize, CallFunc_IsMobileGame_ReturnValue) == 0x000069, "Member 'OptionsMenuHeader_C_SetFontSize::CallFunc_IsMobileGame_ReturnValue' has a wrong offset!");
static_assert(offsetof(OptionsMenuHeader_C_SetFontSize, K2Node_Select_Default) == 0x00006C, "Member 'OptionsMenuHeader_C_SetFontSize::K2Node_Select_Default' has a wrong offset!");
