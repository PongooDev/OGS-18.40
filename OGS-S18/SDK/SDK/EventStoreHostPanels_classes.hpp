...
public:
	...
	class UCommonWidgetSwitcherLegacy*            DetailPanelWidgetSwitcher;                         // 0x0368(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
public:
	...
	void Construct();
	void BndEvt__DetailPanelTabList_K2Node_ComponentBoundEvent_0_OnTabButtonCreation__DelegateSignature(class FName TabId, class UCommonButtonBase* TabButton);
