...
static_assert(sizeof(UTabVideoOptions_New_C) == 0x000398, "Wrong size on UTabVideoOptions_New_C");
static_assert(offsetof(UTabVideoOptions_New_C, UberGraphFrame) == 0x000390, "Member 'UTabVideoOptions_New_C::UberGraphFrame' has a wrong offset!");
