...
static_assert(sizeof(USettingsPanel_C) == 0x0006D0, "Wrong size on USettingsPanel_C");
static_assert(offsetof(USettingsPanel_C, SafeZone_0) == 0x0006C8, "Member 'USettingsPanel_C::SafeZone_0' has a wrong offset!");
