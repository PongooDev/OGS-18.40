...
static_assert(sizeof(SocialPanel_C_ExecuteUbergraph_SocialPanel) == 0x000050, "Wrong size on SocialPanel_C_ExecuteUbergraph_SocialPanel");
...
static_assert(offsetof(SocialPanel_C_ExecuteUbergraph_SocialPanel, CallFunc_IsAnimationPlaying_ReturnValue) == 0x000038, "Member 'SocialPanel_C_ExecuteUbergraph_SocialPanel::CallFunc_IsAnimationPlaying_ReturnValue' has a wrong offset!");
static_assert(offsetof(SocialPanel_C_ExecuteUbergraph_SocialPanel, CallFunc_IsAnimationPlayingForward_ReturnValue) == 0x000039, "Member 'SocialPanel_C_ExecuteUbergraph_SocialPanel::CallFunc_IsAnimationPlayingForward_ReturnValue' has a wrong offset!");
static_assert(offsetof(SocialPanel_C_ExecuteUbergraph_SocialPanel, K2Node_CreateDelegate_OutputDelegate_1) == 0x00003C, "Member 'SocialPanel_C_ExecuteUbergraph_SocialPanel::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
