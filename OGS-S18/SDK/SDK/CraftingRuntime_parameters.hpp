...
static_assert(sizeof(FortContextualTutorial_CraftingReady_HandleFormulaCraftableChanged) == 0x00000C, "Wrong size on FortContextualTutorial_CraftingReady_HandleFormulaCraftableChanged");
...
static_assert(offsetof(FortContextualTutorial_CraftingReady_HandleFormulaCraftableChanged, bIsCraftable) == 0x000008, "Member 'FortContextualTutorial_CraftingReady_HandleFormulaCraftableChanged::bIsCraftable' has a wrong offset!");
...
static_assert(sizeof(CraftingCheatManager_StartSelfCrafting) == 0x000008, "Wrong size on CraftingCheatManager_StartSelfCrafting");
...
static_assert(sizeof(FortContextualTutorial_CraftingTabOpen_HandleFormulaCraftableChanged) == 0x00000C, "Wrong size on FortContextualTutorial_CraftingTabOpen_HandleFormulaCraftableChanged");
...
static_assert(offsetof(FortContextualTutorial_CraftingTabOpen_HandleFormulaCraftableChanged, bIsCraftable) == 0x000008, "Member 'FortContextualTutorial_CraftingTabOpen_HandleFormulaCraftableChanged::bIsCraftable' has a wrong offset!");
...
static_assert(sizeof(FortContextualTutorial_CraftingTabOpen_HandleInventoryTabChanged) == 0x000008, "Wrong size on FortContextualTutorial_CraftingTabOpen_HandleInventoryTabChanged");
...
static_assert(sizeof(CraftingObjectBGA_HandleInteractionRangeBeginOverlap) == 0x0000A8, "Wrong size on CraftingObjectBGA_HandleInteractionRangeBeginOverlap");
...
static_assert(sizeof(CraftingObjectComponent_HandlePickupCraftingItemPickedUp) == 0x000028, "Wrong size on CraftingObjectComponent_HandlePickupCraftingItemPickedUp");
