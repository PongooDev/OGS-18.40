...
static_assert(sizeof(DLSSLibrary_GetDLSSModeInformation) == 0x000018, "Wrong size on DLSSLibrary_GetDLSSModeInformation");
...
static_assert(offsetof(DLSSLibrary_GetDLSSModeInformation, bIsSupported) == 0x000001, "Member 'DLSSLibrary_GetDLSSModeInformation::bIsSupported' has a wrong offset!");
static_assert(offsetof(DLSSLibrary_GetDLSSModeInformation, OptimalScreenPercentage) == 0x000004, "Member 'DLSSLibrary_GetDLSSModeInformation::OptimalScreenPercentage' has a wrong offset!");
static_assert(offsetof(DLSSLibrary_GetDLSSModeInformation, bIsFixedScreenPercentage) == 0x000008, "Member 'DLSSLibrary_GetDLSSModeInformation::bIsFixedScreenPercentage' has a wrong offset!");
static_assert(offsetof(DLSSLibrary_GetDLSSModeInformation, MinScreenPercentage) == 0x00000C, "Member 'DLSSLibrary_GetDLSSModeInformation::MinScreenPercentage' has a wrong offset!");
static_assert(offsetof(DLSSLibrary_GetDLSSModeInformation, MaxScreenPercentage) == 0x000010, "Member 'DLSSLibrary_GetDLSSModeInformation::MaxScreenPercentage' has a wrong offset!");
static_assert(offsetof(DLSSLibrary_GetDLSSModeInformation, OptimalSharpness) == 0x000014, "Member 'DLSSLibrary_GetDLSSModeInformation::OptimalSharpness' has a wrong offset!");
