...
public:
	...
	TDelegate<void(TArray<class AActor*>& SpawnedActors, bool bSuccess)> OnRequestFinished;                                 // 0x0040(0x0010)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FortAthenaLivingWorldManager_TrySpawnEvent) == 0x000060, "Wrong size on FortAthenaLivingWorldManager_TrySpawnEvent");
...
static_assert(offsetof(FortAthenaLivingWorldManager_TrySpawnEvent, OnRequestFinished) == 0x000040, "Member 'FortAthenaLivingWorldManager_TrySpawnEvent::OnRequestFinished' has a wrong offset!");
static_assert(offsetof(FortAthenaLivingWorldManager_TrySpawnEvent, ReturnValue) == 0x000050, "Member 'FortAthenaLivingWorldManager_TrySpawnEvent::ReturnValue' has a wrong offset!");
...
static_assert(alignof(FortAthenaLivingWorldPointProviderInterface_GetPointProviderLocation) == 0x000004, "Wrong alignment on FortAthenaLivingWorldPointProviderInterface_GetPointProviderLocation");
static_assert(sizeof(FortAthenaLivingWorldPointProviderInterface_GetPointProviderLocation) == 0x00000C, "Wrong size on FortAthenaLivingWorldPointProviderInterface_GetPointProviderLocation");
...
static_assert(sizeof(FortAthenaLivingWorldPointProviderInterface_OnSpawnedActor) == 0x000018, "Wrong size on FortAthenaLivingWorldPointProviderInterface_OnSpawnedActor");
...
static_assert(sizeof(FortAthenaLivingWorldPointProviderInterface_GetValidLocation) == 0x000050, "Wrong size on FortAthenaLivingWorldPointProviderInterface_GetValidLocation");
...
static_assert(offsetof(FortAthenaLivingWorldPointProviderInterface_GetValidLocation, OutRotation) == 0x00003C, "Member 'FortAthenaLivingWorldPointProviderInterface_GetValidLocation::OutRotation' has a wrong offset!");
static_assert(offsetof(FortAthenaLivingWorldPointProviderInterface_GetValidLocation, ReturnValue) == 0x000048, "Member 'FortAthenaLivingWorldPointProviderInterface_GetValidLocation::ReturnValue' has a wrong offset!");
...
static_assert(alignof(FortAthenaLivingWorldPointProvidersEnabler_RemoveClosestPointProvidersToPoint) == 0x000004, "Wrong alignment on FortAthenaLivingWorldPointProvidersEnabler_RemoveClosestPointProvidersToPoint");
static_assert(sizeof(FortAthenaLivingWorldPointProvidersEnabler_RemoveClosestPointProvidersToPoint) == 0x000014, "Wrong size on FortAthenaLivingWorldPointProvidersEnabler_RemoveClosestPointProvidersToPoint");
...
static_assert(offsetof(FortAthenaLivingWorldPointProvidersEnabler_RemoveClosestPointProvidersToPoint, MaximumDistance) == 0x00000C, "Member 'FortAthenaLivingWorldPointProvidersEnabler_RemoveClosestPointProvidersToPoint::MaximumDistance' has a wrong offset!");
static_assert(offsetof(FortAthenaLivingWorldPointProvidersEnabler_RemoveClosestPointProvidersToPoint, PointsToDisable) == 0x000010, "Member 'FortAthenaLivingWorldPointProvidersEnabler_RemoveClosestPointProvidersToPoint::PointsToDisable' has a wrong offset!");
...
static_assert(sizeof(FortAthenaLivingWorldVolume_OnPointProviderRegistered) == 0x000010, "Wrong size on FortAthenaLivingWorldVolume_OnPointProviderRegistered");
...
static_assert(sizeof(FortAthenaLivingWorldVolume_SetEQSQueryConfigParam) == 0x00000C, "Wrong size on FortAthenaLivingWorldVolume_SetEQSQueryConfigParam");
...
static_assert(offsetof(FortAthenaLivingWorldVolume_SetEQSQueryConfigParam, Value) == 0x000008, "Member 'FortAthenaLivingWorldVolume_SetEQSQueryConfigParam::Value' has a wrong offset!");
...
static_assert(sizeof(FortCheatManager_LivingWorldManager_LivingWorldManagerSpawnAtLocation) == 0x000028, "Wrong size on FortCheatManager_LivingWorldManager_LivingWorldManagerSpawnAtLocation");
...
static_assert(offsetof(FortCheatManager_LivingWorldManager_LivingWorldManagerSpawnAtLocation, Rotation) == 0x00001C, "Member 'FortCheatManager_LivingWorldManager_LivingWorldManagerSpawnAtLocation::Rotation' has a wrong offset!");
