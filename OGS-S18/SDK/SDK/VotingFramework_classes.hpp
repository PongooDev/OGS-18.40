...
{
public:
	TArray<struct FVoteSessionSettings>           VoteSessionSettingsList;                           // 0x0200(0x0010)(Edit, ZeroConstructor, Protected, NativeAccessSpecifierProtected)
...
{
public:
	TMulticastInlineDelegate<void(struct FGameplayTag& VoteSessionId, struct FGameplayTag& StartingVoteId, EVoteSessionNetworkType NetworkType, EVoteSessionState SessionState)> OnVoteSessionSetupEvent;                           // 0x00B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FGameplayTag& VoteSessionId, struct FGameplayTag& StartingVoteId, EVoteSessionState SessionState)> OnVoteSessionVotingEvent;                          // 0x00C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FGameplayTag& VoteSessionId, struct FGameplayTag& VoteId, EVoteState VoteState)> OnVoteSetupEvent;                                  // 0x00D0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FGameplayTag& VoteSessionId, struct FGameplayTag& VoteId, EVoteState VoteState)> OnVoteStartEvent;                                  // 0x00E0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FGameplayTag& VoteSessionId, struct FGameplayTag& VoteId, struct FGameplayTag& VoteSelectionId, int32 ServerVoteTotal, int32 AllServersVoteTotal)> OnVoteChangeEvent;                                 // 0x00F0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FGameplayTag& VoteSessionId, struct FGameplayTag& VoteId, struct FGameplayTag& WinningVoteSelectionId, EVoteState VoteState)> OnVoteEndEvent;                                    // 0x0100(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FGameplayTag& VoteSessionId)> OnVoteSessionCompleteEvent;                        // 0x0110(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FGameplayTag& VoteSessionId)> OnVoteSessionShutdownEvent;                        // 0x0120(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
{
public:
	TArray<struct FVoteSelection>                 SupportedVoteSelections;                           // 0x0190(0x0010)(Edit, Net, ZeroConstructor, Protected, NativeAccessSpecifierProtected)
