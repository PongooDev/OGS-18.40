...
static_assert(sizeof(ReferAFriendActionMenu_C_OnKeyUp) == 0x0002B8, "Wrong size on ReferAFriendActionMenu_C_OnKeyUp");
...
static_assert(offsetof(ReferAFriendActionMenu_C_OnKeyUp, InKeyEvent) == 0x000038, "Member 'ReferAFriendActionMenu_C_OnKeyUp::InKeyEvent' has a wrong offset!");
static_assert(offsetof(ReferAFriendActionMenu_C_OnKeyUp, ReturnValue) == 0x000070, "Member 'ReferAFriendActionMenu_C_OnKeyUp::ReturnValue' has a wrong offset!");
static_assert(offsetof(ReferAFriendActionMenu_C_OnKeyUp, CallFunc_Unhandled_ReturnValue) == 0x000128, "Member 'ReferAFriendActionMenu_C_OnKeyUp::CallFunc_Unhandled_ReturnValue' has a wrong offset!");
static_assert(offsetof(ReferAFriendActionMenu_C_OnKeyUp, CallFunc_GetKey_ReturnValue) == 0x0001E0, "Member 'ReferAFriendActionMenu_C_OnKeyUp::CallFunc_GetKey_ReturnValue' has a wrong offset!");
static_assert(offsetof(ReferAFriendActionMenu_C_OnKeyUp, CallFunc_EqualEqual_KeyKey_ReturnValue) == 0x0001F8, "Member 'ReferAFriendActionMenu_C_OnKeyUp::CallFunc_EqualEqual_KeyKey_ReturnValue' has a wrong offset!");
static_assert(offsetof(ReferAFriendActionMenu_C_OnKeyUp, CallFunc_Handled_ReturnValue) == 0x000200, "Member 'ReferAFriendActionMenu_C_OnKeyUp::CallFunc_Handled_ReturnValue' has a wrong offset!");
