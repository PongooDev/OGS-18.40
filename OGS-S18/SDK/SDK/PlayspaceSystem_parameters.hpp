...
static_assert(alignof(GameplayVolume_UpdateSize) == 0x000004, "Wrong alignment on GameplayVolume_UpdateSize");
static_assert(sizeof(GameplayVolume_UpdateSize) == 0x00000C, "Wrong size on GameplayVolume_UpdateSize");
...
static_assert(sizeof(OverlapComponent_OnBeginActorOverlap) == 0x0000A8, "Wrong size on OverlapComponent_OnBeginActorOverlap");
...
static_assert(sizeof(PlayspaceControllerComponent_PlayerSpawning_GetSpawnInfo) == 0x00002C, "Wrong size on PlayspaceControllerComponent_PlayerSpawning_GetSpawnInfo");
