...
static_assert(sizeof(UAthenaChatWidgetModalWrapper_C) == 0x000368, "Wrong size on UAthenaChatWidgetModalWrapper_C");
static_assert(offsetof(UAthenaChatWidgetModalWrapper_C, UberGraphFrame) == 0x000360, "Member 'UAthenaChatWidgetModalWrapper_C::UberGraphFrame' has a wrong offset!");
