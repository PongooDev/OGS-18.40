...
public:
	...
	TSoftObjectPtr<class UTexture2D>              CallFunc_GetBannerSmallIconAssetFromRowName_ReturnValue; // 0x0020(0x0028)(UObjectWrapper, HasGetValueTypeHash)
	TSoftObjectPtr<class UTexture2D>              CallFunc_GetBannerLargeIconAssetFromRowName_ReturnValue; // 0x0048(0x0028)(UObjectWrapper, HasGetValueTypeHash)
...
public:
	...
	struct FFortAthenaLoadout                     CallFunc_GetLoadoutForPlayer_ReturnValue;          // 0x0008(0x0150)()
...
static_assert(offsetof(PlayerBanner_C_SetBannerIconAndColorFromProfile, CallFunc_Conv_StringToName_ReturnValue) == 0x000158, "Member 'PlayerBanner_C_SetBannerIconAndColorFromProfile::CallFunc_Conv_StringToName_ReturnValue' has a wrong offset!");
static_assert(offsetof(PlayerBanner_C_SetBannerIconAndColorFromProfile, CallFunc_Conv_StringToName_ReturnValue_1) == 0x000160, "Member 'PlayerBanner_C_SetBannerIconAndColorFromProfile::CallFunc_Conv_StringToName_ReturnValue_1' has a wrong offset!");
