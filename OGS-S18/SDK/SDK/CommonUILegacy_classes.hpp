...
static_assert(alignof(UCommonButtonLegacy) == 0x000008, "Wrong alignment on UCommonButtonLegacy");
static_assert(sizeof(UCommonButtonLegacy) == 0x000C20, "Wrong size on UCommonButtonLegacy");
static_assert(offsetof(UCommonButtonLegacy, OnSelectedChanged) == 0x000BD0, "Member 'UCommonButtonLegacy::OnSelectedChanged' has a wrong offset!");
static_assert(offsetof(UCommonButtonLegacy, OnButtonClicked) == 0x000BE0, "Member 'UCommonButtonLegacy::OnButtonClicked' has a wrong offset!");
static_assert(offsetof(UCommonButtonLegacy, OnButtonDoubleClicked) == 0x000BF0, "Member 'UCommonButtonLegacy::OnButtonDoubleClicked' has a wrong offset!");
static_assert(offsetof(UCommonButtonLegacy, OnButtonHovered) == 0x000C00, "Member 'UCommonButtonLegacy::OnButtonHovered' has a wrong offset!");
static_assert(offsetof(UCommonButtonLegacy, OnButtonUnhovered) == 0x000C10, "Member 'UCommonButtonLegacy::OnButtonUnhovered' has a wrong offset!");
...
static_assert(sizeof(UCommonTabListWidgetLegacy) == 0x000378, "Wrong size on UCommonTabListWidgetLegacy");
static_assert(offsetof(UCommonTabListWidgetLegacy, OnTabButtonCreated) == 0x000358, "Member 'UCommonTabListWidgetLegacy::OnTabButtonCreated' has a wrong offset!");
static_assert(offsetof(UCommonTabListWidgetLegacy, OnTabButtonRemoved) == 0x000368, "Member 'UCommonTabListWidgetLegacy::OnTabButtonRemoved' has a wrong offset!");
...
public:
	...
	TMulticastInlineDelegate<void(class UCommonActivatablePanelLegacy* Panel)> OnWidgetActivated;                                 // 0x0350(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UCommonActivatablePanelLegacy* Panel)> OnWidgetDeactivated;                               // 0x0360(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	bool                                          bConsumeAllActions;                                // 0x0370(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bExposeActionsExternally;                          // 0x0371(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bShouldBypassStack;                                // 0x0372(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_373[0x10D];                                    // 0x0373(0x010D)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UCommonActivatablePanelLegacy) == 0x000480, "Wrong size on UCommonActivatablePanelLegacy");
static_assert(offsetof(UCommonActivatablePanelLegacy, OnWidgetActivated) == 0x000350, "Member 'UCommonActivatablePanelLegacy::OnWidgetActivated' has a wrong offset!");
static_assert(offsetof(UCommonActivatablePanelLegacy, OnWidgetDeactivated) == 0x000360, "Member 'UCommonActivatablePanelLegacy::OnWidgetDeactivated' has a wrong offset!");
static_assert(offsetof(UCommonActivatablePanelLegacy, bConsumeAllActions) == 0x000370, "Member 'UCommonActivatablePanelLegacy::bConsumeAllActions' has a wrong offset!");
static_assert(offsetof(UCommonActivatablePanelLegacy, bExposeActionsExternally) == 0x000371, "Member 'UCommonActivatablePanelLegacy::bExposeActionsExternally' has a wrong offset!");
static_assert(offsetof(UCommonActivatablePanelLegacy, bShouldBypassStack) == 0x000372, "Member 'UCommonActivatablePanelLegacy::bShouldBypassStack' has a wrong offset!");
...
static_assert(alignof(UCommonButtonInternalLegacy) == 0x000008, "Wrong alignment on UCommonButtonInternalLegacy");
static_assert(sizeof(UCommonButtonInternalLegacy) == 0x000488, "Wrong size on UCommonButtonInternalLegacy");
...
static_assert(sizeof(UCommonInputReflectorLegacy) == 0x0002B8, "Wrong size on UCommonInputReflectorLegacy");
static_assert(offsetof(UCommonInputReflectorLegacy, ButtonType) == 0x000288, "Member 'UCommonInputReflectorLegacy::ButtonType' has a wrong offset!");
static_assert(offsetof(UCommonInputReflectorLegacy, ActiveButtons) == 0x000290, "Member 'UCommonInputReflectorLegacy::ActiveButtons' has a wrong offset!");
static_assert(offsetof(UCommonInputReflectorLegacy, InactiveButtons) == 0x0002A0, "Member 'UCommonInputReflectorLegacy::InactiveButtons' has a wrong offset!");
...
static_assert(alignof(UCommonPopupButtonLegacy) == 0x000008, "Wrong alignment on UCommonPopupButtonLegacy");
static_assert(sizeof(UCommonPopupButtonLegacy) == 0x000C30, "Wrong size on UCommonPopupButtonLegacy");
static_assert(offsetof(UCommonPopupButtonLegacy, PopupMenuAnchor) == 0x000C20, "Member 'UCommonPopupButtonLegacy::PopupMenuAnchor' has a wrong offset!");
static_assert(offsetof(UCommonPopupButtonLegacy, PopupMenu) == 0x000C28, "Member 'UCommonPopupButtonLegacy::PopupMenu' has a wrong offset!");
...
{
public:
	bool                                          bUseInputStack;                                    // 0x0480(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_481[0x3];                                      // 0x0481(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TWeakObjectPtr<class UMenuAnchor>             OwningMenuAnchor;                                  // 0x0484(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, Protected, ExposeOnSpawn, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TWeakObjectPtr<class UObject>                 ContextProvidingObject;                            // 0x048C(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, ExposeOnSpawn, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UCommonPopupMenuLegacy) == 0x000498, "Wrong size on UCommonPopupMenuLegacy");
static_assert(offsetof(UCommonPopupMenuLegacy, bUseInputStack) == 0x000480, "Member 'UCommonPopupMenuLegacy::bUseInputStack' has a wrong offset!");
static_assert(offsetof(UCommonPopupMenuLegacy, OwningMenuAnchor) == 0x000484, "Member 'UCommonPopupMenuLegacy::OwningMenuAnchor' has a wrong offset!");
static_assert(offsetof(UCommonPopupMenuLegacy, ContextProvidingObject) == 0x00048C, "Member 'UCommonPopupMenuLegacy::ContextProvidingObject' has a wrong offset!");
...
static_assert(sizeof(UCommonUIActionRouterLegacy) == 0x000108, "Wrong size on UCommonUIActionRouterLegacy");
...
static_assert(alignof(UCommonVisibilityWidgetLegacy) == 0x000008, "Wrong alignment on UCommonVisibilityWidgetLegacy");
static_assert(sizeof(UCommonVisibilityWidgetLegacy) == 0x0002A0, "Wrong size on UCommonVisibilityWidgetLegacy");
static_assert(offsetof(UCommonVisibilityWidgetLegacy, bShowForGamepad) == 0x000290, "Member 'UCommonVisibilityWidgetLegacy::bShowForGamepad' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidgetLegacy, bShowForMouseAndKeyboard) == 0x000291, "Member 'UCommonVisibilityWidgetLegacy::bShowForMouseAndKeyboard' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidgetLegacy, bShowForTouch) == 0x000292, "Member 'UCommonVisibilityWidgetLegacy::bShowForTouch' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidgetLegacy, bShowForPC) == 0x000293, "Member 'UCommonVisibilityWidgetLegacy::bShowForPC' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidgetLegacy, bShowForMac) == 0x000294, "Member 'UCommonVisibilityWidgetLegacy::bShowForMac' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidgetLegacy, bShowForPS4) == 0x000295, "Member 'UCommonVisibilityWidgetLegacy::bShowForPS4' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidgetLegacy, bShowForPS5) == 0x000296, "Member 'UCommonVisibilityWidgetLegacy::bShowForPS5' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidgetLegacy, bShowForXBox) == 0x000297, "Member 'UCommonVisibilityWidgetLegacy::bShowForXBox' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidgetLegacy, bShowForXSX) == 0x000298, "Member 'UCommonVisibilityWidgetLegacy::bShowForXSX' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidgetLegacy, bShowForIOS) == 0x000299, "Member 'UCommonVisibilityWidgetLegacy::bShowForIOS' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidgetLegacy, bShowForAndroid) == 0x00029A, "Member 'UCommonVisibilityWidgetLegacy::bShowForAndroid' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidgetLegacy, bShowForErebus) == 0x00029B, "Member 'UCommonVisibilityWidgetLegacy::bShowForErebus' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidgetLegacy, VisibleType) == 0x00029C, "Member 'UCommonVisibilityWidgetLegacy::VisibleType' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidgetLegacy, HiddenType) == 0x00029D, "Member 'UCommonVisibilityWidgetLegacy::HiddenType' has a wrong offset!");
...
static_assert(sizeof(UCommonWidgetStackLegacy) == 0x000168, "Wrong size on UCommonWidgetStackLegacy");
static_assert(offsetof(UCommonWidgetStackLegacy, OnActiveWidgetChangedLegacyEvent) == 0x000158, "Member 'UCommonWidgetStackLegacy::OnActiveWidgetChangedLegacyEvent' has a wrong offset!");
...
static_assert(sizeof(UCommonWidgetSwitcherLegacy) == 0x0001B8, "Wrong size on UCommonWidgetSwitcherLegacy");
static_assert(offsetof(UCommonWidgetSwitcherLegacy, OnActiveWidgetDeactivated) == 0x000190, "Member 'UCommonWidgetSwitcherLegacy::OnActiveWidgetDeactivated' has a wrong offset!");
static_assert(offsetof(UCommonWidgetSwitcherLegacy, OnActiveWidgetChanged) == 0x0001A0, "Member 'UCommonWidgetSwitcherLegacy::OnActiveWidgetChanged' has a wrong offset!");
static_assert(offsetof(UCommonWidgetSwitcherLegacy, bWidgetActivationEnabled) == 0x0001B1, "Member 'UCommonWidgetSwitcherLegacy::bWidgetActivationEnabled' has a wrong offset!");
static_assert(offsetof(UCommonWidgetSwitcherLegacy, bOutroPanelBelow) == 0x0001B2, "Member 'UCommonWidgetSwitcherLegacy::bOutroPanelBelow' has a wrong offset!");
