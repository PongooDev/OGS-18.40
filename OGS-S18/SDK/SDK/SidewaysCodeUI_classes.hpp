...
{
public:
	class AFortPlayspaceReplicatedState*          ReplicatedState;                                   // 0x02C8(0x0008)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	ESidewaysState                                CurrentSidewaysState;                              // 0x02D0(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(USidewaysWidgetBase) == 0x0002D8, "Wrong size on USidewaysWidgetBase");
static_assert(offsetof(USidewaysWidgetBase, ReplicatedState) == 0x0002C8, "Member 'USidewaysWidgetBase::ReplicatedState' has a wrong offset!");
static_assert(offsetof(USidewaysWidgetBase, CurrentSidewaysState) == 0x0002D0, "Member 'USidewaysWidgetBase::CurrentSidewaysState' has a wrong offset!");
