...
// Enum FortniteUI.EChallengeListEntry_NpcQuestWidgetType
// NumValues: 0x0006
enum class EChallengeListEntry_NpcQuestWidgetType : uint8
{
	Normal                                   = 0,
	QuestGiver                               = 1,
	PartyUp                                  = 2,
...
// Enum FortniteUI.EPurchaseConfirmationButtonMode
// NumValues: 0x0005
...
enum class EOptionalFlowSteps : uint8
{
	...
	TryPlayTrailer                           = 1,
	TryShowMOTDs                             = 2,
	TryShowNormalBanModal                    = 3,
	TryShowSocialBanModal                    = 4,
	TryShowMFAModal                          = 5,
	TryShowCrossplayDialog                   = 6,
	TryShowSocialImport                      = 7,
	TryShowSurveys                           = 8,
	TryShowFireModeModal                     = 9,
	TryShowBadMatchPopup                     = 10,
	TryShowMobileInGameAppRating             = 11,
	TryShowSamsungSensorWarning              = 12,
	TryShowBattlePassPurchaseScreen          = 13,
	TryShowMultipleSubscriptionsAlert        = 14,
	TryPushGiftingScreen                     = 15,
	TryPushMessagingScreen                   = 16,
	TryGoToBattlePassTab                     = 17,
	TryShowRefundTokenNotification           = 18,
	EOptionalFlowSteps_MAX                   = 19,
};
...
public:
	...
	class FName                                   VideoDisplayDataID;                                // 0x0010(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	bool                                          bCheckAutoPlay;                                    // 0x0020(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bForceAutoPlay;                                    // 0x0021(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bStreamingEnabled;                                 // 0x0022(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_23[0x5];                                       // 0x0023(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 VideoUID;                                          // 0x0028(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShouldBeModal;                                    // 0x0038(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseSkipBoundaries;                                // 0x0039(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bHoldToSkip;                                       // 0x003A(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bFadeFromWhite;                                    // 0x003B(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAllowSkipping;                                    // 0x003C(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3D[0x3];                                       // 0x003D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 mimetype;                                          // 0x0040(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 VideoURL;                                          // 0x0050(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableLooping;                                    // 0x0060(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAutoClose;                                        // 0x0061(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bHideControls;                                     // 0x0062(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bHideBackground;                                   // 0x0063(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bStartMTTransparent;                               // 0x0064(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_65[0x3];                                       // 0x0065(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class USoundMix*                              SoundMixOverride;                                  // 0x0068(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bOverrideSoundMix;                                 // 0x0070(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bControlWorldRendering;                            // 0x0071(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FVideoWidgetConfig, VideoDisplayDataID) == 0x000010, "Member 'FVideoWidgetConfig::VideoDisplayDataID' has a wrong offset!");
static_assert(offsetof(FVideoWidgetConfig, FallbackVideoID) == 0x000018, "Member 'FVideoWidgetConfig::FallbackVideoID' has a wrong offset!");
static_assert(offsetof(FVideoWidgetConfig, bCheckAutoPlay) == 0x000020, "Member 'FVideoWidgetConfig::bCheckAutoPlay' has a wrong offset!");
static_assert(offsetof(FVideoWidgetConfig, bForceAutoPlay) == 0x000021, "Member 'FVideoWidgetConfig::bForceAutoPlay' has a wrong offset!");
static_assert(offsetof(FVideoWidgetConfig, bStreamingEnabled) == 0x000022, "Member 'FVideoWidgetConfig::bStreamingEnabled' has a wrong offset!");
static_assert(offsetof(FVideoWidgetConfig, VideoUID) == 0x000028, "Member 'FVideoWidgetConfig::VideoUID' has a wrong offset!");
static_assert(offsetof(FVideoWidgetConfig, bShouldBeModal) == 0x000038, "Member 'FVideoWidgetConfig::bShouldBeModal' has a wrong offset!");
static_assert(offsetof(FVideoWidgetConfig, bUseSkipBoundaries) == 0x000039, "Member 'FVideoWidgetConfig::bUseSkipBoundaries' has a wrong offset!");
static_assert(offsetof(FVideoWidgetConfig, bHoldToSkip) == 0x00003A, "Member 'FVideoWidgetConfig::bHoldToSkip' has a wrong offset!");
static_assert(offsetof(FVideoWidgetConfig, bFadeFromWhite) == 0x00003B, "Member 'FVideoWidgetConfig::bFadeFromWhite' has a wrong offset!");
static_assert(offsetof(FVideoWidgetConfig, bAllowSkipping) == 0x00003C, "Member 'FVideoWidgetConfig::bAllowSkipping' has a wrong offset!");
static_assert(offsetof(FVideoWidgetConfig, mimetype) == 0x000040, "Member 'FVideoWidgetConfig::mimetype' has a wrong offset!");
static_assert(offsetof(FVideoWidgetConfig, VideoURL) == 0x000050, "Member 'FVideoWidgetConfig::VideoURL' has a wrong offset!");
static_assert(offsetof(FVideoWidgetConfig, bEnableLooping) == 0x000060, "Member 'FVideoWidgetConfig::bEnableLooping' has a wrong offset!");
static_assert(offsetof(FVideoWidgetConfig, bAutoClose) == 0x000061, "Member 'FVideoWidgetConfig::bAutoClose' has a wrong offset!");
static_assert(offsetof(FVideoWidgetConfig, bHideControls) == 0x000062, "Member 'FVideoWidgetConfig::bHideControls' has a wrong offset!");
static_assert(offsetof(FVideoWidgetConfig, bHideBackground) == 0x000063, "Member 'FVideoWidgetConfig::bHideBackground' has a wrong offset!");
static_assert(offsetof(FVideoWidgetConfig, bStartMTTransparent) == 0x000064, "Member 'FVideoWidgetConfig::bStartMTTransparent' has a wrong offset!");
static_assert(offsetof(FVideoWidgetConfig, SoundMixOverride) == 0x000068, "Member 'FVideoWidgetConfig::SoundMixOverride' has a wrong offset!");
static_assert(offsetof(FVideoWidgetConfig, bOverrideSoundMix) == 0x000070, "Member 'FVideoWidgetConfig::bOverrideSoundMix' has a wrong offset!");
static_assert(offsetof(FVideoWidgetConfig, bControlWorldRendering) == 0x000071, "Member 'FVideoWidgetConfig::bControlWorldRendering' has a wrong offset!");
...
struct alignas(0x08) FRewardPreviewParams final
{
public:
	uint8                                         Pad_0[0x48];                                       // 0x0000(0x0048)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FRewardPreviewParams) == 0x000008, "Wrong alignment on FRewardPreviewParams");
static_assert(sizeof(FRewardPreviewParams) == 0x000048, "Wrong size on FRewardPreviewParams");
...
struct FAthenaCrewPackItem final
{
public:
	class FString                                 TemplateId;                                        // 0x0000(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 OfferTag;                                          // 0x0010(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(FAthenaCrewPackItem) == 0x000008, "Wrong alignment on FAthenaCrewPackItem");
static_assert(sizeof(FAthenaCrewPackItem) == 0x000028, "Wrong size on FAthenaCrewPackItem");
static_assert(offsetof(FAthenaCrewPackItem, TemplateId) == 0x000000, "Member 'FAthenaCrewPackItem::TemplateId' has a wrong offset!");
static_assert(offsetof(FAthenaCrewPackItem, OfferTag) == 0x000010, "Member 'FAthenaCrewPackItem::OfferTag' has a wrong offset!");
static_assert(offsetof(FAthenaCrewPackItem, Quantity) == 0x000020, "Member 'FAthenaCrewPackItem::Quantity' has a wrong offset!");
...
{
public:
	class FString                                 SkinImageURL;                                      // 0x0000(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FText                                   SkinTitle;                                         // 0x0010(0x0018)(NativeAccessSpecifierPublic)
	bool                                          bSkinImageTakeOver;                                // 0x0028(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_29[0x7];                                       // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   MtxTitle;                                          // 0x0030(0x0018)(NativeAccessSpecifierPublic)
	class FString                                 BattlepassImageURL;                                // 0x0048(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 BattlepassTileImageURL;                            // 0x0058(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FText                                   BattlepassTitle;                                   // 0x0068(0x0018)(NativeAccessSpecifierPublic)
	class FText                                   BattlepassDescription;                             // 0x0080(0x0018)(NativeAccessSpecifierPublic)
	class FString                                 ColorA;                                            // 0x0098(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 ColorB;                                            // 0x00A8(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 ColorC;                                            // 0x00B8(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 ItemShopTileImageURL;                              // 0x00C8(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FText                                   ItemShopTileViolatorText;                          // 0x00D8(0x0018)(NativeAccessSpecifierPublic)
	EViolatorIntensity                            ItemShopTileViolatorIntensity;                     // 0x00F0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_F1[0x7];                                       // 0x00F1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FDateTime                              CrewPackDateOverride;                              // 0x00F8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FAthenaCrewPackItem>            CrewPackItems;                                     // 0x0100(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FAthenaSubscriptionMonthlyRewards) == 0x000008, "Wrong alignment on FAthenaSubscriptionMonthlyRewards");
static_assert(sizeof(FAthenaSubscriptionMonthlyRewards) == 0x000110, "Wrong size on FAthenaSubscriptionMonthlyRewards");
static_assert(offsetof(FAthenaSubscriptionMonthlyRewards, SkinImageURL) == 0x000000, "Member 'FAthenaSubscriptionMonthlyRewards::SkinImageURL' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionMonthlyRewards, SkinTitle) == 0x000010, "Member 'FAthenaSubscriptionMonthlyRewards::SkinTitle' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionMonthlyRewards, bSkinImageTakeOver) == 0x000028, "Member 'FAthenaSubscriptionMonthlyRewards::bSkinImageTakeOver' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionMonthlyRewards, MtxTitle) == 0x000030, "Member 'FAthenaSubscriptionMonthlyRewards::MtxTitle' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionMonthlyRewards, BattlepassImageURL) == 0x000048, "Member 'FAthenaSubscriptionMonthlyRewards::BattlepassImageURL' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionMonthlyRewards, BattlepassTileImageURL) == 0x000058, "Member 'FAthenaSubscriptionMonthlyRewards::BattlepassTileImageURL' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionMonthlyRewards, BattlepassTitle) == 0x000068, "Member 'FAthenaSubscriptionMonthlyRewards::BattlepassTitle' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionMonthlyRewards, BattlepassDescription) == 0x000080, "Member 'FAthenaSubscriptionMonthlyRewards::BattlepassDescription' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionMonthlyRewards, ColorA) == 0x000098, "Member 'FAthenaSubscriptionMonthlyRewards::ColorA' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionMonthlyRewards, ColorB) == 0x0000A8, "Member 'FAthenaSubscriptionMonthlyRewards::ColorB' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionMonthlyRewards, ColorC) == 0x0000B8, "Member 'FAthenaSubscriptionMonthlyRewards::ColorC' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionMonthlyRewards, ItemShopTileImageURL) == 0x0000C8, "Member 'FAthenaSubscriptionMonthlyRewards::ItemShopTileImageURL' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionMonthlyRewards, ItemShopTileViolatorText) == 0x0000D8, "Member 'FAthenaSubscriptionMonthlyRewards::ItemShopTileViolatorText' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionMonthlyRewards, ItemShopTileViolatorIntensity) == 0x0000F0, "Member 'FAthenaSubscriptionMonthlyRewards::ItemShopTileViolatorIntensity' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionMonthlyRewards, CrewPackDateOverride) == 0x0000F8, "Member 'FAthenaSubscriptionMonthlyRewards::CrewPackDateOverride' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionMonthlyRewards, CrewPackItems) == 0x000100, "Member 'FAthenaSubscriptionMonthlyRewards::CrewPackItems' has a wrong offset!");
...
// 0x0050 (0x0050 - 0x0000)
struct FSubscriptionBulletPoint final
{
public:
	...
	class FString                                 IncludedCountries;                                 // 0x0030(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class FString>                         IncludedPlatforms;                                 // 0x0040(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FSubscriptionBulletPoint) == 0x000008, "Wrong alignment on FSubscriptionBulletPoint");
static_assert(sizeof(FSubscriptionBulletPoint) == 0x000050, "Wrong size on FSubscriptionBulletPoint");
static_assert(offsetof(FSubscriptionBulletPoint, Title) == 0x000000, "Member 'FSubscriptionBulletPoint::Title' has a wrong offset!");
static_assert(offsetof(FSubscriptionBulletPoint, Description) == 0x000018, "Member 'FSubscriptionBulletPoint::Description' has a wrong offset!");
static_assert(offsetof(FSubscriptionBulletPoint, IncludedCountries) == 0x000030, "Member 'FSubscriptionBulletPoint::IncludedCountries' has a wrong offset!");
static_assert(offsetof(FSubscriptionBulletPoint, IncludedPlatforms) == 0x000040, "Member 'FSubscriptionBulletPoint::IncludedPlatforms' has a wrong offset!");

// ScriptStruct FortniteUI.SubscriptionBulletPoints
// 0x0010 (0x0010 - 0x0000)
struct FSubscriptionBulletPoints final
{
public:
	TArray<struct FSubscriptionBulletPoint>       BulletPoints;                                      // 0x0000(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FSubscriptionBulletPoints) == 0x000008, "Wrong alignment on FSubscriptionBulletPoints");
static_assert(sizeof(FSubscriptionBulletPoints) == 0x000010, "Wrong size on FSubscriptionBulletPoints");
static_assert(offsetof(FSubscriptionBulletPoints, BulletPoints) == 0x000000, "Member 'FSubscriptionBulletPoints::BulletPoints' has a wrong offset!");

// ScriptStruct FortniteUI.AthenaSubscriptionPurchaseDetails
// 0x00A8 (0x00A8 - 0x0000)
struct FAthenaSubscriptionPurchaseDetails final
{
public:
	class FText                                   SkinTitle;                                         // 0x0000(0x0018)(NativeAccessSpecifierPublic)
	class FText                                   SkinDescription;                                   // 0x0018(0x0018)(NativeAccessSpecifierPublic)
	class FText                                   MtxTitle;                                          // 0x0030(0x0018)(NativeAccessSpecifierPublic)
	class FText                                   MtxDescription;                                    // 0x0048(0x0018)(NativeAccessSpecifierPublic)
	class FText                                   BattlepassTitle;                                   // 0x0060(0x0018)(NativeAccessSpecifierPublic)
	class FText                                   BattlepassDescription;                             // 0x0078(0x0018)(NativeAccessSpecifierPublic)
	int32                                         BattlepassRefund;                                  // 0x0090(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_94[0x4];                                       // 0x0094(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSubscriptionBulletPoints              AdditionalBulletPoints;                            // 0x0098(0x0010)(NativeAccessSpecifierPublic)
};
static_assert(alignof(FAthenaSubscriptionPurchaseDetails) == 0x000008, "Wrong alignment on FAthenaSubscriptionPurchaseDetails");
static_assert(sizeof(FAthenaSubscriptionPurchaseDetails) == 0x0000A8, "Wrong size on FAthenaSubscriptionPurchaseDetails");
static_assert(offsetof(FAthenaSubscriptionPurchaseDetails, SkinTitle) == 0x000000, "Member 'FAthenaSubscriptionPurchaseDetails::SkinTitle' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionPurchaseDetails, SkinDescription) == 0x000018, "Member 'FAthenaSubscriptionPurchaseDetails::SkinDescription' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionPurchaseDetails, MtxTitle) == 0x000030, "Member 'FAthenaSubscriptionPurchaseDetails::MtxTitle' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionPurchaseDetails, MtxDescription) == 0x000048, "Member 'FAthenaSubscriptionPurchaseDetails::MtxDescription' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionPurchaseDetails, BattlepassTitle) == 0x000060, "Member 'FAthenaSubscriptionPurchaseDetails::BattlepassTitle' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionPurchaseDetails, BattlepassDescription) == 0x000078, "Member 'FAthenaSubscriptionPurchaseDetails::BattlepassDescription' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionPurchaseDetails, BattlepassRefund) == 0x000090, "Member 'FAthenaSubscriptionPurchaseDetails::BattlepassRefund' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionPurchaseDetails, AdditionalBulletPoints) == 0x000098, "Member 'FAthenaSubscriptionPurchaseDetails::AdditionalBulletPoints' has a wrong offset!");
...
struct FAthenaSubscriptionInfo final
{
public:
	struct FAthenaSubscriptionMonthlyRewards      CurrentRewards;                                    // 0x0000(0x0110)(NativeAccessSpecifierPublic)
	struct FAthenaSubscriptionMonthlyRewards      NextRewards;                                       // 0x0110(0x0110)(NativeAccessSpecifierPublic)
	struct FAthenaSubscriptionProgressiveInfo     ProgressiveInfo;                                   // 0x0220(0x00A8)(NativeAccessSpecifierPublic)
	struct FAthenaSubscriptionPurchaseDetails     PurchaseSubscriptionDetails;                       // 0x02C8(0x00A8)(NativeAccessSpecifierPublic)
	class FText                                   SubscriptionDisclaimer;                            // 0x0370(0x0018)(NativeAccessSpecifierPublic)
	class FText                                   BlockedBenefitsNotice;                             // 0x0388(0x0018)(NativeAccessSpecifierPublic)
	class FText                                   RewardsDelayedNotice;                              // 0x03A0(0x0018)(NativeAccessSpecifierPublic)
	struct FSubscriptionModals                    SubModals;                                         // 0x03B8(0x0010)(NativeAccessSpecifierPublic)
};
static_assert(alignof(FAthenaSubscriptionInfo) == 0x000008, "Wrong alignment on FAthenaSubscriptionInfo");
static_assert(sizeof(FAthenaSubscriptionInfo) == 0x0003C8, "Wrong size on FAthenaSubscriptionInfo");
static_assert(offsetof(FAthenaSubscriptionInfo, CurrentRewards) == 0x000000, "Member 'FAthenaSubscriptionInfo::CurrentRewards' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionInfo, NextRewards) == 0x000110, "Member 'FAthenaSubscriptionInfo::NextRewards' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionInfo, ProgressiveInfo) == 0x000220, "Member 'FAthenaSubscriptionInfo::ProgressiveInfo' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionInfo, PurchaseSubscriptionDetails) == 0x0002C8, "Member 'FAthenaSubscriptionInfo::PurchaseSubscriptionDetails' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionInfo, SubscriptionDisclaimer) == 0x000370, "Member 'FAthenaSubscriptionInfo::SubscriptionDisclaimer' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionInfo, BlockedBenefitsNotice) == 0x000388, "Member 'FAthenaSubscriptionInfo::BlockedBenefitsNotice' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionInfo, RewardsDelayedNotice) == 0x0003A0, "Member 'FAthenaSubscriptionInfo::RewardsDelayedNotice' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionInfo, SubModals) == 0x0003B8, "Member 'FAthenaSubscriptionInfo::SubModals' has a wrong offset!");
...
public:
	...
	TArray<class FText>                           RoundDisplayNames;                                 // 0x01A8(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FFortTournamentDisplayInfo) == 0x000008, "Wrong alignment on FFortTournamentDisplayInfo");
static_assert(sizeof(FFortTournamentDisplayInfo) == 0x0001B8, "Wrong size on FFortTournamentDisplayInfo");
...
static_assert(offsetof(FFortTournamentDisplayInfo, RoundDisplayNames) == 0x0001A8, "Member 'FFortTournamentDisplayInfo::RoundDisplayNames' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_89[0x47];                                      // 0x0089(0x0047)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(sizeof(FBattlePassPurchaseData) == 0x000028, "Wrong size on FBattlePassPurchaseData");
...
struct FAthenaSubscriptionExpectedRewards final : public FAthenaSubscriptionMonthlyRewards
{
public:
	EMcpSubscriptionState                         SubscriptionState;                                 // 0x0110(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_111[0x17];                                     // 0x0111(0x0017)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   SkinDescription;                                   // 0x0128(0x0018)(NativeAccessSpecifierPublic)
	class FText                                   MtxDescription;                                    // 0x0140(0x0018)(NativeAccessSpecifierPublic)
	bool                                          bUsingNextSkin;                                    // 0x0158(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUsingNextBattlepassImage;                         // 0x0159(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUsingNextBattlepassTexts;                         // 0x015A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUsingNextSkinTileImage;                           // 0x015B(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_15C[0x4];                                      // 0x015C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAthenaSubscriptionExpectedRewards) == 0x000008, "Wrong alignment on FAthenaSubscriptionExpectedRewards");
static_assert(sizeof(FAthenaSubscriptionExpectedRewards) == 0x000160, "Wrong size on FAthenaSubscriptionExpectedRewards");
static_assert(offsetof(FAthenaSubscriptionExpectedRewards, SubscriptionState) == 0x000110, "Member 'FAthenaSubscriptionExpectedRewards::SubscriptionState' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionExpectedRewards, SkinDescription) == 0x000128, "Member 'FAthenaSubscriptionExpectedRewards::SkinDescription' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionExpectedRewards, MtxDescription) == 0x000140, "Member 'FAthenaSubscriptionExpectedRewards::MtxDescription' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionExpectedRewards, bUsingNextSkin) == 0x000158, "Member 'FAthenaSubscriptionExpectedRewards::bUsingNextSkin' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionExpectedRewards, bUsingNextBattlepassImage) == 0x000159, "Member 'FAthenaSubscriptionExpectedRewards::bUsingNextBattlepassImage' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionExpectedRewards, bUsingNextBattlepassTexts) == 0x00015A, "Member 'FAthenaSubscriptionExpectedRewards::bUsingNextBattlepassTexts' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionExpectedRewards, bUsingNextSkinTileImage) == 0x00015B, "Member 'FAthenaSubscriptionExpectedRewards::bUsingNextSkinTileImage' has a wrong offset!");
...
// 0x0068 (0x0068 - 0x0000)
struct FRewardCategoryTabData final
{
public:
	...
	struct FGameplayTagContainer                  ExcludeTags;                                       // 0x0040(0x0020)(Edit, NativeAccessSpecifierPublic)
	bool                                          bDefaultEntry;                                     // 0x0060(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_61[0x7];                                       // 0x0061(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FRewardCategoryTabData) == 0x000008, "Wrong alignment on FRewardCategoryTabData");
static_assert(sizeof(FRewardCategoryTabData) == 0x000068, "Wrong size on FRewardCategoryTabData");
static_assert(offsetof(FRewardCategoryTabData, TabDisplayAsset) == 0x000000, "Member 'FRewardCategoryTabData::TabDisplayAsset' has a wrong offset!");
static_assert(offsetof(FRewardCategoryTabData, DisplayName) == 0x000008, "Member 'FRewardCategoryTabData::DisplayName' has a wrong offset!");
static_assert(offsetof(FRewardCategoryTabData, IncludeTags) == 0x000020, "Member 'FRewardCategoryTabData::IncludeTags' has a wrong offset!");
static_assert(offsetof(FRewardCategoryTabData, ExcludeTags) == 0x000040, "Member 'FRewardCategoryTabData::ExcludeTags' has a wrong offset!");
static_assert(offsetof(FRewardCategoryTabData, bDefaultEntry) == 0x000060, "Member 'FRewardCategoryTabData::bDefaultEntry' has a wrong offset!");
...
// ScriptStruct FortniteUI.QuestCategoryTabData
// 0x0020 (0x0020 - 0x0000)
struct FQuestCategoryTabData final
{
public:
	class UObject*                                TabDisplayAsset;                                   // 0x0000(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FText                                   DisplayName;                                       // 0x0008(0x0018)(Edit, NativeAccessSpecifierPublic)
};
static_assert(alignof(FQuestCategoryTabData) == 0x000008, "Wrong alignment on FQuestCategoryTabData");
static_assert(sizeof(FQuestCategoryTabData) == 0x000020, "Wrong size on FQuestCategoryTabData");
static_assert(offsetof(FQuestCategoryTabData, TabDisplayAsset) == 0x000000, "Member 'FQuestCategoryTabData::TabDisplayAsset' has a wrong offset!");
static_assert(offsetof(FQuestCategoryTabData, DisplayName) == 0x000008, "Member 'FQuestCategoryTabData::DisplayName' has a wrong offset!");
...
public:
	class UObject*                                TabDisplayAsset;                                   // 0x0000(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FText                                   DisplayName;                                       // 0x0008(0x0018)(Edit, NativeAccessSpecifierPublic)
	struct FGameplayTag                           IncludeTag;                                        // 0x0020(0x0008)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_28[0x8];                                       // 0x0028(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FGoalsPageCategoryTabData) == 0x000008, "Wrong alignment on FGoalsPageCategoryTabData");
static_assert(sizeof(FGoalsPageCategoryTabData) == 0x000030, "Wrong size on FGoalsPageCategoryTabData");
...
public:
	struct FGameplayTagContainer                  ItemTags;                                          // 0x0008(0x0020)(Edit, NativeAccessSpecifierPublic)
	struct FStatBound                             Damage;                                            // 0x0028(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FStatBound                             FireRate;                                          // 0x0030(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FStatBound                             MagazineSize;                                      // 0x0038(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FStatBound                             ReloadTime;                                        // 0x0040(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FAthenaItemShopSectionData) == 0x000058, "Wrong size on FAthenaItemShopSectionData");
...
static_assert(sizeof(FPreviewRewardData) == 0x000098, "Wrong size on FPreviewRewardData");
...
public:
	...
	TSoftObjectPtr<class UTexture2D>              Icon;                                              // 0x0020(0x0028)(BlueprintVisible, BlueprintReadOnly, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	class UFortVariantTokenType*                  VariantToken;                                      // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftObjectPtr<class UObject>                 TileMaterial;                                      // 0x0008(0x0028)(BlueprintVisible, BlueprintReadOnly, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bHidden;                                           // 0x0030(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsLocked;                                         // 0x0031(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_32[0x2];                                       // 0x0032(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         AdditionalMonthsRequired;                          // 0x0034(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         StageIndex;                                        // 0x0038(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3C[0x4];                                       // 0x003C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FProgressiveStageItemInfo) == 0x000008, "Wrong alignment on FProgressiveStageItemInfo");
static_assert(sizeof(FProgressiveStageItemInfo) == 0x000040, "Wrong size on FProgressiveStageItemInfo");
static_assert(offsetof(FProgressiveStageItemInfo, VariantToken) == 0x000000, "Member 'FProgressiveStageItemInfo::VariantToken' has a wrong offset!");
static_assert(offsetof(FProgressiveStageItemInfo, TileMaterial) == 0x000008, "Member 'FProgressiveStageItemInfo::TileMaterial' has a wrong offset!");
static_assert(offsetof(FProgressiveStageItemInfo, bHidden) == 0x000030, "Member 'FProgressiveStageItemInfo::bHidden' has a wrong offset!");
static_assert(offsetof(FProgressiveStageItemInfo, bIsLocked) == 0x000031, "Member 'FProgressiveStageItemInfo::bIsLocked' has a wrong offset!");
static_assert(offsetof(FProgressiveStageItemInfo, AdditionalMonthsRequired) == 0x000034, "Member 'FProgressiveStageItemInfo::AdditionalMonthsRequired' has a wrong offset!");
static_assert(offsetof(FProgressiveStageItemInfo, StageIndex) == 0x000038, "Member 'FProgressiveStageItemInfo::StageIndex' has a wrong offset!");
...
public:
	...
	class UFortItemDefinition*                    OptionalItemVariantIsUsedFor;                      // 0x0020(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FVaultVariantOverrideOption) == 0x000008, "Wrong alignment on FVaultVariantOverrideOption");
static_assert(sizeof(FVaultVariantOverrideOption) == 0x000028, "Wrong size on FVaultVariantOverrideOption");
...
static_assert(offsetof(FVaultVariantOverrideOption, OptionalItemVariantIsUsedFor) == 0x000020, "Member 'FVaultVariantOverrideOption::OptionalItemVariantIsUsedFor' has a wrong offset!");
...
public:
	...
	class FName                                   TabNameID;                                         // 0x0018(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	struct FEventMessageTag                       EventMessageTag;                                   // 0x0000(0x0008)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ESlateVisibility                              MessageReceivedVisibility;                         // 0x0008(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ESlateVisibility                              MessageStateClearedVisibility;                     // 0x0009(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_A[0x2];                                        // 0x000A(0x0002)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FGameplayMessageVisibility) == 0x000004, "Wrong alignment on FGameplayMessageVisibility");
static_assert(sizeof(FGameplayMessageVisibility) == 0x00000C, "Wrong size on FGameplayMessageVisibility");
...
static_assert(offsetof(FGameplayMessageVisibility, MessageReceivedVisibility) == 0x000008, "Member 'FGameplayMessageVisibility::MessageReceivedVisibility' has a wrong offset!");
static_assert(offsetof(FGameplayMessageVisibility, MessageStateClearedVisibility) == 0x000009, "Member 'FGameplayMessageVisibility::MessageStateClearedVisibility' has a wrong offset!");
...
public:
	...
	bool                                          bHyperlinkStyle;                                   // 0x0278(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FFortRichTextStyleData) == 0x000280, "Wrong size on FFortRichTextStyleData");
...
static_assert(offsetof(FFortRichTextStyleData, bHyperlinkStyle) == 0x000278, "Member 'FFortRichTextStyleData::bHyperlinkStyle' has a wrong offset!");
...
public:
	...
	bool                                          bDynamicTab;                                       // 0x0019(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FSubscriptionContentTabData, bDynamicTab) == 0x000019, "Member 'FSubscriptionContentTabData::bDynamicTab' has a wrong offset!");
...
public:
	...
	TScriptInterface<class IFortUIManagerInterface> Manager;                                           // 0x0008(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, NativeAccessSpecifierPublic)
};
