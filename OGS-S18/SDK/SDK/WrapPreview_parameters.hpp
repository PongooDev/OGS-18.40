...
public:
	...
	bool                                          K2Node_Event_bUseSecondaryTransitionEffects;       // 0x0048(0x0001)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_Event_bShowFloor;                           // 0x0049(0x0001)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsMobileGame_ReturnValue;                 // 0x004A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_4B[0x5];                                       // 0x004B(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	class UFortGameUserSettings*                  CallFunc_GetFortGameUserSettings_ReturnValue;      // 0x0050(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsInPerformanceMode_ReturnValue;          // 0x0058(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	bool                                          K2Node_Event_bEnableAutotestBackground;            // 0x006D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	bool                                          CallFunc_IsErebus_ReturnValue;                     // 0x0078(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(WrapPreview_C_ExecuteUbergraph_WrapPreview) == 0x000080, "Wrong size on WrapPreview_C_ExecuteUbergraph_WrapPreview");
...
static_assert(offsetof(WrapPreview_C_ExecuteUbergraph_WrapPreview, CallFunc_K2_GetActorLocation_ReturnValue) == 0x000004, "Member 'WrapPreview_C_ExecuteUbergraph_WrapPreview::CallFunc_K2_GetActorLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(WrapPreview_C_ExecuteUbergraph_WrapPreview, CallFunc_GetGameUserSettings_ReturnValue) == 0x000010, "Member 'WrapPreview_C_ExecuteUbergraph_WrapPreview::CallFunc_GetGameUserSettings_ReturnValue' has a wrong offset!");
static_assert(offsetof(WrapPreview_C_ExecuteUbergraph_WrapPreview, CallFunc_GetShadowQuality_ReturnValue) == 0x000018, "Member 'WrapPreview_C_ExecuteUbergraph_WrapPreview::CallFunc_GetShadowQuality_ReturnValue' has a wrong offset!");
static_assert(offsetof(WrapPreview_C_ExecuteUbergraph_WrapPreview, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x00001C, "Member 'WrapPreview_C_ExecuteUbergraph_WrapPreview::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WrapPreview_C_ExecuteUbergraph_WrapPreview, CallFunc_K2_GetActorLocation_ReturnValue_1) == 0x000020, "Member 'WrapPreview_C_ExecuteUbergraph_WrapPreview::CallFunc_K2_GetActorLocation_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WrapPreview_C_ExecuteUbergraph_WrapPreview, CallFunc_SpawnEmitterAtLocation_ReturnValue) == 0x000030, "Member 'WrapPreview_C_ExecuteUbergraph_WrapPreview::CallFunc_SpawnEmitterAtLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(WrapPreview_C_ExecuteUbergraph_WrapPreview, K2Node_Event_InMaterialInstance) == 0x000038, "Member 'WrapPreview_C_ExecuteUbergraph_WrapPreview::K2Node_Event_InMaterialInstance' has a wrong offset!");
static_assert(offsetof(WrapPreview_C_ExecuteUbergraph_WrapPreview, CallFunc_CreateDynamicMaterialInstance_ReturnValue) == 0x000040, "Member 'WrapPreview_C_ExecuteUbergraph_WrapPreview::CallFunc_CreateDynamicMaterialInstance_ReturnValue' has a wrong offset!");
static_assert(offsetof(WrapPreview_C_ExecuteUbergraph_WrapPreview, K2Node_Event_bUseSecondaryTransitionEffects) == 0x000048, "Member 'WrapPreview_C_ExecuteUbergraph_WrapPreview::K2Node_Event_bUseSecondaryTransitionEffects' has a wrong offset!");
static_assert(offsetof(WrapPreview_C_ExecuteUbergraph_WrapPreview, K2Node_Event_bShowFloor) == 0x000049, "Member 'WrapPreview_C_ExecuteUbergraph_WrapPreview::K2Node_Event_bShowFloor' has a wrong offset!");
static_assert(offsetof(WrapPreview_C_ExecuteUbergraph_WrapPreview, CallFunc_IsMobileGame_ReturnValue) == 0x00004A, "Member 'WrapPreview_C_ExecuteUbergraph_WrapPreview::CallFunc_IsMobileGame_ReturnValue' has a wrong offset!");
static_assert(offsetof(WrapPreview_C_ExecuteUbergraph_WrapPreview, CallFunc_GetFortGameUserSettings_ReturnValue) == 0x000050, "Member 'WrapPreview_C_ExecuteUbergraph_WrapPreview::CallFunc_GetFortGameUserSettings_ReturnValue' has a wrong offset!");
static_assert(offsetof(WrapPreview_C_ExecuteUbergraph_WrapPreview, CallFunc_IsInPerformanceMode_ReturnValue) == 0x000058, "Member 'WrapPreview_C_ExecuteUbergraph_WrapPreview::CallFunc_IsInPerformanceMode_ReturnValue' has a wrong offset!");
static_assert(offsetof(WrapPreview_C_ExecuteUbergraph_WrapPreview, K2Node_CreateDelegate_OutputDelegate) == 0x00005C, "Member 'WrapPreview_C_ExecuteUbergraph_WrapPreview::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(WrapPreview_C_ExecuteUbergraph_WrapPreview, CallFunc_BooleanOR_ReturnValue) == 0x00006C, "Member 'WrapPreview_C_ExecuteUbergraph_WrapPreview::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
static_assert(offsetof(WrapPreview_C_ExecuteUbergraph_WrapPreview, K2Node_Event_bEnableAutotestBackground) == 0x00006D, "Member 'WrapPreview_C_ExecuteUbergraph_WrapPreview::K2Node_Event_bEnableAutotestBackground' has a wrong offset!");
static_assert(offsetof(WrapPreview_C_ExecuteUbergraph_WrapPreview, CallFunc_CreateDynamicMaterialInstance_ReturnValue_1) == 0x000070, "Member 'WrapPreview_C_ExecuteUbergraph_WrapPreview::CallFunc_CreateDynamicMaterialInstance_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WrapPreview_C_ExecuteUbergraph_WrapPreview, CallFunc_IsErebus_ReturnValue) == 0x000078, "Member 'WrapPreview_C_ExecuteUbergraph_WrapPreview::CallFunc_IsErebus_ReturnValue' has a wrong offset!");
static_assert(offsetof(WrapPreview_C_ExecuteUbergraph_WrapPreview, CallFunc_BooleanOR_ReturnValue_1) == 0x000079, "Member 'WrapPreview_C_ExecuteUbergraph_WrapPreview::CallFunc_BooleanOR_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WrapPreview_C_ExecuteUbergraph_WrapPreview, CallFunc_BooleanOR_ReturnValue_2) == 0x00007A, "Member 'WrapPreview_C_ExecuteUbergraph_WrapPreview::CallFunc_BooleanOR_ReturnValue_2' has a wrong offset!");
