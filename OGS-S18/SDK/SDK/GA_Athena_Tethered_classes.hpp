...
static_assert(sizeof(UGA_Athena_Tethered_C) == 0x000B38, "Wrong size on UGA_Athena_Tethered_C");
...
static_assert(offsetof(UGA_Athena_Tethered_C, BreakStructuresOnTetherRange) == 0x000B08, "Member 'UGA_Athena_Tethered_C::BreakStructuresOnTetherRange' has a wrong offset!");
static_assert(offsetof(UGA_Athena_Tethered_C, Event_FishingForceEnd) == 0x000B30, "Member 'UGA_Athena_Tethered_C::Event_FishingForceEnd' has a wrong offset!");
