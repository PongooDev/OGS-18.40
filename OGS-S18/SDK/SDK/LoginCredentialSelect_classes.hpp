...
public:
	...
	class UCommonWidgetSwitcherLegacy*            CommonWidgetSwitcher_0;                            // 0x0308(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
