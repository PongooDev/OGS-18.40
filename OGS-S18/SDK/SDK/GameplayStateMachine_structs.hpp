...
static_assert(offsetof(FActiveGameplayStateData, BeginStateDelay) == 0x000010, "Member 'FActiveGameplayStateData::BeginStateDelay' has a wrong offset!");
static_assert(offsetof(FActiveGameplayStateData, InitializationTime) == 0x000014, "Member 'FActiveGameplayStateData::InitializationTime' has a wrong offset!");
...
static_assert(sizeof(FGameplayStateTransition) == 0x000030, "Wrong size on FGameplayStateTransition");
...
static_assert(offsetof(FGameplayStateTransition, BeginStateDelay) == 0x000028, "Member 'FGameplayStateTransition::BeginStateDelay' has a wrong offset!");
