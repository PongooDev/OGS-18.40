...
static_assert(sizeof(UTabAccountOptions_New_C) == 0x000398, "Wrong size on UTabAccountOptions_New_C");
static_assert(offsetof(UTabAccountOptions_New_C, UberGraphFrame) == 0x000390, "Member 'UTabAccountOptions_New_C::UberGraphFrame' has a wrong offset!");
