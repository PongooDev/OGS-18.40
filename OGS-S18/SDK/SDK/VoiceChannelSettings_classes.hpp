...
public:
	...
	class UWidgetAnimation*                       GearHover;                                         // 0x0318(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash)
	...
	class UCommonTextBlock*                       Text_LowPowerMode;                                 // 0x0370(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UImage*                                 VoiceDisabledIcon;                                 // 0x0378(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UCommonRichTextBlock*                   VoiceDisabledText;                                 // 0x0380(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(UVoiceChannelSettings_C) == 0x000388, "Wrong size on UVoiceChannelSettings_C");
static_assert(offsetof(UVoiceChannelSettings_C, UberGraphFrame) == 0x000310, "Member 'UVoiceChannelSettings_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UVoiceChannelSettings_C, GearHover) == 0x000318, "Member 'UVoiceChannelSettings_C::GearHover' has a wrong offset!");
...
static_assert(offsetof(UVoiceChannelSettings_C, Text_LowPowerMode) == 0x000370, "Member 'UVoiceChannelSettings_C::Text_LowPowerMode' has a wrong offset!");
static_assert(offsetof(UVoiceChannelSettings_C, VoiceDisabledIcon) == 0x000378, "Member 'UVoiceChannelSettings_C::VoiceDisabledIcon' has a wrong offset!");
static_assert(offsetof(UVoiceChannelSettings_C, VoiceDisabledText) == 0x000380, "Member 'UVoiceChannelSettings_C::VoiceDisabledText' has a wrong offset!");
