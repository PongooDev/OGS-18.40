...
{
public:
	struct FHitResult                             InOutImpact;                                       // 0x0000(0x0088)(Parm, OutParm, IsPlainOldData, NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
	class AFortPawn*                              FortPawn;                                          // 0x0088(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FortAthenaMutator_Knockback_HandleBlockedCharacterMovement) == 0x000090, "Wrong size on FortAthenaMutator_Knockback_HandleBlockedCharacterMovement");
...
static_assert(offsetof(FortAthenaMutator_Knockback_HandleBlockedCharacterMovement, FortPawn) == 0x000088, "Member 'FortAthenaMutator_Knockback_HandleBlockedCharacterMovement::FortPawn' has a wrong offset!");
