...
public:
	...
	TScriptInterface<class IFortVehicleInterface> K2Node_Event_Vehicle;                              // 0x0008(0x0010)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper)
	...
	TScriptInterface<class IFortVehicleInterface> K2Node_Event_Vehicle_1;                            // 0x0028(0x0010)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper)
...
public:
	...
	TDelegate<void(class UStreamingRadioPlayerComponent* Component, const struct FAthenaRadioStation& AffectedSource)> K2Node_CreateDelegate_OutputDelegate;              // 0x0018(0x0010)(ZeroConstructor, NoDestructor)
