...
public:
	...
	bool                                          bAboveSnowAltitude;                                // 0x00E4(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	...
	bool                                          bSnowAltitudeEnabled;                              // 0x00F0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	...
	bool                                          bIsIndoors;                                        // 0x0140(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	...
	bool                                          bTagApplicationEnabled;                            // 0x0160(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(UBP_AmbientAudioController_C) == 0x0001C0, "Wrong size on UBP_AmbientAudioController_C");
static_assert(offsetof(UBP_AmbientAudioController_C, UberGraphFrame) == 0x0000D8, "Member 'UBP_AmbientAudioController_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UBP_AmbientAudioController_C, CheckFrequency) == 0x0000E0, "Member 'UBP_AmbientAudioController_C::CheckFrequency' has a wrong offset!");
static_assert(offsetof(UBP_AmbientAudioController_C, bAboveSnowAltitude) == 0x0000E4, "Member 'UBP_AmbientAudioController_C::bAboveSnowAltitude' has a wrong offset!");
static_assert(offsetof(UBP_AmbientAudioController_C, WinterAudioBank) == 0x0000E8, "Member 'UBP_AmbientAudioController_C::WinterAudioBank' has a wrong offset!");
static_assert(offsetof(UBP_AmbientAudioController_C, bSnowAltitudeEnabled) == 0x0000F0, "Member 'UBP_AmbientAudioController_C::bSnowAltitudeEnabled' has a wrong offset!");
static_assert(offsetof(UBP_AmbientAudioController_C, StormAudioBank) == 0x0000F8, "Member 'UBP_AmbientAudioController_C::StormAudioBank' has a wrong offset!");
static_assert(offsetof(UBP_AmbientAudioController_C, AmbientAudioInsideTag) == 0x000100, "Member 'UBP_AmbientAudioController_C::AmbientAudioInsideTag' has a wrong offset!");
...
static_assert(offsetof(UBP_AmbientAudioController_C, SnowRadius) == 0x00011C, "Member 'UBP_AmbientAudioController_C::SnowRadius' has a wrong offset!");
...
static_assert(offsetof(UBP_AmbientAudioController_C, IndoorInterpTime) == 0x000138, "Member 'UBP_AmbientAudioController_C::IndoorInterpTime' has a wrong offset!");
static_assert(offsetof(UBP_AmbientAudioController_C, IndoorStateChangedTime) == 0x00013C, "Member 'UBP_AmbientAudioController_C::IndoorStateChangedTime' has a wrong offset!");
static_assert(offsetof(UBP_AmbientAudioController_C, bIsIndoors) == 0x000140, "Member 'UBP_AmbientAudioController_C::bIsIndoors' has a wrong offset!");
static_assert(offsetof(UBP_AmbientAudioController_C, IsPlayerIndoorsInterp) == 0x000144, "Member 'UBP_AmbientAudioController_C::IsPlayerIndoorsInterp' has a wrong offset!");
...
static_assert(offsetof(UBP_AmbientAudioController_C, Reverbs) == 0x000170, "Member 'UBP_AmbientAudioController_C::Reverbs' has a wrong offset!");
