...
static_assert(sizeof(FAnimNode_LayeredBoneBlend) == 0x0000C8, "Wrong size on FAnimNode_LayeredBoneBlend");
...
public:
	...
	uint8                                         Pad_208[0x588];                                    // 0x0208(0x0588)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_RigidBody) == 0x000010, "Wrong alignment on FAnimNode_RigidBody");
static_assert(sizeof(FAnimNode_RigidBody) == 0x000790, "Wrong size on FAnimNode_RigidBody");
