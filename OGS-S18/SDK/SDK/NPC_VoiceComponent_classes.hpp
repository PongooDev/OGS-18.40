...
static_assert(sizeof(UNPC_VoiceComponent_C) == 0x0000E0, "Wrong size on UNPC_VoiceComponent_C");
...
static_assert(offsetof(UNPC_VoiceComponent_C, Audio_Component) == 0x0000D0, "Member 'UNPC_VoiceComponent_C::Audio_Component' has a wrong offset!");
static_assert(offsetof(UNPC_VoiceComponent_C, SourceChainToApply) == 0x0000D8, "Member 'UNPC_VoiceComponent_C::SourceChainToApply' has a wrong offset!");
