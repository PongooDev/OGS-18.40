...
static_assert(sizeof(UCurieComponent) == 0x0000C8, "Wrong size on UCurieComponent");
...
static_assert(sizeof(UCurieElementInteractWithElementHandler) == 0x000038, "Wrong size on UCurieElementInteractWithElementHandler");
...
static_assert(sizeof(UCurieElementInteractWithMaterialHandler) == 0x000038, "Wrong size on UCurieElementInteractWithMaterialHandler");
...
static_assert(sizeof(UCurieElementAttachHandler) == 0x000068, "Wrong size on UCurieElementAttachHandler");
...
static_assert(offsetof(UCurieElementAttachHandler, OnBeginAttachmentEffects) == 0x000038, "Member 'UCurieElementAttachHandler::OnBeginAttachmentEffects' has a wrong offset!");
static_assert(offsetof(UCurieElementAttachHandler, OngoingAttachmentEffects) == 0x000048, "Member 'UCurieElementAttachHandler::OngoingAttachmentEffects' has a wrong offset!");
static_assert(offsetof(UCurieElementAttachHandler, OnEndAttachmentEffects) == 0x000058, "Member 'UCurieElementAttachHandler::OnEndAttachmentEffects' has a wrong offset!");
...
static_assert(sizeof(UCurieElementAttachConditionHandler) == 0x000038, "Wrong size on UCurieElementAttachConditionHandler");
...
static_assert(sizeof(UCurieElementInteractWithContainerHandler) == 0x000078, "Wrong size on UCurieElementInteractWithContainerHandler");
...
static_assert(offsetof(UCurieElementInteractWithContainerHandler, OnInstantInteractionEffects) == 0x000038, "Member 'UCurieElementInteractWithContainerHandler::OnInstantInteractionEffects' has a wrong offset!");
static_assert(offsetof(UCurieElementInteractWithContainerHandler, OnBeginInteractionEffects) == 0x000048, "Member 'UCurieElementInteractWithContainerHandler::OnBeginInteractionEffects' has a wrong offset!");
static_assert(offsetof(UCurieElementInteractWithContainerHandler, OngoingInteractionEffects) == 0x000058, "Member 'UCurieElementInteractWithContainerHandler::OngoingInteractionEffects' has a wrong offset!");
static_assert(offsetof(UCurieElementInteractWithContainerHandler, OnEndInteractionEffects) == 0x000068, "Member 'UCurieElementInteractWithContainerHandler::OnEndInteractionEffects' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_E8[0x2A8];                                     // 0x00E8(0x02A8)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_520[0x54];                                     // 0x0520(0x0054)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         BitPad_574_0 : 2;                                  // 0x0574(0x0001)(Fixing Bit-Field Size Between Bits [ Dumper-7 ])
	...
	uint8                                         Pad_575[0x3];                                      // 0x0575(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UCurieManager) == 0x000578, "Wrong size on UCurieManager");
...
static_assert(offsetof(UCurieManager, MaterialDataRegistryName) == 0x0000B8, "Member 'UCurieManager::MaterialDataRegistryName' has a wrong offset!");
static_assert(offsetof(UCurieManager, ElementDataRegistryName) == 0x0000C0, "Member 'UCurieManager::ElementDataRegistryName' has a wrong offset!");
static_assert(offsetof(UCurieManager, EntityStateDataRegistryName) == 0x0000C8, "Member 'UCurieManager::EntityStateDataRegistryName' has a wrong offset!");
static_assert(offsetof(UCurieManager, MaterialDefinitionsTable) == 0x0000D0, "Member 'UCurieManager::MaterialDefinitionsTable' has a wrong offset!");
static_assert(offsetof(UCurieManager, ElementDefinitionsTable) == 0x0000D8, "Member 'UCurieManager::ElementDefinitionsTable' has a wrong offset!");
static_assert(offsetof(UCurieManager, EntityStateDefinitionsTable) == 0x0000E0, "Member 'UCurieManager::EntityStateDefinitionsTable' has a wrong offset!");
static_assert(offsetof(UCurieManager, ElementAttachmentHandlers) == 0x000390, "Member 'UCurieManager::ElementAttachmentHandlers' has a wrong offset!");
static_assert(offsetof(UCurieManager, ElementAttachmentConditionHandlers) == 0x0003E0, "Member 'UCurieManager::ElementAttachmentConditionHandlers' has a wrong offset!");
static_assert(offsetof(UCurieManager, ElementInteractWithElementHandlers) == 0x000430, "Member 'UCurieManager::ElementInteractWithElementHandlers' has a wrong offset!");
static_assert(offsetof(UCurieManager, ElementInteractWithMaterialHandlers) == 0x000480, "Member 'UCurieManager::ElementInteractWithMaterialHandlers' has a wrong offset!");
static_assert(offsetof(UCurieManager, ElementInteractWithContainerHandlers) == 0x0004D0, "Member 'UCurieManager::ElementInteractWithContainerHandlers' has a wrong offset!");
