...
static_assert(sizeof(AMeshBeaconClient) == 0x000330, "Wrong size on AMeshBeaconClient");
...
static_assert(offsetof(AMeshBeaconClient, ClientId) == 0x000310, "Member 'AMeshBeaconClient::ClientId' has a wrong offset!");
...
static_assert(sizeof(AMeshBeaconHost) == 0x000368, "Wrong size on AMeshBeaconHost");
static_assert(offsetof(AMeshBeaconHost, MaxConnections) == 0x000360, "Member 'AMeshBeaconHost::MaxConnections' has a wrong offset!");
...
static_assert(sizeof(UMeshConnection) == 0x003220, "Wrong size on UMeshConnection");
...
public:
	...
	TArray<class AActor*>                         ClientDormantDynamicActors;                        // 0x07D8(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMeshNetDriver) == 0x0007E8, "Wrong size on UMeshNetDriver");
static_assert(offsetof(UMeshNetDriver, ClientDormantDynamicActors) == 0x0007D8, "Member 'UMeshNetDriver::ClientDormantDynamicActors' has a wrong offset!");
