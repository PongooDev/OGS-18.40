...
public:
	...
	struct FFortTournamentDisplayInfo             K2Node_CustomEvent_ColorInfo;                      // 0x0008(0x01B8)()
	class UArenaPersonalView_C*                   K2Node_DynamicCast_AsArena_Personal_View;          // 0x01C0(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ArenaViewMeTab_C_ExecuteUbergraph_ArenaViewMeTab) == 0x0001D0, "Wrong size on ArenaViewMeTab_C_ExecuteUbergraph_ArenaViewMeTab");
...
static_assert(offsetof(ArenaViewMeTab_C_ExecuteUbergraph_ArenaViewMeTab, K2Node_DynamicCast_AsArena_Personal_View) == 0x0001C0, "Member 'ArenaViewMeTab_C_ExecuteUbergraph_ArenaViewMeTab::K2Node_DynamicCast_AsArena_Personal_View' has a wrong offset!");
static_assert(offsetof(ArenaViewMeTab_C_ExecuteUbergraph_ArenaViewMeTab, K2Node_DynamicCast_bSuccess) == 0x0001C8, "Member 'ArenaViewMeTab_C_ExecuteUbergraph_ArenaViewMeTab::K2Node_DynamicCast_bSuccess' has a wrong offset!");
...
static_assert(sizeof(ArenaViewMeTab_C_Colorize) == 0x0001B8, "Wrong size on ArenaViewMeTab_C_Colorize");
