...
static_assert(sizeof(SequenceCameraShakeTestUtil_GetCameraCachePOV) == 0x0005F0, "Wrong size on SequenceCameraShakeTestUtil_GetCameraCachePOV");
...
static_assert(sizeof(SequenceCameraShakeTestUtil_GetLastFrameCameraCachePOV) == 0x0005F0, "Wrong size on SequenceCameraShakeTestUtil_GetLastFrameCameraCachePOV");
...
static_assert(sizeof(SequenceCameraShakeTestUtil_GetPostProcessBlendCache) == 0x000570, "Wrong size on SequenceCameraShakeTestUtil_GetPostProcessBlendCache");
...
static_assert(offsetof(SequenceCameraShakeTestUtil_GetPostProcessBlendCache, OutPPBlendWeight) == 0x000560, "Member 'SequenceCameraShakeTestUtil_GetPostProcessBlendCache::OutPPBlendWeight' has a wrong offset!");
static_assert(offsetof(SequenceCameraShakeTestUtil_GetPostProcessBlendCache, ReturnValue) == 0x000564, "Member 'SequenceCameraShakeTestUtil_GetPostProcessBlendCache::ReturnValue' has a wrong offset!");
