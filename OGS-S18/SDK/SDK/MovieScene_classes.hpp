...
public:
	...
	uint8                                         Pad_3D0[0x78];                                     // 0x03D0(0x0078)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneSequenceReplProperties      NetSyncProps;                                      // 0x0448(0x0010)(Net, NoDestructor, Protected, NativeAccessSpecifierProtected)
	TScriptInterface<class IMovieScenePlaybackClient> PlaybackClient;                                    // 0x0458(0x0010)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	class UMovieSceneSequenceTickManager*         TickManager;                                       // 0x0468(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_470[0x88];                                     // 0x0470(0x0088)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMovieSceneSequencePlayer) == 0x0004F8, "Wrong size on UMovieSceneSequencePlayer");
...
static_assert(offsetof(UMovieSceneSequencePlayer, NetSyncProps) == 0x000448, "Member 'UMovieSceneSequencePlayer::NetSyncProps' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, PlaybackClient) == 0x000458, "Member 'UMovieSceneSequencePlayer::PlaybackClient' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, TickManager) == 0x000468, "Member 'UMovieSceneSequencePlayer::TickManager' has a wrong offset!");
