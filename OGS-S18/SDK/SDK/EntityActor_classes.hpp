...
static_assert(sizeof(UEntityActorStaticMeshRenderComponent) == 0x0000B0, "Wrong size on UEntityActorStaticMeshRenderComponent");
static_assert(offsetof(UEntityActorStaticMeshRenderComponent, StaticMeshComponentCache) == 0x000090, "Member 'UEntityActorStaticMeshRenderComponent::StaticMeshComponentCache' has a wrong offset!");
static_assert(offsetof(UEntityActorStaticMeshRenderComponent, ShadowVar_MeshMaterials) == 0x000098, "Member 'UEntityActorStaticMeshRenderComponent::ShadowVar_MeshMaterials' has a wrong offset!");
static_assert(offsetof(UEntityActorStaticMeshRenderComponent, ShadowVar_EnableCollision) == 0x0000A8, "Member 'UEntityActorStaticMeshRenderComponent::ShadowVar_EnableCollision' has a wrong offset!");
static_assert(offsetof(UEntityActorStaticMeshRenderComponent, ShadowVar_MaxDrawDistance) == 0x0000AC, "Member 'UEntityActorStaticMeshRenderComponent::ShadowVar_MaxDrawDistance' has a wrong offset!");
...
static_assert(offsetof(UEntityActorTextDisplayComponent, bAddedTextRenderComponent) == 0x000080, "Member 'UEntityActorTextDisplayComponent::bAddedTextRenderComponent' has a wrong offset!");
...
static_assert(sizeof(ASimObject) == 0x000228, "Wrong size on ASimObject");
