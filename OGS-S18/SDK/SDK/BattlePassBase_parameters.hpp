...
static_assert(sizeof(FortBattlePassPurchaseResourcesWidget_OnPurchaseAmountChanged) == 0x000004, "Wrong size on FortBattlePassPurchaseResourcesWidget_OnPurchaseAmountChanged");
