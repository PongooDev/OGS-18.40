...
static_assert(sizeof(Parent_Tree_Apollo_C_ExecuteUbergraph_Parent_Tree_Apollo) == 0x000004, "Wrong size on Parent_Tree_Apollo_C_ExecuteUbergraph_Parent_Tree_Apollo");
