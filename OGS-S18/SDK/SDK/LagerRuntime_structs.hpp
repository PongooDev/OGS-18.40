...
static_assert(sizeof(FLivingWorldCalendarEventCondition) == 0x000014, "Wrong size on FLivingWorldCalendarEventCondition");
...
static_assert(offsetof(FLivingWorldCalendarEventCondition, Behavior) == 0x000008, "Member 'FLivingWorldCalendarEventCondition::Behavior' has a wrong offset!");
static_assert(offsetof(FLivingWorldCalendarEventCondition, ShouldEventBeActive) == 0x000009, "Member 'FLivingWorldCalendarEventCondition::ShouldEventBeActive' has a wrong offset!");
static_assert(offsetof(FLivingWorldCalendarEventCondition, RatioBehavior) == 0x00000A, "Member 'FLivingWorldCalendarEventCondition::RatioBehavior' has a wrong offset!");
static_assert(offsetof(FLivingWorldCalendarEventCondition, RatioValue) == 0x00000C, "Member 'FLivingWorldCalendarEventCondition::RatioValue' has a wrong offset!");
static_assert(offsetof(FLivingWorldCalendarEventCondition, RatioMaxValue) == 0x000010, "Member 'FLivingWorldCalendarEventCondition::RatioMaxValue' has a wrong offset!");
...
static_assert(sizeof(FFortAthenaLivingWorldDensityGrid) == 0x000108, "Wrong size on FFortAthenaLivingWorldDensityGrid");
...
static_assert(sizeof(FFortAthenaLivingWorldEventTagDensityCondition) == 0x000010, "Wrong size on FFortAthenaLivingWorldEventTagDensityCondition");
...
static_assert(offsetof(FFortAthenaLivingWorldEventTagDensityCondition, Distance) == 0x000008, "Member 'FFortAthenaLivingWorldEventTagDensityCondition::Distance' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEventTagDensityCondition, MaxDensity) == 0x00000C, "Member 'FFortAthenaLivingWorldEventTagDensityCondition::MaxDensity' has a wrong offset!");
...
public:
	...
	float                                         MinDistanceToPlayer;                               // 0x00C4(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         MaxDistanceToPlayer;                               // 0x00C8(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bCanSpawnWithoutMatchingPlayerDistance;            // 0x00CC(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_CD[0x3];                                       // 0x00CD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         RandomActivationChance;                            // 0x00D0(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FFortAthenaLivingWorldEventDespawnCondition DespawnCondition;                                  // 0x00D4(0x0018)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(FFortAthenaLivingWorldEvent) == 0x000128, "Wrong size on FFortAthenaLivingWorldEvent");
...
static_assert(offsetof(FFortAthenaLivingWorldEvent, TagDensityConditions) == 0x0000B0, "Member 'FFortAthenaLivingWorldEvent::TagDensityConditions' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, bCheckForActorDensity) == 0x0000C0, "Member 'FFortAthenaLivingWorldEvent::bCheckForActorDensity' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, MinDistanceToPlayer) == 0x0000C4, "Member 'FFortAthenaLivingWorldEvent::MinDistanceToPlayer' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, MaxDistanceToPlayer) == 0x0000C8, "Member 'FFortAthenaLivingWorldEvent::MaxDistanceToPlayer' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, bCanSpawnWithoutMatchingPlayerDistance) == 0x0000CC, "Member 'FFortAthenaLivingWorldEvent::bCanSpawnWithoutMatchingPlayerDistance' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, RandomActivationChance) == 0x0000D0, "Member 'FFortAthenaLivingWorldEvent::RandomActivationChance' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, DespawnCondition) == 0x0000D4, "Member 'FFortAthenaLivingWorldEvent::DespawnCondition' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, RequirePlaylistTags) == 0x0000F0, "Member 'FFortAthenaLivingWorldEvent::RequirePlaylistTags' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, CalendarEventConditions) == 0x000110, "Member 'FFortAthenaLivingWorldEvent::CalendarEventConditions' has a wrong offset!");
...
static_assert(sizeof(FFortLivingWorldConfigOverride) == 0x000080, "Wrong size on FFortLivingWorldConfigOverride");
...
static_assert(offsetof(FFortLivingWorldConfigOverride, EndVersion) == 0x000078, "Member 'FFortLivingWorldConfigOverride::EndVersion' has a wrong offset!");
