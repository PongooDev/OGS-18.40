...
static_assert(sizeof(UMoleTaskLogicObjective) == 0x0000F0, "Wrong size on UMoleTaskLogicObjective");
...
static_assert(offsetof(UMoleTaskLogicObjective, MinimumCompletionTimeSecurityThreshold) == 0x0000C0, "Member 'UMoleTaskLogicObjective::MinimumCompletionTimeSecurityThreshold' has a wrong offset!");
...
static_assert(sizeof(UMoleTaskLogicObjective_DamageActors) == 0x000120, "Wrong size on UMoleTaskLogicObjective_DamageActors");
static_assert(offsetof(UMoleTaskLogicObjective_DamageActors, DamageAmount) == 0x0000F0, "Member 'UMoleTaskLogicObjective_DamageActors::DamageAmount' has a wrong offset!");
...
static_assert(sizeof(UMoleEliminationAbility) == 0x000AE8, "Wrong size on UMoleEliminationAbility");
static_assert(offsetof(UMoleEliminationAbility, CooldownTagsToListenTo) == 0x000AA8, "Member 'UMoleEliminationAbility::CooldownTagsToListenTo' has a wrong offset!");
static_assert(offsetof(UMoleEliminationAbility, CombinedCooldownTags) == 0x000AC8, "Member 'UMoleEliminationAbility::CombinedCooldownTags' has a wrong offset!");
...
static_assert(sizeof(UFortCinematicComponent) == 0x000160, "Wrong size on UFortCinematicComponent");
static_assert(offsetof(UFortCinematicComponent, PawnVisibilityMap) == 0x0000B0, "Member 'UFortCinematicComponent::PawnVisibilityMap' has a wrong offset!");
static_assert(offsetof(UFortCinematicComponent, LocalPawnVisibilityMap) == 0x000100, "Member 'UFortCinematicComponent::LocalPawnVisibilityMap' has a wrong offset!");
static_assert(offsetof(UFortCinematicComponent, StateStack) == 0x000150, "Member 'UFortCinematicComponent::StateStack' has a wrong offset!");
...
static_assert(sizeof(UMoleAFKComponent) == 0x000128, "Wrong size on UMoleAFKComponent");
static_assert(offsetof(UMoleAFKComponent, LongestAFKPeriod) == 0x000100, "Member 'UMoleAFKComponent::LongestAFKPeriod' has a wrong offset!");
...
static_assert(offsetof(UMoleTaskLogicObjective_DestroyActors, Quantity) == 0x0000F0, "Member 'UMoleTaskLogicObjective_DestroyActors::Quantity' has a wrong offset!");
...
static_assert(sizeof(UMoleAnalyticsComponent) == 0x000290, "Wrong size on UMoleAnalyticsComponent");
...
static_assert(sizeof(UMoleAssetManagerComponent) == 0x0000E8, "Wrong size on UMoleAssetManagerComponent");
static_assert(offsetof(UMoleAssetManagerComponent, AssetLoadInfo) == 0x0000C8, "Member 'UMoleAssetManagerComponent::AssetLoadInfo' has a wrong offset!");
static_assert(offsetof(UMoleAssetManagerComponent, BundlesToLoad) == 0x0000D8, "Member 'UMoleAssetManagerComponent::BundlesToLoad' has a wrong offset!");
...
static_assert(sizeof(UMoleSabotageAbility) == 0x000B00, "Wrong size on UMoleSabotageAbility");
static_assert(offsetof(UMoleSabotageAbility, SabotageTag) == 0x000AA8, "Member 'UMoleSabotageAbility::SabotageTag' has a wrong offset!");
static_assert(offsetof(UMoleSabotageAbility, CooldownTagsToListenTo) == 0x000AB0, "Member 'UMoleSabotageAbility::CooldownTagsToListenTo' has a wrong offset!");
static_assert(offsetof(UMoleSabotageAbility, CombinedCooldownTags) == 0x000AD0, "Member 'UMoleSabotageAbility::CombinedCooldownTags' has a wrong offset!");
static_assert(offsetof(UMoleSabotageAbility, InterruptionType) == 0x000AF0, "Member 'UMoleSabotageAbility::InterruptionType' has a wrong offset!");
static_assert(offsetof(UMoleSabotageAbility, SabotageEventMessageTag) == 0x000AF4, "Member 'UMoleSabotageAbility::SabotageEventMessageTag' has a wrong offset!");
...
static_assert(sizeof(UMoleSupplyDropSabotageAbility) == 0x000B58, "Wrong size on UMoleSupplyDropSabotageAbility");
static_assert(offsetof(UMoleSupplyDropSabotageAbility, NumberOfPointsToFix) == 0x000B08, "Member 'UMoleSupplyDropSabotageAbility::NumberOfPointsToFix' has a wrong offset!");
static_assert(offsetof(UMoleSupplyDropSabotageAbility, FixTaskHandles) == 0x000B30, "Member 'UMoleSupplyDropSabotageAbility::FixTaskHandles' has a wrong offset!");
static_assert(offsetof(UMoleSupplyDropSabotageAbility, InteractionInfoRowName) == 0x000B40, "Member 'UMoleSupplyDropSabotageAbility::InteractionInfoRowName' has a wrong offset!");
static_assert(offsetof(UMoleSupplyDropSabotageAbility, ChosenFixPoints) == 0x000B48, "Member 'UMoleSupplyDropSabotageAbility::ChosenFixPoints' has a wrong offset!");
...
static_assert(sizeof(UMoleAudioManagerComponent) == 0x0000B0, "Wrong size on UMoleAudioManagerComponent");
...
static_assert(sizeof(UMoleCinematicComponent) == 0x0003E8, "Wrong size on UMoleCinematicComponent");
static_assert(offsetof(UMoleCinematicComponent, bRoleAssignedTeleport) == 0x000168, "Member 'UMoleCinematicComponent::bRoleAssignedTeleport' has a wrong offset!");
static_assert(offsetof(UMoleCinematicComponent, RoleAssignTeleportHandle) == 0x000170, "Member 'UMoleCinematicComponent::RoleAssignTeleportHandle' has a wrong offset!");
static_assert(offsetof(UMoleCinematicComponent, RoleAssignedCineState) == 0x000190, "Member 'UMoleCinematicComponent::RoleAssignedCineState' has a wrong offset!");
static_assert(offsetof(UMoleCinematicComponent, MeetingPayload) == 0x0001D8, "Member 'UMoleCinematicComponent::MeetingPayload' has a wrong offset!");
static_assert(offsetof(UMoleCinematicComponent, MeetingCalledCineState) == 0x0001F8, "Member 'UMoleCinematicComponent::MeetingCalledCineState' has a wrong offset!");
static_assert(offsetof(UMoleCinematicComponent, bVoteDiscussionTeleport) == 0x000248, "Member 'UMoleCinematicComponent::bVoteDiscussionTeleport' has a wrong offset!");
static_assert(offsetof(UMoleCinematicComponent, VoteDiscussTeleportHandle) == 0x000250, "Member 'UMoleCinematicComponent::VoteDiscussTeleportHandle' has a wrong offset!");
static_assert(offsetof(UMoleCinematicComponent, VoteDiscussCineState) == 0x000270, "Member 'UMoleCinematicComponent::VoteDiscussCineState' has a wrong offset!");
static_assert(offsetof(UMoleCinematicComponent, VoteResolvedCineState) == 0x0002D8, "Member 'UMoleCinematicComponent::VoteResolvedCineState' has a wrong offset!");
static_assert(offsetof(UMoleCinematicComponent, bVotingTeleport) == 0x000320, "Member 'UMoleCinematicComponent::bVotingTeleport' has a wrong offset!");
static_assert(offsetof(UMoleCinematicComponent, VotingTeleportHandle) == 0x000328, "Member 'UMoleCinematicComponent::VotingTeleportHandle' has a wrong offset!");
static_assert(offsetof(UMoleCinematicComponent, VoteSkippedCineState) == 0x000350, "Member 'UMoleCinematicComponent::VoteSkippedCineState' has a wrong offset!");
static_assert(offsetof(UMoleCinematicComponent, VoteEjectionCineState) == 0x0003A0, "Member 'UMoleCinematicComponent::VoteEjectionCineState' has a wrong offset!");
...
{
public:
	class APlayerState*                           RepresentedPlayer;                                 // 0x08B8(0x0008)(BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, Transient, IsPlainOldData, RepNotify, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AMoleEliminationMarker) == 0x0008C0, "Wrong size on AMoleEliminationMarker");
static_assert(offsetof(AMoleEliminationMarker, RepresentedPlayer) == 0x0008B8, "Member 'AMoleEliminationMarker::RepresentedPlayer' has a wrong offset!");
...
static_assert(sizeof(UMoleTaskLogicAction_GrantWeapon) == 0x0000A0, "Wrong size on UMoleTaskLogicAction_GrantWeapon");
...
static_assert(offsetof(UMoleTaskLogicAction_GrantWeapon, GrantedWeaponGuid) == 0x000090, "Member 'UMoleTaskLogicAction_GrantWeapon::GrantedWeaponGuid' has a wrong offset!");
...
static_assert(sizeof(AMoleGameBaseMutator) == 0x000368, "Wrong size on AMoleGameBaseMutator");
static_assert(offsetof(AMoleGameBaseMutator, BlockedEmoteTags) == 0x0002C8, "Member 'AMoleGameBaseMutator::BlockedEmoteTags' has a wrong offset!");
static_assert(offsetof(AMoleGameBaseMutator, BlockedEmoteTagsForGhosts) == 0x0002E8, "Member 'AMoleGameBaseMutator::BlockedEmoteTagsForGhosts' has a wrong offset!");
static_assert(offsetof(AMoleGameBaseMutator, LeaveTextOverride) == 0x000308, "Member 'AMoleGameBaseMutator::LeaveTextOverride' has a wrong offset!");
static_assert(offsetof(AMoleGameBaseMutator, LeavePartyTextOverride) == 0x000320, "Member 'AMoleGameBaseMutator::LeavePartyTextOverride' has a wrong offset!");
static_assert(offsetof(AMoleGameBaseMutator, GhostLeaveTextOverride) == 0x000338, "Member 'AMoleGameBaseMutator::GhostLeaveTextOverride' has a wrong offset!");
static_assert(offsetof(AMoleGameBaseMutator, GhostLeavePartyTextOverride) == 0x000350, "Member 'AMoleGameBaseMutator::GhostLeavePartyTextOverride' has a wrong offset!");
...
static_assert(sizeof(UMoleGameplayAbility_Voting) == 0x000AC0, "Wrong size on UMoleGameplayAbility_Voting");
static_assert(offsetof(UMoleGameplayAbility_Voting, VotingTargetingPreset) == 0x000AA8, "Member 'UMoleGameplayAbility_Voting::VotingTargetingPreset' has a wrong offset!");
static_assert(offsetof(UMoleGameplayAbility_Voting, AsyncTargetingHandle) == 0x000AB0, "Member 'UMoleGameplayAbility_Voting::AsyncTargetingHandle' has a wrong offset!");
static_assert(offsetof(UMoleGameplayAbility_Voting, BestVotingTarget) == 0x000AB8, "Member 'UMoleGameplayAbility_Voting::BestVotingTarget' has a wrong offset!");
...
static_assert(sizeof(UMoleGamePlayerSpawningComponent) == 0x0000F8, "Wrong size on UMoleGamePlayerSpawningComponent");
...
static_assert(sizeof(AMoleGamePlayspace) == 0x000560, "Wrong size on AMoleGamePlayspace");
static_assert(offsetof(AMoleGamePlayspace, MoleStateMachineClass) == 0x000540, "Member 'AMoleGamePlayspace::MoleStateMachineClass' has a wrong offset!");
static_assert(offsetof(AMoleGamePlayspace, InventoryManager) == 0x000558, "Member 'AMoleGamePlayspace::InventoryManager' has a wrong offset!");
...
{
public:
	float                                         PrepareStateDelayTime;                             // 0x0080(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMoleGameplayState_Tasks) == 0x000090, "Wrong size on UMoleGameplayState_Tasks");
static_assert(offsetof(UMoleGameplayState_Tasks, PrepareStateDelayTime) == 0x000080, "Member 'UMoleGameplayState_Tasks::PrepareStateDelayTime' has a wrong offset!");
...
static_assert(sizeof(UMoleGhostControllerComponent) == 0x0000B8, "Wrong size on UMoleGhostControllerComponent");
static_assert(offsetof(UMoleGhostControllerComponent, GhostInputComp) == 0x0000B0, "Member 'UMoleGhostControllerComponent::GhostInputComp' has a wrong offset!");
...
{
public:
	class UMaterialInterface*                     GhostMaterial;                                     // 0x0568(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class APlayerState*                           RepresentedPlayerState;                            // 0x0570(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AMoleGhostMannequin) == 0x000580, "Wrong size on AMoleGhostMannequin");
static_assert(offsetof(AMoleGhostMannequin, GhostMaterial) == 0x000568, "Member 'AMoleGhostMannequin::GhostMaterial' has a wrong offset!");
static_assert(offsetof(AMoleGhostMannequin, RepresentedPlayerState) == 0x000570, "Member 'AMoleGhostMannequin::RepresentedPlayerState' has a wrong offset!");
...
static_assert(sizeof(UMoleTaskLogicAction_SetInteractionData) == 0x000078, "Wrong size on UMoleTaskLogicAction_SetInteractionData");
...
static_assert(sizeof(UMoleImpostorBiasComponent) == 0x0000D0, "Wrong size on UMoleImpostorBiasComponent");
static_assert(offsetof(UMoleImpostorBiasComponent, RolePreference) == 0x0000B0, "Member 'UMoleImpostorBiasComponent::RolePreference' has a wrong offset!");
...
static_assert(sizeof(UMoleLobbyState_Waiting) == 0x000080, "Wrong size on UMoleLobbyState_Waiting");
...
static_assert(sizeof(UMoleLevelManagerComponent) == 0x0000F8, "Wrong size on UMoleLevelManagerComponent");
static_assert(offsetof(UMoleLevelManagerComponent, DesiredMapDescription) == 0x0000B0, "Member 'UMoleLevelManagerComponent::DesiredMapDescription' has a wrong offset!");
static_assert(offsetof(UMoleLevelManagerComponent, CurrentLevelData) == 0x0000D0, "Member 'UMoleLevelManagerComponent::CurrentLevelData' has a wrong offset!");
...
{
public:
	float                                         LobbyTransitionServerTime;                         // 0x0080(0x0004)(Net, ZeroConstructor, Transient, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_84[0xC];                                       // 0x0084(0x000C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMoleLobbyState_Countdown) == 0x000090, "Wrong size on UMoleLobbyState_Countdown");
static_assert(offsetof(UMoleLobbyState_Countdown, LobbyTransitionServerTime) == 0x000080, "Member 'UMoleLobbyState_Countdown::LobbyTransitionServerTime' has a wrong offset!");
...
static_assert(sizeof(UMolePlayerControllerComponent) == 0x000100, "Wrong size on UMolePlayerControllerComponent");
static_assert(offsetof(UMolePlayerControllerComponent, MoleCoreInputComp) == 0x0000B8, "Member 'UMolePlayerControllerComponent::MoleCoreInputComp' has a wrong offset!");
static_assert(offsetof(UMolePlayerControllerComponent, MoleKBMInputSettings) == 0x0000C0, "Member 'UMolePlayerControllerComponent::MoleKBMInputSettings' has a wrong offset!");
static_assert(offsetof(UMolePlayerControllerComponent, MoleControllerInputSettings) == 0x0000C8, "Member 'UMolePlayerControllerComponent::MoleControllerInputSettings' has a wrong offset!");
static_assert(offsetof(UMolePlayerControllerComponent, BindingsDataTable) == 0x0000D0, "Member 'UMolePlayerControllerComponent::BindingsDataTable' has a wrong offset!");
...
static_assert(sizeof(UMoleLobbyState_Loading) == 0x000088, "Wrong size on UMoleLobbyState_Loading");
...
static_assert(sizeof(UMoleLobbyState_Login) == 0x000088, "Wrong size on UMoleLobbyState_Login");
...
static_assert(sizeof(UMoleLobbyState_Matchmake) == 0x000088, "Wrong size on UMoleLobbyState_Matchmake");
...
static_assert(sizeof(UMoleLobbyStateMachine) == 0x000100, "Wrong size on UMoleLobbyStateMachine");
...
static_assert(sizeof(UMolePawnComponent) == 0x000108, "Wrong size on UMolePawnComponent");
static_assert(offsetof(UMolePawnComponent, MaterialOpacityParameter) == 0x0000B0, "Member 'UMolePawnComponent::MaterialOpacityParameter' has a wrong offset!");
static_assert(offsetof(UMolePawnComponent, GhostMaterial) == 0x0000B8, "Member 'UMolePawnComponent::GhostMaterial' has a wrong offset!");
static_assert(offsetof(UMolePawnComponent, PlayerFootstepBankBase) == 0x0000C0, "Member 'UMolePawnComponent::PlayerFootstepBankBase' has a wrong offset!");
static_assert(offsetof(UMolePawnComponent, PlayerFootstepBankPriority) == 0x0000C8, "Member 'UMolePawnComponent::PlayerFootstepBankPriority' has a wrong offset!");
static_assert(offsetof(UMolePawnComponent, BaseCustomizationData) == 0x0000D0, "Member 'UMolePawnComponent::BaseCustomizationData' has a wrong offset!");
static_assert(offsetof(UMolePawnComponent, GhostCustomizationData) == 0x0000D8, "Member 'UMolePawnComponent::GhostCustomizationData' has a wrong offset!");
static_assert(offsetof(UMolePawnComponent, bIsGhost) == 0x0000F4, "Member 'UMolePawnComponent::bIsGhost' has a wrong offset!");
static_assert(offsetof(UMolePawnComponent, GhostCollisionProfile) == 0x0000F8, "Member 'UMolePawnComponent::GhostCollisionProfile' has a wrong offset!");
...
static_assert(sizeof(UMolePerformanceComponent) == 0x0000B0, "Wrong size on UMolePerformanceComponent");
...
static_assert(sizeof(AMolePlayerStart) == 0x000298, "Wrong size on AMolePlayerStart");
static_assert(offsetof(AMolePlayerStart, CorrespondingPlayerNumber) == 0x000290, "Member 'AMolePlayerStart::CorrespondingPlayerNumber' has a wrong offset!");
...
static_assert(sizeof(UMolePlayerStateComponent) == 0x000188, "Wrong size on UMolePlayerStateComponent");
static_assert(offsetof(UMolePlayerStateComponent, OnPlayerBecameGhost) == 0x0000E0, "Member 'UMolePlayerStateComponent::OnPlayerBecameGhost' has a wrong offset!");
static_assert(offsetof(UMolePlayerStateComponent, PlayerNumber) == 0x0000F0, "Member 'UMolePlayerStateComponent::PlayerNumber' has a wrong offset!");
static_assert(offsetof(UMolePlayerStateComponent, DeathInfo) == 0x0000F4, "Member 'UMolePlayerStateComponent::DeathInfo' has a wrong offset!");
static_assert(offsetof(UMolePlayerStateComponent, GhostGameplayEffect) == 0x0000F8, "Member 'UMolePlayerStateComponent::GhostGameplayEffect' has a wrong offset!");
static_assert(offsetof(UMolePlayerStateComponent, EliminationMarkerClass) == 0x000100, "Member 'UMolePlayerStateComponent::EliminationMarkerClass' has a wrong offset!");
static_assert(offsetof(UMolePlayerStateComponent, Role) == 0x000110, "Member 'UMolePlayerStateComponent::Role' has a wrong offset!");
static_assert(offsetof(UMolePlayerStateComponent, EnemyPlayerStates) == 0x000118, "Member 'UMolePlayerStateComponent::EnemyPlayerStates' has a wrong offset!");
static_assert(offsetof(UMolePlayerStateComponent, bIsRevealedEnemy) == 0x000128, "Member 'UMolePlayerStateComponent::bIsRevealedEnemy' has a wrong offset!");
static_assert(offsetof(UMolePlayerStateComponent, bHasLeftGame) == 0x000129, "Member 'UMolePlayerStateComponent::bHasLeftGame' has a wrong offset!");
static_assert(offsetof(UMolePlayerStateComponent, KillerPlayerState) == 0x000130, "Member 'UMolePlayerStateComponent::KillerPlayerState' has a wrong offset!");
static_assert(offsetof(UMolePlayerStateComponent, GhostBlockedAbilityTags) == 0x000138, "Member 'UMolePlayerStateComponent::GhostBlockedAbilityTags' has a wrong offset!");
static_assert(offsetof(UMolePlayerStateComponent, PlayerTeleportedData) == 0x000158, "Member 'UMolePlayerStateComponent::PlayerTeleportedData' has a wrong offset!");
...
static_assert(sizeof(UMolePlayerTaskManagementComponent) == 0x0003E8, "Wrong size on UMolePlayerTaskManagementComponent");
static_assert(offsetof(UMolePlayerTaskManagementComponent, MoleActiveTaskStateArray) == 0x0000B0, "Member 'UMolePlayerTaskManagementComponent::MoleActiveTaskStateArray' has a wrong offset!");
static_assert(offsetof(UMolePlayerTaskManagementComponent, MoleCompletedTaskArray) == 0x0001F8, "Member 'UMolePlayerTaskManagementComponent::MoleCompletedTaskArray' has a wrong offset!");
static_assert(offsetof(UMolePlayerTaskManagementComponent, MoleCollisionLeashes) == 0x000328, "Member 'UMolePlayerTaskManagementComponent::MoleCollisionLeashes' has a wrong offset!");
static_assert(offsetof(UMolePlayerTaskManagementComponent, MoleDistanceLeashes) == 0x000338, "Member 'UMolePlayerTaskManagementComponent::MoleDistanceLeashes' has a wrong offset!");
static_assert(offsetof(UMolePlayerTaskManagementComponent, LeashTimerHandle) == 0x000348, "Member 'UMolePlayerTaskManagementComponent::LeashTimerHandle' has a wrong offset!");
static_assert(offsetof(UMolePlayerTaskManagementComponent, PrimaryActiveTaskHandle) == 0x000350, "Member 'UMolePlayerTaskManagementComponent::PrimaryActiveTaskHandle' has a wrong offset!");
static_assert(offsetof(UMolePlayerTaskManagementComponent, ActiveTaskInputComponent) == 0x000358, "Member 'UMolePlayerTaskManagementComponent::ActiveTaskInputComponent' has a wrong offset!");
static_assert(offsetof(UMolePlayerTaskManagementComponent, CancelPrimaryTaskTimerHandle) == 0x000360, "Member 'UMolePlayerTaskManagementComponent::CancelPrimaryTaskTimerHandle' has a wrong offset!");
static_assert(offsetof(UMolePlayerTaskManagementComponent, TaskCompletionGameplayCue) == 0x000370, "Member 'UMolePlayerTaskManagementComponent::TaskCompletionGameplayCue' has a wrong offset!");
static_assert(offsetof(UMolePlayerTaskManagementComponent, TaskInterruptionGameplayCue) == 0x000378, "Member 'UMolePlayerTaskManagementComponent::TaskInterruptionGameplayCue' has a wrong offset!");
static_assert(offsetof(UMolePlayerTaskManagementComponent, EnemyTrackingTargetingPreset) == 0x000388, "Member 'UMolePlayerTaskManagementComponent::EnemyTrackingTargetingPreset' has a wrong offset!");
static_assert(offsetof(UMolePlayerTaskManagementComponent, AsyncTargetingHandle) == 0x000390, "Member 'UMolePlayerTaskManagementComponent::AsyncTargetingHandle' has a wrong offset!");
static_assert(offsetof(UMolePlayerTaskManagementComponent, BestEnemyTarget) == 0x000398, "Member 'UMolePlayerTaskManagementComponent::BestEnemyTarget' has a wrong offset!");
...
static_assert(sizeof(UMolePlayerVisibilityManagerComponent) == 0x0000C8, "Wrong size on UMolePlayerVisibilityManagerComponent");
static_assert(offsetof(UMolePlayerVisibilityManagerComponent, Ghosts) == 0x0000B0, "Member 'UMolePlayerVisibilityManagerComponent::Ghosts' has a wrong offset!");
...
static_assert(sizeof(UMoleQuestComponent) == 0x0000B8, "Wrong size on UMoleQuestComponent");
...
static_assert(sizeof(UMoleQuickChatComponent) == 0x000108, "Wrong size on UMoleQuickChatComponent");
static_assert(offsetof(UMoleQuickChatComponent, MinimumTimeBetweenSend) == 0x0000B0, "Member 'UMoleQuickChatComponent::MinimumTimeBetweenSend' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatComponent, MessageInfo) == 0x0000B8, "Member 'UMoleQuickChatComponent::MessageInfo' has a wrong offset!");
...
static_assert(sizeof(UMoleSabotageManagerComponent) == 0x0001E8, "Wrong size on UMoleSabotageManagerComponent");
static_assert(offsetof(UMoleSabotageManagerComponent, RoundStartCooldownEffect) == 0x0000B0, "Member 'UMoleSabotageManagerComponent::RoundStartCooldownEffect' has a wrong offset!");
static_assert(offsetof(UMoleSabotageManagerComponent, RoundStartCooldownEffectForElimination) == 0x0000B8, "Member 'UMoleSabotageManagerComponent::RoundStartCooldownEffectForElimination' has a wrong offset!");
static_assert(offsetof(UMoleSabotageManagerComponent, AfterUseCooldownEffect) == 0x0000C0, "Member 'UMoleSabotageManagerComponent::AfterUseCooldownEffect' has a wrong offset!");
static_assert(offsetof(UMoleSabotageManagerComponent, SaboteurAbilitySet) == 0x0000C8, "Member 'UMoleSabotageManagerComponent::SaboteurAbilitySet' has a wrong offset!");
static_assert(offsetof(UMoleSabotageManagerComponent, SaboteurAbilitySetHandles) == 0x0000D0, "Member 'UMoleSabotageManagerComponent::SaboteurAbilitySetHandles' has a wrong offset!");
static_assert(offsetof(UMoleSabotageManagerComponent, SaboteurAbilitySetInputGuids) == 0x000120, "Member 'UMoleSabotageManagerComponent::SaboteurAbilitySetInputGuids' has a wrong offset!");
static_assert(offsetof(UMoleSabotageManagerComponent, ActiveSabotageHandles) == 0x000170, "Member 'UMoleSabotageManagerComponent::ActiveSabotageHandles' has a wrong offset!");
static_assert(offsetof(UMoleSabotageManagerComponent, SabotageToEventTag) == 0x000180, "Member 'UMoleSabotageManagerComponent::SabotageToEventTag' has a wrong offset!");
static_assert(offsetof(UMoleSabotageManagerComponent, CurrentSabotageStatus) == 0x0001D0, "Member 'UMoleSabotageManagerComponent::CurrentSabotageStatus' has a wrong offset!");
static_assert(offsetof(UMoleSabotageManagerComponent, ActiveSabotageTimerInfo) == 0x0001DC, "Member 'UMoleSabotageManagerComponent::ActiveSabotageTimerInfo' has a wrong offset!");
static_assert(offsetof(UMoleSabotageManagerComponent, CurrentLightingMode) == 0x0001E0, "Member 'UMoleSabotageManagerComponent::CurrentLightingMode' has a wrong offset!");
...
{
public:
	struct FMoleStateGameOverEventData            MoleStateGameOverEventData;                        // 0x0080(0x0020)(Net, Transient, RepNotify, NativeAccessSpecifierPrivate)
	TArray<class APlayerState*>                   ImposterPlayerStates;                              // 0x00A0(0x0010)(Net, ZeroConstructor, Transient, RepNotify, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMoleState_Gameover) == 0x0000B0, "Wrong size on UMoleState_Gameover");
static_assert(offsetof(UMoleState_Gameover, MoleStateGameOverEventData) == 0x000080, "Member 'UMoleState_Gameover::MoleStateGameOverEventData' has a wrong offset!");
static_assert(offsetof(UMoleState_Gameover, ImposterPlayerStates) == 0x0000A0, "Member 'UMoleState_Gameover::ImposterPlayerStates' has a wrong offset!");
...
{
public:
	struct FMoleEmergencyMeetingData              LastSummonedEmergencyMeetingData;                  // 0x00C0(0x0020)(Net, Transient, RepNotify, NoDestructor, Protected, NativeAccessSpecifierProtected)
	TSubclassOf<class AMoleGhostMannequin>        GhostMannequinProxyClass;                          // 0x00E0(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FVector                                GhostMannequinLocationOffset;                      // 0x00E8(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FRotator                               GhostMannequinRotationOffset;                      // 0x00F4(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, NativeAccessSpecifierProtected)
	struct FGameplayTagContainer                  AbilityTagsToBlockInMeeting;                       // 0x0100(0x0020)(Edit, Protected, NativeAccessSpecifierProtected)
	TArray<class APlayerState*>                   FreshlyKilledGhosts;                               // 0x0120(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPrivate)
	TArray<class AMoleGhostMannequin*>            DeadGhostProxies;                                  // 0x0130(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPrivate)
	bool                                          bEmergencyMeetingActive;                           // 0x0140(0x0001)(Net, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_141[0x7];                                      // 0x0141(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static void GetAllMoleFreshlyKilledGhosts(class UObject* WorldContext, TArray<class APlayerState*>* OutFreshlyKilledGhosts);
	static bool IsEmergencyMeetingActive(class UObject* WorldContext);
	static bool RequestEmergencyMeeting(class UObject* WorldContext, const struct FMoleEmergencyMeetingData& MeetingData);
...
static_assert(sizeof(UMoleState_Gameplay) == 0x000148, "Wrong size on UMoleState_Gameplay");
static_assert(offsetof(UMoleState_Gameplay, LastSummonedEmergencyMeetingData) == 0x0000C0, "Member 'UMoleState_Gameplay::LastSummonedEmergencyMeetingData' has a wrong offset!");
static_assert(offsetof(UMoleState_Gameplay, GhostMannequinProxyClass) == 0x0000E0, "Member 'UMoleState_Gameplay::GhostMannequinProxyClass' has a wrong offset!");
static_assert(offsetof(UMoleState_Gameplay, GhostMannequinLocationOffset) == 0x0000E8, "Member 'UMoleState_Gameplay::GhostMannequinLocationOffset' has a wrong offset!");
static_assert(offsetof(UMoleState_Gameplay, GhostMannequinRotationOffset) == 0x0000F4, "Member 'UMoleState_Gameplay::GhostMannequinRotationOffset' has a wrong offset!");
static_assert(offsetof(UMoleState_Gameplay, AbilityTagsToBlockInMeeting) == 0x000100, "Member 'UMoleState_Gameplay::AbilityTagsToBlockInMeeting' has a wrong offset!");
static_assert(offsetof(UMoleState_Gameplay, FreshlyKilledGhosts) == 0x000120, "Member 'UMoleState_Gameplay::FreshlyKilledGhosts' has a wrong offset!");
static_assert(offsetof(UMoleState_Gameplay, DeadGhostProxies) == 0x000130, "Member 'UMoleState_Gameplay::DeadGhostProxies' has a wrong offset!");
static_assert(offsetof(UMoleState_Gameplay, bEmergencyMeetingActive) == 0x000140, "Member 'UMoleState_Gameplay::bEmergencyMeetingActive' has a wrong offset!");
...
static_assert(sizeof(UMoleState_Setup) == 0x000080, "Wrong size on UMoleState_Setup");
...
{
public:
	struct FScalableFloat                         PlayerCountToEnemyIncrement;                       // 0x00C0(0x0028)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	TSubclassOf<class UMolePlayerStateComponent>  MolePlayerStateComponentClass;                     // 0x00E8(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class APlayerState*>                   EnemyPlayerStates;                                 // 0x00F0(0x0010)(ZeroConstructor, Transient, Protected, NativeAccessSpecifierProtected)
	struct FMoleStateGameOverEventData            MoleStateGameOverEventData;                        // 0x0100(0x0020)(Net, Transient, NativeAccessSpecifierPrivate)
	uint8                                         Pad_120[0x20];                                     // 0x0120(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         RemainingSaboteurs;                                // 0x0140(0x0004)(Net, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         StartOfMatchPlayerCount;                           // 0x0144(0x0004)(Net, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)

public:
	static int32 GetMoleRemainingSaboteurCount(class UObject* WorldContextObject);
	static int32 GetMoleStartOfMatchPlayerCount(const class UObject* WorldContextObject);
...
static_assert(sizeof(UMoleStateMachine) == 0x000148, "Wrong size on UMoleStateMachine");
static_assert(offsetof(UMoleStateMachine, PlayerCountToEnemyIncrement) == 0x0000C0, "Member 'UMoleStateMachine::PlayerCountToEnemyIncrement' has a wrong offset!");
static_assert(offsetof(UMoleStateMachine, MolePlayerStateComponentClass) == 0x0000E8, "Member 'UMoleStateMachine::MolePlayerStateComponentClass' has a wrong offset!");
static_assert(offsetof(UMoleStateMachine, EnemyPlayerStates) == 0x0000F0, "Member 'UMoleStateMachine::EnemyPlayerStates' has a wrong offset!");
static_assert(offsetof(UMoleStateMachine, MoleStateGameOverEventData) == 0x000100, "Member 'UMoleStateMachine::MoleStateGameOverEventData' has a wrong offset!");
static_assert(offsetof(UMoleStateMachine, RemainingSaboteurs) == 0x000140, "Member 'UMoleStateMachine::RemainingSaboteurs' has a wrong offset!");
static_assert(offsetof(UMoleStateMachine, StartOfMatchPlayerCount) == 0x000144, "Member 'UMoleStateMachine::StartOfMatchPlayerCount' has a wrong offset!");
...
static_assert(sizeof(UMoleTargetingSelectionTask_BaseMoleTrace) == 0x0000B0, "Wrong size on UMoleTargetingSelectionTask_BaseMoleTrace");
static_assert(offsetof(UMoleTargetingSelectionTask_BaseMoleTrace, PawnTargetingSource) == 0x0000A8, "Member 'UMoleTargetingSelectionTask_BaseMoleTrace::PawnTargetingSource' has a wrong offset!");
...
public:
	...
	TMulticastInlineDelegate<void(class UMoleTaskLinkComponent* TaskLinkComponent, class AFortPawn* InteractingPawn, EInteractionBeingAttempted InteractionType)> OnTaskLinkOwnerActorInteract;                      // 0x00F8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMoleTaskLinkComponent) == 0x000260, "Wrong size on UMoleTaskLinkComponent");
static_assert(offsetof(UMoleTaskLinkComponent, OnTaskPermissionChanged) == 0x0000B0, "Member 'UMoleTaskLinkComponent::OnTaskPermissionChanged' has a wrong offset!");
static_assert(offsetof(UMoleTaskLinkComponent, OnTaskInteractionChanged) == 0x0000D8, "Member 'UMoleTaskLinkComponent::OnTaskInteractionChanged' has a wrong offset!");
static_assert(offsetof(UMoleTaskLinkComponent, OnTaskGenericObjectiveStatChanged) == 0x0000E8, "Member 'UMoleTaskLinkComponent::OnTaskGenericObjectiveStatChanged' has a wrong offset!");
static_assert(offsetof(UMoleTaskLinkComponent, OnTaskLinkOwnerActorInteract) == 0x0000F8, "Member 'UMoleTaskLinkComponent::OnTaskLinkOwnerActorInteract' has a wrong offset!");
static_assert(offsetof(UMoleTaskLinkComponent, TaskTag) == 0x000108, "Member 'UMoleTaskLinkComponent::TaskTag' has a wrong offset!");
static_assert(offsetof(UMoleTaskLinkComponent, TaskInteractionInfoTable) == 0x000110, "Member 'UMoleTaskLinkComponent::TaskInteractionInfoTable' has a wrong offset!");
static_assert(offsetof(UMoleTaskLinkComponent, PlayerTaskStateDataArray) == 0x000138, "Member 'UMoleTaskLinkComponent::PlayerTaskStateDataArray' has a wrong offset!");
...
static_assert(sizeof(UMoleTaskLogicAction_HighlightActors) == 0x000078, "Wrong size on UMoleTaskLogicAction_HighlightActors");
static_assert(offsetof(UMoleTaskLogicAction_HighlightActors, IndicatorRelativeLocationOffset) == 0x00006C, "Member 'UMoleTaskLogicAction_HighlightActors::IndicatorRelativeLocationOffset' has a wrong offset!");
...
static_assert(offsetof(UMoleTaskLogicObjective_FixSabotage, NumOfPointsToFix) == 0x0000F0, "Member 'UMoleTaskLogicObjective_FixSabotage::NumOfPointsToFix' has a wrong offset!");
...
static_assert(sizeof(UMoleTaskLogicObjective_GenericStat) == 0x000178, "Wrong size on UMoleTaskLogicObjective_GenericStat");
static_assert(offsetof(UMoleTaskLogicObjective_GenericStat, StatTag) == 0x0000F0, "Member 'UMoleTaskLogicObjective_GenericStat::StatTag' has a wrong offset!");
static_assert(offsetof(UMoleTaskLogicObjective_GenericStat, InitialValue) == 0x0000F8, "Member 'UMoleTaskLogicObjective_GenericStat::InitialValue' has a wrong offset!");
...
static_assert(offsetof(UMoleTaskLogicObjective_Interact, Quantity) == 0x0000F0, "Member 'UMoleTaskLogicObjective_Interact::Quantity' has a wrong offset!");
...
static_assert(sizeof(UMoleTaskManagerComponent) == 0x000280, "Wrong size on UMoleTaskManagerComponent");
static_assert(offsetof(UMoleTaskManagerComponent, MoleTaskContentMappings) == 0x0000D8, "Member 'UMoleTaskManagerComponent::MoleTaskContentMappings' has a wrong offset!");
static_assert(offsetof(UMoleTaskManagerComponent, AvailableTaskList) == 0x0000E8, "Member 'UMoleTaskManagerComponent::AvailableTaskList' has a wrong offset!");
static_assert(offsetof(UMoleTaskManagerComponent, TaskTrackingData) == 0x0000F8, "Member 'UMoleTaskManagerComponent::TaskTrackingData' has a wrong offset!");
static_assert(offsetof(UMoleTaskManagerComponent, UnpooledTaskAssignments) == 0x000108, "Member 'UMoleTaskManagerComponent::UnpooledTaskAssignments' has a wrong offset!");
static_assert(offsetof(UMoleTaskManagerComponent, TaskPoolDependencyToTaskAssetMap) == 0x000158, "Member 'UMoleTaskManagerComponent::TaskPoolDependencyToTaskAssetMap' has a wrong offset!");
static_assert(offsetof(UMoleTaskManagerComponent, StartOfInUseTasksIdx) == 0x0001A8, "Member 'UMoleTaskManagerComponent::StartOfInUseTasksIdx' has a wrong offset!");
static_assert(offsetof(UMoleTaskManagerComponent, NumTasksPerPlayer) == 0x0001B0, "Member 'UMoleTaskManagerComponent::NumTasksPerPlayer' has a wrong offset!");
static_assert(offsetof(UMoleTaskManagerComponent, NumScoreRequiredPerPlayer) == 0x0001D8, "Member 'UMoleTaskManagerComponent::NumScoreRequiredPerPlayer' has a wrong offset!");
static_assert(offsetof(UMoleTaskManagerComponent, ShouldEnemiesReceiveTasks) == 0x000200, "Member 'UMoleTaskManagerComponent::ShouldEnemiesReceiveTasks' has a wrong offset!");
static_assert(offsetof(UMoleTaskManagerComponent, ScoreData) == 0x000228, "Member 'UMoleTaskManagerComponent::ScoreData' has a wrong offset!");
...
static_assert(sizeof(AMoleTaskPoint) == 0x000220, "Wrong size on AMoleTaskPoint");
...
static_assert(sizeof(UMoleTaskPointManagerComponent) == 0x0000B0, "Wrong size on UMoleTaskPointManagerComponent");
...
{
public:
	struct FMoleActiveTaskStateHandle             Handle;                                            // 0x00C0(0x0004)(BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMoleTaskStateMachine) == 0x0000D0, "Wrong size on UMoleTaskStateMachine");
static_assert(offsetof(UMoleTaskStateMachine, Handle) == 0x0000C0, "Member 'UMoleTaskStateMachine::Handle' has a wrong offset!");
...
static_assert(sizeof(UMoleTeleportAllSabotageAbility) == 0x000B30, "Wrong size on UMoleTeleportAllSabotageAbility");
static_assert(offsetof(UMoleTeleportAllSabotageAbility, TimeBeforeTeleport) == 0x000B00, "Member 'UMoleTeleportAllSabotageAbility::TimeBeforeTeleport' has a wrong offset!");
...
static_assert(sizeof(AMoleTeleportPoint) == 0x000228, "Wrong size on AMoleTeleportPoint");
static_assert(offsetof(AMoleTeleportPoint, SpawnPoint) == 0x000220, "Member 'AMoleTeleportPoint::SpawnPoint' has a wrong offset!");
...
static_assert(sizeof(UMoleVoiceComponent) == 0x0000E8, "Wrong size on UMoleVoiceComponent");
static_assert(offsetof(UMoleVoiceComponent, bIsControllingGameVoiceChannels) == 0x0000B0, "Member 'UMoleVoiceComponent::bIsControllingGameVoiceChannels' has a wrong offset!");
static_assert(offsetof(UMoleVoiceComponent, bIsInLobbyState) == 0x0000B1, "Member 'UMoleVoiceComponent::bIsInLobbyState' has a wrong offset!");
static_assert(offsetof(UMoleVoiceComponent, VoiceChannelState) == 0x0000B2, "Member 'UMoleVoiceComponent::VoiceChannelState' has a wrong offset!");
static_assert(offsetof(UMoleVoiceComponent, MoleGameChannel) == 0x0000B8, "Member 'UMoleVoiceComponent::MoleGameChannel' has a wrong offset!");
static_assert(offsetof(UMoleVoiceComponent, MoleGhostChannel) == 0x0000C8, "Member 'UMoleVoiceComponent::MoleGhostChannel' has a wrong offset!");
...
static_assert(sizeof(UMoleVotingComponent) == 0x000150, "Wrong size on UMoleVotingComponent");
static_assert(offsetof(UMoleVotingComponent, VotingInputComp) == 0x0000C8, "Member 'UMoleVotingComponent::VotingInputComp' has a wrong offset!");
static_assert(offsetof(UMoleVotingComponent, bVoteCasted) == 0x0000D0, "Member 'UMoleVotingComponent::bVoteCasted' has a wrong offset!");
static_assert(offsetof(UMoleVotingComponent, BestVotingTarget) == 0x0000D8, "Member 'UMoleVotingComponent::BestVotingTarget' has a wrong offset!");
static_assert(offsetof(UMoleVotingComponent, VoteBinding) == 0x0000E0, "Member 'UMoleVotingComponent::VoteBinding' has a wrong offset!");
static_assert(offsetof(UMoleVotingComponent, SkipBinding) == 0x000100, "Member 'UMoleVotingComponent::SkipBinding' has a wrong offset!");
static_assert(offsetof(UMoleVotingComponent, CancelEmoteBinding) == 0x000120, "Member 'UMoleVotingComponent::CancelEmoteBinding' has a wrong offset!");
...
{
public:
	TSubclassOf<class UMoleQuickChatComponent>    QuickChatComponentClass;                           // 0x0080(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_88[0x8];                                       // 0x0088(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         DiscussionFinishServerTime;                        // 0x0090(0x0004)(Net, ZeroConstructor, Transient, IsPlainOldData, RepNotify, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMoleVotingState_Discussion) == 0x000098, "Wrong size on UMoleVotingState_Discussion");
static_assert(offsetof(UMoleVotingState_Discussion, QuickChatComponentClass) == 0x000080, "Member 'UMoleVotingState_Discussion::QuickChatComponentClass' has a wrong offset!");
static_assert(offsetof(UMoleVotingState_Discussion, DiscussionFinishServerTime) == 0x000090, "Member 'UMoleVotingState_Discussion::DiscussionFinishServerTime' has a wrong offset!");
...
public:
	...
	struct FMoleVoteResolutionData                VotingResolutionData;                              // 0x0088(0x0020)(Net, RepNotify, NoDestructor, Protected, NativeAccessSpecifierProtected)
	TMap<class APlayerState*, class AMolePlayerStart*> PlayerToPlayerStart;                               // 0x00A8(0x0050)(Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMoleVotingState_ResultDisplay) == 0x0000F8, "Wrong size on UMoleVotingState_ResultDisplay");
static_assert(offsetof(UMoleVotingState_ResultDisplay, VotingResolutionData) == 0x000088, "Member 'UMoleVotingState_ResultDisplay::VotingResolutionData' has a wrong offset!");
static_assert(offsetof(UMoleVotingState_ResultDisplay, PlayerToPlayerStart) == 0x0000A8, "Member 'UMoleVotingState_ResultDisplay::PlayerToPlayerStart' has a wrong offset!");
...
static_assert(sizeof(UMoleVotingState_SummaryDisplay) == 0x000088, "Wrong size on UMoleVotingState_SummaryDisplay");
...
{
public:
	TSubclassOf<class UGameplayAbility>           VotingAbility;                                     // 0x0080(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TMap<class APlayerState*, struct FGameplayAbilitySpecHandle> PlayerStateToVoteAbilityHandle;                    // 0x0088(0x0050)(Transient, Protected, NativeAccessSpecifierProtected)
	TSubclassOf<class UMoleVotingComponent>       VotingComponentClass;                              // 0x00D8(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_E0[0x8];                                       // 0x00E0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         ServerFinishTime;                                  // 0x00E8(0x0004)(Net, ZeroConstructor, Transient, IsPlainOldData, RepNotify, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMoleVotingState_VoteCasting) == 0x0000F0, "Wrong size on UMoleVotingState_VoteCasting");
static_assert(offsetof(UMoleVotingState_VoteCasting, VotingAbility) == 0x000080, "Member 'UMoleVotingState_VoteCasting::VotingAbility' has a wrong offset!");
static_assert(offsetof(UMoleVotingState_VoteCasting, PlayerStateToVoteAbilityHandle) == 0x000088, "Member 'UMoleVotingState_VoteCasting::PlayerStateToVoteAbilityHandle' has a wrong offset!");
static_assert(offsetof(UMoleVotingState_VoteCasting, VotingComponentClass) == 0x0000D8, "Member 'UMoleVotingState_VoteCasting::VotingComponentClass' has a wrong offset!");
static_assert(offsetof(UMoleVotingState_VoteCasting, ServerFinishTime) == 0x0000E8, "Member 'UMoleVotingState_VoteCasting::ServerFinishTime' has a wrong offset!");
...
public:
	...
	float                                         PrepareStateDelayTime;                             // 0x00DC(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<struct FMoleVote>                      VoteList;                                          // 0x00E0(0x0010)(Net, ZeroConstructor, Transient, RepNotify, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMoleVotingStateMachine) == 0x000108, "Wrong size on UMoleVotingStateMachine");
static_assert(offsetof(UMoleVotingStateMachine, PrepareStateDelayTime) == 0x0000DC, "Member 'UMoleVotingStateMachine::PrepareStateDelayTime' has a wrong offset!");
static_assert(offsetof(UMoleVotingStateMachine, VoteList) == 0x0000E0, "Member 'UMoleVotingStateMachine::VoteList' has a wrong offset!");
