...
{
public:
	struct FMoleAbilityUIData                     InAbilityUIData;                                   // 0x0000(0x0060)(Parm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(MoleEnemyAbilityEntry_OnAbilityDataReceived) == 0x000060, "Wrong size on MoleEnemyAbilityEntry_OnAbilityDataReceived");
static_assert(offsetof(MoleEnemyAbilityEntry_OnAbilityDataReceived, InAbilityUIData) == 0x000000, "Member 'MoleEnemyAbilityEntry_OnAbilityDataReceived::InAbilityUIData' has a wrong offset!");
...
static_assert(sizeof(MoleEnemyAbilityOverlay_OnAbilityDataReceived) == 0x000060, "Wrong size on MoleEnemyAbilityOverlay_OnAbilityDataReceived");
...
public:
	...
	struct FMoleAbilityUIData                     OutEnemyAbilityUIData;                             // 0x0010(0x0060)(Parm, OutParm, NativeAccessSpecifierPublic)
...
static_assert(sizeof(MoleUIDirector_GetMoleEnemyAbilityUIData) == 0x000078, "Wrong size on MoleUIDirector_GetMoleEnemyAbilityUIData");
...
static_assert(offsetof(MoleUIDirector_GetMoleEnemyAbilityUIData, ReturnValue) == 0x000070, "Member 'MoleUIDirector_GetMoleEnemyAbilityUIData::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(MoleUIDirector_GetMolePlayerUIData) == 0x000030, "Wrong size on MoleUIDirector_GetMolePlayerUIData");
...
static_assert(offsetof(MoleUIDirector_GetMolePlayerUIData, ReturnValue) == 0x000028, "Member 'MoleUIDirector_GetMolePlayerUIData::ReturnValue' has a wrong offset!");
