...
public:
	...
	bool                                          bUsePlayerSpawningComponent;                       // 0x06E0(0x0001)(Edit, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_6E1[0x7];                                      // 0x06E1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class UPlayspaceControllerComponent_PlayerSpawning> ControllerSpawningComponent;                       // 0x06E8(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(APlayspacePlayerController) == 0x0006F0, "Wrong size on APlayspacePlayerController");
static_assert(offsetof(APlayspacePlayerController, bUsePlayerSpawningComponent) == 0x0006E0, "Member 'APlayspacePlayerController::bUsePlayerSpawningComponent' has a wrong offset!");
static_assert(offsetof(APlayspacePlayerController, ControllerSpawningComponent) == 0x0006E8, "Member 'APlayspacePlayerController::ControllerSpawningComponent' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_D0[0xD8];                                      // 0x00D0(0x00D8)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FActorOverlapEvent>             UnhandledEnterEvents;                              // 0x01A8(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	TArray<struct FActorOverlapEvent>             UnhandledExitEvents;                               // 0x01B8(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UPlayspaceManagerComponent, UnhandledEnterEvents) == 0x0001A8, "Member 'UPlayspaceManagerComponent::UnhandledEnterEvents' has a wrong offset!");
static_assert(offsetof(UPlayspaceManagerComponent, UnhandledExitEvents) == 0x0001B8, "Member 'UPlayspaceManagerComponent::UnhandledExitEvents' has a wrong offset!");
