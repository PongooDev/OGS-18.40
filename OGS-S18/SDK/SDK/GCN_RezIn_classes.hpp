...
public:
	...
	bool                                          DEBUG_ANIMATION;                                   // 0x04A0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	bool                                          SpawnDrone;                                        // 0x04A1(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn)
	...
	bool                                          DEBUG_CHILDCOMPONENTS;                             // 0x0580(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	...
	bool                                          Spawn_VFX_Attached;                                // 0x05B8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	bool                                          DEBUG_TESTJANUSFX;                                 // 0x05D0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(AGCN_RezIn_C) == 0x0005E0, "Wrong size on AGCN_RezIn_C");
static_assert(offsetof(AGCN_RezIn_C, UberGraphFrame) == 0x000470, "Member 'AGCN_RezIn_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AGCN_RezIn_C, TFX_ResOutCharacterMesh_LightIntensity_81C5527F43A6972D94623590BA582E8C) == 0x000478, "Member 'AGCN_RezIn_C::TFX_ResOutCharacterMesh_LightIntensity_81C5527F43A6972D94623590BA582E8C' has a wrong offset!");
static_assert(offsetof(AGCN_RezIn_C, TFX_ResOutCharacterMesh_ZHeightParam_81C5527F43A6972D94623590BA582E8C) == 0x00047C, "Member 'AGCN_RezIn_C::TFX_ResOutCharacterMesh_ZHeightParam_81C5527F43A6972D94623590BA582E8C' has a wrong offset!");
static_assert(offsetof(AGCN_RezIn_C, TFX_ResOutCharacterMesh_TransitionParam_81C5527F43A6972D94623590BA582E8C) == 0x000480, "Member 'AGCN_RezIn_C::TFX_ResOutCharacterMesh_TransitionParam_81C5527F43A6972D94623590BA582E8C' has a wrong offset!");
static_assert(offsetof(AGCN_RezIn_C, TFX_ResOutCharacterMesh__Direction_81C5527F43A6972D94623590BA582E8C) == 0x000484, "Member 'AGCN_RezIn_C::TFX_ResOutCharacterMesh__Direction_81C5527F43A6972D94623590BA582E8C' has a wrong offset!");
static_assert(offsetof(AGCN_RezIn_C, TFX_ResOutCharacterMesh) == 0x000488, "Member 'AGCN_RezIn_C::TFX_ResOutCharacterMesh' has a wrong offset!");
static_assert(offsetof(AGCN_RezIn_C, TFX_GlowCharacterMesh_EmissiveWarp_9EA15145493A8F1A5915938D5529A028) == 0x000490, "Member 'AGCN_RezIn_C::TFX_GlowCharacterMesh_EmissiveWarp_9EA15145493A8F1A5915938D5529A028' has a wrong offset!");
static_assert(offsetof(AGCN_RezIn_C, TFX_GlowCharacterMesh__Direction_9EA15145493A8F1A5915938D5529A028) == 0x000494, "Member 'AGCN_RezIn_C::TFX_GlowCharacterMesh__Direction_9EA15145493A8F1A5915938D5529A028' has a wrong offset!");
static_assert(offsetof(AGCN_RezIn_C, TFX_GlowCharacterMesh) == 0x000498, "Member 'AGCN_RezIn_C::TFX_GlowCharacterMesh' has a wrong offset!");
static_assert(offsetof(AGCN_RezIn_C, DEBUG_ANIMATION) == 0x0004A0, "Member 'AGCN_RezIn_C::DEBUG_ANIMATION' has a wrong offset!");
static_assert(offsetof(AGCN_RezIn_C, SpawnDrone) == 0x0004A1, "Member 'AGCN_RezIn_C::SpawnDrone' has a wrong offset!");
static_assert(offsetof(AGCN_RezIn_C, Teleportation_Drone) == 0x0004A8, "Member 'AGCN_RezIn_C::Teleportation_Drone' has a wrong offset!");
static_assert(offsetof(AGCN_RezIn_C, Teleport_Bot_AnimPlayRate) == 0x0004B0, "Member 'AGCN_RezIn_C::Teleport_Bot_AnimPlayRate' has a wrong offset!");
static_assert(offsetof(AGCN_RezIn_C, Teleport_Bot_Lifespan) == 0x0004B4, "Member 'AGCN_RezIn_C::Teleport_Bot_Lifespan' has a wrong offset!");
static_assert(offsetof(AGCN_RezIn_C, Teleportation_Point_Light) == 0x0004B8, "Member 'AGCN_RezIn_C::Teleportation_Point_Light' has a wrong offset!");
static_assert(offsetof(AGCN_RezIn_C, Teleportation_Light_Offset) == 0x0004C0, "Member 'AGCN_RezIn_C::Teleportation_Light_Offset' has a wrong offset!");
static_assert(offsetof(AGCN_RezIn_C, Teleportation_Light_Color) == 0x0004CC, "Member 'AGCN_RezIn_C::Teleportation_Light_Color' has a wrong offset!");
static_assert(offsetof(AGCN_RezIn_C, DissolveMIDs) == 0x0004E0, "Member 'AGCN_RezIn_C::DissolveMIDs' has a wrong offset!");
static_assert(offsetof(AGCN_RezIn_C, Mat_Chracter_Dissolve) == 0x0004F0, "Member 'AGCN_RezIn_C::Mat_Chracter_Dissolve' has a wrong offset!");
static_assert(offsetof(AGCN_RezIn_C, Pawn) == 0x0004F8, "Member 'AGCN_RezIn_C::Pawn' has a wrong offset!");
static_assert(offsetof(AGCN_RezIn_C, Dissolve) == 0x000500, "Member 'AGCN_RezIn_C::Dissolve' has a wrong offset!");
static_assert(offsetof(AGCN_RezIn_C, Socket_Mesh_Top) == 0x000550, "Member 'AGCN_RezIn_C::Socket_Mesh_Top' has a wrong offset!");
static_assert(offsetof(AGCN_RezIn_C, Max_Light_Intensity) == 0x000558, "Member 'AGCN_RezIn_C::Max_Light_Intensity' has a wrong offset!");
static_assert(offsetof(AGCN_RezIn_C, Socket_Mesh_Bottom) == 0x00055C, "Member 'AGCN_RezIn_C::Socket_Mesh_Bottom' has a wrong offset!");
static_assert(offsetof(AGCN_RezIn_C, Meshes_to_Dissolve) == 0x000568, "Member 'AGCN_RezIn_C::Meshes_to_Dissolve' has a wrong offset!");
static_assert(offsetof(AGCN_RezIn_C, Drone) == 0x000578, "Member 'AGCN_RezIn_C::Drone' has a wrong offset!");
static_assert(offsetof(AGCN_RezIn_C, DEBUG_CHILDCOMPONENTS) == 0x000580, "Member 'AGCN_RezIn_C::DEBUG_CHILDCOMPONENTS' has a wrong offset!");
static_assert(offsetof(AGCN_RezIn_C, Particle_Components) == 0x000588, "Member 'AGCN_RezIn_C::Particle_Components' has a wrong offset!");
static_assert(offsetof(AGCN_RezIn_C, Spawned_Teleport_VFX) == 0x000598, "Member 'AGCN_RezIn_C::Spawned_Teleport_VFX' has a wrong offset!");
static_assert(offsetof(AGCN_RezIn_C, Teleport_In_Visual_Effect) == 0x0005A0, "Member 'AGCN_RezIn_C::Teleport_In_Visual_Effect' has a wrong offset!");
static_assert(offsetof(AGCN_RezIn_C, Teleport_In_VFX_Attach_Point_Name) == 0x0005A8, "Member 'AGCN_RezIn_C::Teleport_In_VFX_Attach_Point_Name' has a wrong offset!");
static_assert(offsetof(AGCN_RezIn_C, Cur_Dissolve_Setup_Attempt) == 0x0005B0, "Member 'AGCN_RezIn_C::Cur_Dissolve_Setup_Attempt' has a wrong offset!");
static_assert(offsetof(AGCN_RezIn_C, AmountOfTimesToAttemptRestoreMats) == 0x0005B4, "Member 'AGCN_RezIn_C::AmountOfTimesToAttemptRestoreMats' has a wrong offset!");
static_assert(offsetof(AGCN_RezIn_C, Spawn_VFX_Attached) == 0x0005B8, "Member 'AGCN_RezIn_C::Spawn_VFX_Attached' has a wrong offset!");
static_assert(offsetof(AGCN_RezIn_C, Dissolve_Timeline_Playrate) == 0x0005BC, "Member 'AGCN_RezIn_C::Dissolve_Timeline_Playrate' has a wrong offset!");
static_assert(offsetof(AGCN_RezIn_C, Glow_Timeline_Playrate) == 0x0005C0, "Member 'AGCN_RezIn_C::Glow_Timeline_Playrate' has a wrong offset!");
static_assert(offsetof(AGCN_RezIn_C, Drone_Visual_Effect) == 0x0005C8, "Member 'AGCN_RezIn_C::Drone_Visual_Effect' has a wrong offset!");
static_assert(offsetof(AGCN_RezIn_C, DEBUG_TESTJANUSFX) == 0x0005D0, "Member 'AGCN_RezIn_C::DEBUG_TESTJANUSFX' has a wrong offset!");
static_assert(offsetof(AGCN_RezIn_C, Drone_VFX_Attach_Point) == 0x0005D4, "Member 'AGCN_RezIn_C::Drone_VFX_Attach_Point' has a wrong offset!");
