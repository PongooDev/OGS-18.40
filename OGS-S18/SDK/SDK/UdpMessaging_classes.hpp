...
public:
	...
	uint32                                        AutoRepairAttemptLimit;                            // 0x002C(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bStopServiceWhenAppDeactivates;                    // 0x0030(0x0001)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UUdpMessagingSettings, AutoRepairAttemptLimit) == 0x00002C, "Member 'UUdpMessagingSettings::AutoRepairAttemptLimit' has a wrong offset!");
static_assert(offsetof(UUdpMessagingSettings, bStopServiceWhenAppDeactivates) == 0x000030, "Member 'UUdpMessagingSettings::bStopServiceWhenAppDeactivates' has a wrong offset!");
