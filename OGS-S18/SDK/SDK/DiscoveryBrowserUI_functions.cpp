...
// Function DiscoveryBrowserUI.FortActivityBrowserView.HandleMovieWidgetMediaStarted
// (Final, Native, Private)

void UFortActivityBrowserView::HandleMovieWidgetMediaStarted()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortActivityBrowserView", "HandleMovieWidgetMediaStarted");
...
void UFortActivityBrowserView::OnMoviePlayingChanged(const bool bIsPlaying)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortActivityBrowserView", "OnMoviePlayingChanged");

	Params::FortActivityBrowserView_OnMoviePlayingChanged Parms{};
...
void UFortActivityBrowserView::OnPreviewImageChanged(const bool bIsLoading, const class UTexture* Texture)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortActivityBrowserView", "OnPreviewImageChanged");

	Params::FortActivityBrowserView_OnPreviewImageChanged Parms{};
...
bool UFortActivityBrowserView::IsShowingPromotedContent() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortActivityBrowserView", "IsShowingPromotedContent");

	Params::FortActivityBrowserView_IsShowingPromotedContent Parms{};
