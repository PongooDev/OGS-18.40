...
{
public:
	class UNormalBangWrapper_C*                   NormalBangWrapper;                                 // 0x0C28(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(UAthenaCustomizationBannerButton_C) == 0x000C30, "Wrong size on UAthenaCustomizationBannerButton_C");
static_assert(offsetof(UAthenaCustomizationBannerButton_C, NormalBangWrapper) == 0x000C28, "Member 'UAthenaCustomizationBannerButton_C::NormalBangWrapper' has a wrong offset!");
