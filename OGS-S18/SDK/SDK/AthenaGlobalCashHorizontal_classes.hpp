...
static_assert(sizeof(UAthenaGlobalCashHorizontal_C) == 0x0002F0, "Wrong size on UAthenaGlobalCashHorizontal_C");
static_assert(offsetof(UAthenaGlobalCashHorizontal_C, UberGraphFrame) == 0x0002E8, "Member 'UAthenaGlobalCashHorizontal_C::UberGraphFrame' has a wrong offset!");
