...
{
public:
	struct FMotoSynthRuntimeSettings              Settings;                                          // 0x0028(0x00C8)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMotoSynthPreset) == 0x0000F0, "Wrong size on UMotoSynthPreset");
...
public:
	...
	uint8                                         Pad_6DC[0x114];                                    // 0x06DC(0x0114)(Fixing Struct Size After Last Property [ Dumper-7 ])
