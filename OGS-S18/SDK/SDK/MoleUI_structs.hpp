...
public:
	...
	class FName                                   InputBinding;                                      // 0x0058(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FMoleAbilityUIData) == 0x000008, "Wrong alignment on FMoleAbilityUIData");
static_assert(sizeof(FMoleAbilityUIData) == 0x000060, "Wrong size on FMoleAbilityUIData");
...
static_assert(offsetof(FMoleAbilityUIData, InputBinding) == 0x000058, "Member 'FMoleAbilityUIData::InputBinding' has a wrong offset!");
...
static_assert(sizeof(FMolePlayerUIData) == 0x000018, "Wrong size on FMolePlayerUIData");
