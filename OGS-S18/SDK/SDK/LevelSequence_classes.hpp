...
{
public:
	TMulticastInlineDelegate<void(class UCameraComponent* CameraComponent)> OnCameraCut;                                       // 0x04F8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(offsetof(ULevelSequencePlayer, OnCameraCut) == 0x0004F8, "Member 'ULevelSequencePlayer::OnCameraCut' has a wrong offset!");
