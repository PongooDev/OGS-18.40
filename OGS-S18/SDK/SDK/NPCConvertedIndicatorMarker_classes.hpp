...
{
public:
	class UImage*                                 IrwinIndicator;                                    // 0x0520(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(UNPCConvertedIndicatorMarker_C) == 0x000528, "Wrong size on UNPCConvertedIndicatorMarker_C");
static_assert(offsetof(UNPCConvertedIndicatorMarker_C, IrwinIndicator) == 0x000520, "Member 'UNPCConvertedIndicatorMarker_C::IrwinIndicator' has a wrong offset!");
