...
{
public:
	bool                                          bEnabled;                                          // 0x02C8(0x0001)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2C9[0x3];                                      // 0x02C9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         MinimumDisplayTime;                                // 0x02CC(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         UpdateTime;                                        // 0x02D0(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         InitialDelay;                                      // 0x02D4(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UBadNetworkIndicator) == 0x0002F8, "Wrong size on UBadNetworkIndicator");
static_assert(offsetof(UBadNetworkIndicator, bEnabled) == 0x0002C8, "Member 'UBadNetworkIndicator::bEnabled' has a wrong offset!");
static_assert(offsetof(UBadNetworkIndicator, MinimumDisplayTime) == 0x0002CC, "Member 'UBadNetworkIndicator::MinimumDisplayTime' has a wrong offset!");
static_assert(offsetof(UBadNetworkIndicator, UpdateTime) == 0x0002D0, "Member 'UBadNetworkIndicator::UpdateTime' has a wrong offset!");
static_assert(offsetof(UBadNetworkIndicator, InitialDelay) == 0x0002D4, "Member 'UBadNetworkIndicator::InitialDelay' has a wrong offset!");
