...
public:
	...
	int32                                         RandomSeedOffset;                                  // 0x0454(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	uint8                                         BitPad_520_2 : 6;                                  // 0x0520(0x0001)(Fixing Bit-Field Size For New Byte [ Dumper-7 ])
	...
	uint8                                         Pad_58B[0x9];                                      // 0x058B(0x0009)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         BitPad_594_0 : 4;                                  // 0x0594(0x0001)(Fixing Bit-Field Size Between Bits [ Dumper-7 ])
	uint8                                         bAllowScalability : 1;                             // 0x0594(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         Pad_595[0x5B];                                     // 0x0595(0x005B)(Fixing Size After Last Property [ Dumper-7 ])
	class UNiagaraCullProxyComponent*             CullProxy;                                         // 0x05F0(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UNiagaraComponent, Asset) == 0x000448, "Member 'UNiagaraComponent::Asset' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, TickBehavior) == 0x000450, "Member 'UNiagaraComponent::TickBehavior' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, RandomSeedOffset) == 0x000454, "Member 'UNiagaraComponent::RandomSeedOffset' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, OverrideParameters) == 0x000458, "Member 'UNiagaraComponent::OverrideParameters' has a wrong offset!");
...
static_assert(offsetof(UNiagaraComponent, CullProxy) == 0x0005F0, "Member 'UNiagaraComponent::CullProxy' has a wrong offset!");
...
public:
	...
	bool                                          bAllowInCullProxies;                               // 0x0061(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bMotionBlurEnabled;                                // 0x0062(0x0001)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UNiagaraRendererProperties, bAllowInCullProxies) == 0x000061, "Member 'UNiagaraRendererProperties::bAllowInCullProxies' has a wrong offset!");
static_assert(offsetof(UNiagaraRendererProperties, bMotionBlurEnabled) == 0x000062, "Member 'UNiagaraRendererProperties::bMotionBlurEnabled' has a wrong offset!");
...
public:
	...
	TSet<struct FNiagaraEmitterNameSettingsRef>   GPUEmitterWhitelist;                               // 0x0118(0x0050)(Config, NativeAccessSpecifierPublic)
	TSet<class FName>                             GpuDataInterfaceBlacklist;                         // 0x0168(0x0050)(Config, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UNiagaraComponentSettings, GPUEmitterWhitelist) == 0x000118, "Member 'UNiagaraComponentSettings::GPUEmitterWhitelist' has a wrong offset!");
static_assert(offsetof(UNiagaraComponentSettings, GpuDataInterfaceBlacklist) == 0x000168, "Member 'UNiagaraComponentSettings::GpuDataInterfaceBlacklist' has a wrong offset!");
...
{
public:
	TArray<struct FNiagaraCulledComponentInfo>    Instances;                                         // 0x05F8(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNiagaraCullProxyComponent) == 0x000610, "Wrong size on UNiagaraCullProxyComponent");
static_assert(offsetof(UNiagaraCullProxyComponent, Instances) == 0x0005F8, "Member 'UNiagaraCullProxyComponent::Instances' has a wrong offset!");
...
public:
	...
	struct FNiagaraDebugHUDSettingsData           Data;                                              // 0x0048(0x0118)(Edit, Config, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNiagaraDebugHUDSettings) == 0x000160, "Wrong size on UNiagaraDebugHUDSettings");
...
public:
	...
	uint8                                         bDeprecatedShaderStagesEnabled : 1;                // 0x0110(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bSimulationStagesEnabled : 1;                      // 0x0110(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bLimitDeltaTime : 1;                               // 0x0110(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_111[0x7];                                      // 0x0111(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 UniqueEmitterName;                                 // 0x0118(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class UNiagaraRendererProperties*>     RendererProperties;                                // 0x0128(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	TArray<struct FNiagaraEventScriptProperties>  EventHandlerScriptProps;                           // 0x0138(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPrivate)
	TArray<class UNiagaraSimulationStageBase*>    SimulationStages;                                  // 0x0148(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	class UNiagaraScript*                         GPUComputeScript;                                  // 0x0158(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class FName>                           SharedEventGeneratorIds;                           // 0x0160(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UNiagaraEmitter) == 0x000248, "Wrong size on UNiagaraEmitter");
...
static_assert(offsetof(UNiagaraEmitter, UniqueEmitterName) == 0x000118, "Member 'UNiagaraEmitter::UniqueEmitterName' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, RendererProperties) == 0x000128, "Member 'UNiagaraEmitter::RendererProperties' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, EventHandlerScriptProps) == 0x000138, "Member 'UNiagaraEmitter::EventHandlerScriptProps' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, SimulationStages) == 0x000148, "Member 'UNiagaraEmitter::SimulationStages' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, GPUComputeScript) == 0x000158, "Member 'UNiagaraEmitter::GPUComputeScript' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, SharedEventGeneratorIds) == 0x000160, "Member 'UNiagaraEmitter::SharedEventGeneratorIds' has a wrong offset!");
...
public:
	...
	struct FTransform                             DesiredRelativeTransform;                          // 0x0240(0x0030)(Edit, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, NativeAccessSpecifierProtected)
	float                                         BaseAuthoredFOV;                                   // 0x0270(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         bAllowMultipleInstances : 1;                       // 0x0274(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, DisableEditOnInstance, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bResetWhenRetriggered : 1;                         // 0x0274(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, DisableEditOnInstance, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         Pad_275[0x3];                                      // 0x0275(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<TSubclassOf<class AActor>>             EmittersToTreatAsSame;                             // 0x0278(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	class APlayerCameraManager*                   OwningCameraManager;                               // 0x0288(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(ANiagaraLensEffectBase) == 0x000290, "Wrong size on ANiagaraLensEffectBase");
static_assert(offsetof(ANiagaraLensEffectBase, DesiredRelativeTransform) == 0x000240, "Member 'ANiagaraLensEffectBase::DesiredRelativeTransform' has a wrong offset!");
static_assert(offsetof(ANiagaraLensEffectBase, BaseAuthoredFOV) == 0x000270, "Member 'ANiagaraLensEffectBase::BaseAuthoredFOV' has a wrong offset!");
static_assert(offsetof(ANiagaraLensEffectBase, EmittersToTreatAsSame) == 0x000278, "Member 'ANiagaraLensEffectBase::EmittersToTreatAsSame' has a wrong offset!");
static_assert(offsetof(ANiagaraLensEffectBase, OwningCameraManager) == 0x000288, "Member 'ANiagaraLensEffectBase::OwningCameraManager' has a wrong offset!");
...
public:
	...
	struct FNiagaraVMExecutableData               CachedScriptVM;                                    // 0x01C8(0x0138)(NativeAccessSpecifierPrivate)
	TArray<class UNiagaraParameterCollection*>    CachedParameterCollectionReferences;               // 0x0300(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	TArray<struct FNiagaraScriptDataInterfaceInfo> CachedDefaultDataInterfaces;                       // 0x0310(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UNiagaraScript) == 0x000328, "Wrong size on UNiagaraScript");
...
static_assert(offsetof(UNiagaraScript, CachedParameterCollectionReferences) == 0x000300, "Member 'UNiagaraScript::CachedParameterCollectionReferences' has a wrong offset!");
static_assert(offsetof(UNiagaraScript, CachedDefaultDataInterfaces) == 0x000310, "Member 'UNiagaraScript::CachedDefaultDataInterfaces' has a wrong offset!");
...
{
public:
	uint8                                         bOverrideCastShadow : 1;                           // 0x0030(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverrideReceivesDecals : 1;                       // 0x0030(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverrideRenderCustomDepth : 1;                    // 0x0030(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverrideCustomDepthStencilValue : 1;              // 0x0030(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverrideCustomDepthStencilWriteMask : 1;          // 0x0030(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bCastShadow : 1;                                   // 0x0030(0x0001)(BitIndex: 0x05, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bReceivesDecals : 1;                               // 0x0030(0x0001)(BitIndex: 0x06, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bRenderCustomDepth : 1;                            // 0x0030(0x0001)(BitIndex: 0x07, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	ERendererStencilMask                          CustomDepthStencilWriteMask;                       // 0x0031(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	bool                                          bDeterminism;                                      // 0x03AD(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_3AE[0x2];                                      // 0x03AE(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         RandomSeed;                                        // 0x03B0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         WarmupTime;                                        // 0x03B4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         WarmupTickCount;                                   // 0x03B8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UNiagaraSystem) == 0x0004F8, "Wrong size on UNiagaraSystem");
static_assert(offsetof(UNiagaraSystem, CustomDepthStencilWriteMask) == 0x000031, "Member 'UNiagaraSystem::CustomDepthStencilWriteMask' has a wrong offset!");
...
static_assert(offsetof(UNiagaraSystem, bDeterminism) == 0x0003AD, "Member 'UNiagaraSystem::bDeterminism' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, RandomSeed) == 0x0003B0, "Member 'UNiagaraSystem::RandomSeed' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, WarmupTime) == 0x0003B4, "Member 'UNiagaraSystem::WarmupTime' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, WarmupTickCount) == 0x0003B8, "Member 'UNiagaraSystem::WarmupTickCount' has a wrong offset!");
