...
static_assert(sizeof(UGameFeatureAction_DataRegistry) == 0x000038, "Wrong size on UGameFeatureAction_DataRegistry");
...
static_assert(sizeof(UGameFeatureAction_DataRegistrySource) == 0x000038, "Wrong size on UGameFeatureAction_DataRegistrySource");
