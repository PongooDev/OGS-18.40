...
public:
	...
	struct FFortTournamentDisplayInfo             K2Node_Event_ColorInfo;                            // 0x0050(0x01B8)()
	...
	TDelegate<void(class UCommonButtonLegacy* Button)> K2Node_CreateDelegate_OutputDelegate_1;            // 0x0218(0x0010)(ZeroConstructor, NoDestructor)
	class ULeaderboardTab_C*                      K2Node_DynamicCast_AsLeaderboard_Tab;              // 0x0228(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x0230(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_231[0x7];                                      // 0x0231(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class ULeaderboardListViewWrapper_C*          K2Node_DynamicCast_AsLeaderboard_List_View_Wrapper; // 0x0238(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess_1;                     // 0x0240(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_241[0x7];                                      // 0x0241(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UListView*                              CallFunc_GetListView_ReturnValue;                  // 0x0248(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UObject*                                K2Node_CustomEvent_Item;                           // 0x0250(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UFortEventLeaderboardEntryData*         K2Node_DynamicCast_AsFort_Event_Leaderboard_Entry_Data; // 0x0258(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess_2;                     // 0x0260(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_261[0x7];                                      // 0x0261(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UArenaViewMeTab_C*                      K2Node_DynamicCast_AsArena_View_Me_Tab;            // 0x0268(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ArenaLeaderboard_C_ExecuteUbergraph_ArenaLeaderboard) == 0x000278, "Wrong size on ArenaLeaderboard_C_ExecuteUbergraph_ArenaLeaderboard");
...
static_assert(offsetof(ArenaLeaderboard_C_ExecuteUbergraph_ArenaLeaderboard, CallFunc_GetDynamicMaterial_ReturnValue) == 0x000208, "Member 'ArenaLeaderboard_C_ExecuteUbergraph_ArenaLeaderboard::CallFunc_GetDynamicMaterial_ReturnValue' has a wrong offset!");
static_assert(offsetof(ArenaLeaderboard_C_ExecuteUbergraph_ArenaLeaderboard, CallFunc_GetDynamicMaterial_ReturnValue_1) == 0x000210, "Member 'ArenaLeaderboard_C_ExecuteUbergraph_ArenaLeaderboard::CallFunc_GetDynamicMaterial_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(ArenaLeaderboard_C_ExecuteUbergraph_ArenaLeaderboard, K2Node_CreateDelegate_OutputDelegate_1) == 0x000218, "Member 'ArenaLeaderboard_C_ExecuteUbergraph_ArenaLeaderboard::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(ArenaLeaderboard_C_ExecuteUbergraph_ArenaLeaderboard, K2Node_DynamicCast_AsLeaderboard_Tab) == 0x000228, "Member 'ArenaLeaderboard_C_ExecuteUbergraph_ArenaLeaderboard::K2Node_DynamicCast_AsLeaderboard_Tab' has a wrong offset!");
static_assert(offsetof(ArenaLeaderboard_C_ExecuteUbergraph_ArenaLeaderboard, K2Node_DynamicCast_bSuccess) == 0x000230, "Member 'ArenaLeaderboard_C_ExecuteUbergraph_ArenaLeaderboard::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(ArenaLeaderboard_C_ExecuteUbergraph_ArenaLeaderboard, K2Node_DynamicCast_AsLeaderboard_List_View_Wrapper) == 0x000238, "Member 'ArenaLeaderboard_C_ExecuteUbergraph_ArenaLeaderboard::K2Node_DynamicCast_AsLeaderboard_List_View_Wrapper' has a wrong offset!");
static_assert(offsetof(ArenaLeaderboard_C_ExecuteUbergraph_ArenaLeaderboard, K2Node_DynamicCast_bSuccess_1) == 0x000240, "Member 'ArenaLeaderboard_C_ExecuteUbergraph_ArenaLeaderboard::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(ArenaLeaderboard_C_ExecuteUbergraph_ArenaLeaderboard, CallFunc_GetListView_ReturnValue) == 0x000248, "Member 'ArenaLeaderboard_C_ExecuteUbergraph_ArenaLeaderboard::CallFunc_GetListView_ReturnValue' has a wrong offset!");
static_assert(offsetof(ArenaLeaderboard_C_ExecuteUbergraph_ArenaLeaderboard, K2Node_CustomEvent_Item) == 0x000250, "Member 'ArenaLeaderboard_C_ExecuteUbergraph_ArenaLeaderboard::K2Node_CustomEvent_Item' has a wrong offset!");
static_assert(offsetof(ArenaLeaderboard_C_ExecuteUbergraph_ArenaLeaderboard, K2Node_DynamicCast_AsFort_Event_Leaderboard_Entry_Data) == 0x000258, "Member 'ArenaLeaderboard_C_ExecuteUbergraph_ArenaLeaderboard::K2Node_DynamicCast_AsFort_Event_Leaderboard_Entry_Data' has a wrong offset!");
static_assert(offsetof(ArenaLeaderboard_C_ExecuteUbergraph_ArenaLeaderboard, K2Node_DynamicCast_bSuccess_2) == 0x000260, "Member 'ArenaLeaderboard_C_ExecuteUbergraph_ArenaLeaderboard::K2Node_DynamicCast_bSuccess_2' has a wrong offset!");
static_assert(offsetof(ArenaLeaderboard_C_ExecuteUbergraph_ArenaLeaderboard, K2Node_DynamicCast_AsArena_View_Me_Tab) == 0x000268, "Member 'ArenaLeaderboard_C_ExecuteUbergraph_ArenaLeaderboard::K2Node_DynamicCast_AsArena_View_Me_Tab' has a wrong offset!");
static_assert(offsetof(ArenaLeaderboard_C_ExecuteUbergraph_ArenaLeaderboard, K2Node_DynamicCast_bSuccess_3) == 0x000270, "Member 'ArenaLeaderboard_C_ExecuteUbergraph_ArenaLeaderboard::K2Node_DynamicCast_bSuccess_3' has a wrong offset!");
...
{
public:
	struct FFortTournamentDisplayInfo             ColorInfo;                                         // 0x0000(0x01B8)(BlueprintVisible, BlueprintReadOnly, Parm)
};
static_assert(alignof(ArenaLeaderboard_C_OnColorize) == 0x000008, "Wrong alignment on ArenaLeaderboard_C_OnColorize");
static_assert(sizeof(ArenaLeaderboard_C_OnColorize) == 0x0001B8, "Wrong size on ArenaLeaderboard_C_OnColorize");
