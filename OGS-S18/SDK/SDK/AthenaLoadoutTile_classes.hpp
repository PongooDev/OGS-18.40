...
static_assert(sizeof(UAthenaLoadoutTile_C) == 0x000C40, "Wrong size on UAthenaLoadoutTile_C");
static_assert(offsetof(UAthenaLoadoutTile_C, UberGraphFrame) == 0x000C38, "Member 'UAthenaLoadoutTile_C::UberGraphFrame' has a wrong offset!");
