...
public:
	void OnInitialize();
	void OnUpdate();
	bool UpdateVirtualSubjectFrameData_Internal(const struct FLiveLinkBaseFrameData& InStruct);
...
static_assert(sizeof(ULiveLinkBlueprintVirtualSubject) == 0x000100, "Wrong size on ULiveLinkBlueprintVirtualSubject");
