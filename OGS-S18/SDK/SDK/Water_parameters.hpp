...
static_assert(alignof(WaterBody_GetWaterVelocityVectorAtSplineInputKey) == 0x000004, "Wrong alignment on WaterBody_GetWaterVelocityVectorAtSplineInputKey");
static_assert(sizeof(WaterBody_GetWaterVelocityVectorAtSplineInputKey) == 0x000010, "Wrong size on WaterBody_GetWaterVelocityVectorAtSplineInputKey");
...
static_assert(offsetof(WaterBody_GetWaterVelocityVectorAtSplineInputKey, ReturnValue) == 0x000004, "Member 'WaterBody_GetWaterVelocityVectorAtSplineInputKey::ReturnValue' has a wrong offset!");
