...
static_assert(sizeof(USoundLibraryAnimContext) == 0x000060, "Wrong size on USoundLibraryAnimContext");
...
static_assert(offsetof(USoundLibraryAnimContext, Animation) == 0x000050, "Member 'USoundLibraryAnimContext::Animation' has a wrong offset!");
static_assert(offsetof(USoundLibraryAnimContext, AnimRate) == 0x000058, "Member 'USoundLibraryAnimContext::AnimRate' has a wrong offset!");
