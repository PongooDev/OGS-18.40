...
// Function HermesPlaysetsUI.DownloadOnDemandDirector.CanShowRemoveButton
// 0x0001 (0x0001 - 0x0000)
struct DownloadOnDemandDirector_CanShowRemoveButton final
{
public:
	bool                                          ReturnValue;                                       // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(DownloadOnDemandDirector_CanShowRemoveButton) == 0x000001, "Wrong alignment on DownloadOnDemandDirector_CanShowRemoveButton");
static_assert(sizeof(DownloadOnDemandDirector_CanShowRemoveButton) == 0x000001, "Wrong size on DownloadOnDemandDirector_CanShowRemoveButton");
static_assert(offsetof(DownloadOnDemandDirector_CanShowRemoveButton, ReturnValue) == 0x000000, "Member 'DownloadOnDemandDirector_CanShowRemoveButton::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(DownloadOnDemandDirector_LoadLinkCodeMetaData) == 0x000030, "Wrong size on DownloadOnDemandDirector_LoadLinkCodeMetaData");
static_assert(offsetof(DownloadOnDemandDirector_LoadLinkCodeMetaData, InLinkCode) == 0x000000, "Member 'DownloadOnDemandDirector_LoadLinkCodeMetaData::InLinkCode' has a wrong offset!");
static_assert(offsetof(DownloadOnDemandDirector_LoadLinkCodeMetaData, InProjectId) == 0x000010, "Member 'DownloadOnDemandDirector_LoadLinkCodeMetaData::InProjectId' has a wrong offset!");
static_assert(offsetof(DownloadOnDemandDirector_LoadLinkCodeMetaData, InFortPlayerControllerAthena) == 0x000020, "Member 'DownloadOnDemandDirector_LoadLinkCodeMetaData::InFortPlayerControllerAthena' has a wrong offset!");
static_assert(offsetof(DownloadOnDemandDirector_LoadLinkCodeMetaData, ReturnValue) == 0x000028, "Member 'DownloadOnDemandDirector_LoadLinkCodeMetaData::ReturnValue' has a wrong offset!");
