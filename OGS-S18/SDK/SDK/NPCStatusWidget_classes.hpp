...
static_assert(sizeof(UNPCStatusWidget_C) == 0x0002A0, "Wrong size on UNPCStatusWidget_C");
...
static_assert(offsetof(UNPCStatusWidget_C, CurrentHealthPercent) == 0x000294, "Member 'UNPCStatusWidget_C::CurrentHealthPercent' has a wrong offset!");
static_assert(offsetof(UNPCStatusWidget_C, CurrentShieldPercent) == 0x000298, "Member 'UNPCStatusWidget_C::CurrentShieldPercent' has a wrong offset!");
