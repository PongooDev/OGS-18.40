...
public:
	...
	class UFortUIFriendNotification*              K2Node_DynamicCast_AsFort_UIFriend_Notification;   // 0x00D8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x00E0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_SwitchEnum_CmpSuccess;                      // 0x00E1(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	ESlateVisibility                              CallFunc_GetOpenButtonVisibility_ReturnValue;      // 0x00E2(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(ToastWidget_New_C_SetToast) == 0x000008, "Wrong alignment on ToastWidget_New_C_SetToast");
static_assert(sizeof(ToastWidget_New_C_SetToast) == 0x0000E8, "Wrong size on ToastWidget_New_C_SetToast");
...
static_assert(offsetof(ToastWidget_New_C_SetToast, CallFunc_GetLocalPlayerSubsystem_ReturnValue) == 0x000060, "Member 'ToastWidget_New_C_SetToast::CallFunc_GetLocalPlayerSubsystem_ReturnValue' has a wrong offset!");
static_assert(offsetof(ToastWidget_New_C_SetToast, CallFunc_IsInZone_ReturnValue) == 0x000068, "Member 'ToastWidget_New_C_SetToast::CallFunc_IsInZone_ReturnValue' has a wrong offset!");
static_assert(offsetof(ToastWidget_New_C_SetToast, K2Node_MakeStruct_FormatArgumentData_1) == 0x000070, "Member 'ToastWidget_New_C_SetToast::K2Node_MakeStruct_FormatArgumentData_1' has a wrong offset!");
static_assert(offsetof(ToastWidget_New_C_SetToast, K2Node_MakeArray_Array) == 0x0000B0, "Member 'ToastWidget_New_C_SetToast::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(ToastWidget_New_C_SetToast, CallFunc_Format_ReturnValue) == 0x0000C0, "Member 'ToastWidget_New_C_SetToast::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(ToastWidget_New_C_SetToast, K2Node_DynamicCast_AsFort_UIFriend_Notification) == 0x0000D8, "Member 'ToastWidget_New_C_SetToast::K2Node_DynamicCast_AsFort_UIFriend_Notification' has a wrong offset!");
static_assert(offsetof(ToastWidget_New_C_SetToast, K2Node_DynamicCast_bSuccess) == 0x0000E0, "Member 'ToastWidget_New_C_SetToast::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(ToastWidget_New_C_SetToast, K2Node_SwitchEnum_CmpSuccess) == 0x0000E1, "Member 'ToastWidget_New_C_SetToast::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(ToastWidget_New_C_SetToast, CallFunc_GetOpenButtonVisibility_ReturnValue) == 0x0000E2, "Member 'ToastWidget_New_C_SetToast::CallFunc_GetOpenButtonVisibility_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(ToastWidget_New_C_ExecuteUbergraph_ToastWidget_New) == 0x000150, "Wrong size on ToastWidget_New_C_ExecuteUbergraph_ToastWidget_New");
...
static_assert(offsetof(ToastWidget_New_C_ExecuteUbergraph_ToastWidget_New, K2Node_Event_ToastNotification) == 0x000148, "Member 'ToastWidget_New_C_ExecuteUbergraph_ToastWidget_New::K2Node_Event_ToastNotification' has a wrong offset!");
