...
public:
	...
	TMulticastInlineDelegate<void(int32 SecondsRemaining)> OnSecondsRemainingUpdated;                         // 0x0278(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	TMulticastInlineDelegate<void()>              FadeOut;                                           // 0x0288(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
static_assert(sizeof(ABP_Generic_TimerManager_C) == 0x000298, "Wrong size on ABP_Generic_TimerManager_C");
...
static_assert(offsetof(ABP_Generic_TimerManager_C, OnSecondsRemainingUpdated) == 0x000278, "Member 'ABP_Generic_TimerManager_C::OnSecondsRemainingUpdated' has a wrong offset!");
static_assert(offsetof(ABP_Generic_TimerManager_C, FadeOut) == 0x000288, "Member 'ABP_Generic_TimerManager_C::FadeOut' has a wrong offset!");
