...
static_assert(sizeof(ASidewaysPlayspace) == 0x000540, "Wrong size on ASidewaysPlayspace");
...
static_assert(sizeof(UFortControllerComponent_Sideways) == 0x0000B8, "Wrong size on UFortControllerComponent_Sideways");
static_assert(offsetof(UFortControllerComponent_Sideways, UpdateClosestSidewaysHandle) == 0x0000B0, "Member 'UFortControllerComponent_Sideways::UpdateClosestSidewaysHandle' has a wrong offset!");
...
static_assert(sizeof(UPlayspaceComponent_SidewaysDimension) == 0x000170, "Wrong size on UPlayspaceComponent_SidewaysDimension");
static_assert(offsetof(UPlayspaceComponent_SidewaysDimension, CachedAIServiceLoot) == 0x000168, "Member 'UPlayspaceComponent_SidewaysDimension::CachedAIServiceLoot' has a wrong offset!");
...
static_assert(sizeof(UPlayspaceComponent_SidewaysEncounter) == 0x000108, "Wrong size on UPlayspaceComponent_SidewaysEncounter");
...
static_assert(sizeof(USidewaysFeatureAction_HoldGlobalData) == 0x000070, "Wrong size on USidewaysFeatureAction_HoldGlobalData");
...
static_assert(offsetof(USidewaysFeatureAction_HoldGlobalData, SidewaysBubbleRadiusParameterNamesForLocalPlayers) == 0x000060, "Member 'USidewaysFeatureAction_HoldGlobalData::SidewaysBubbleRadiusParameterNamesForLocalPlayers' has a wrong offset!");
...
static_assert(sizeof(USidewaysStateComponent) == 0x0000D8, "Wrong size on USidewaysStateComponent");
static_assert(offsetof(USidewaysStateComponent, SidewaysState) == 0x0000B0, "Member 'USidewaysStateComponent::SidewaysState' has a wrong offset!");
static_assert(offsetof(USidewaysStateComponent, SidewaysPlayspace) == 0x0000B8, "Member 'USidewaysStateComponent::SidewaysPlayspace' has a wrong offset!");
static_assert(offsetof(USidewaysStateComponent, OnSidewaysStateChangedDelegate) == 0x0000C0, "Member 'USidewaysStateComponent::OnSidewaysStateChangedDelegate' has a wrong offset!");
...
static_assert(sizeof(USidewaysStateComponent_Player) == 0x000138, "Wrong size on USidewaysStateComponent_Player");
static_assert(offsetof(USidewaysStateComponent_Player, SidewaysMaterialParameterCollection) == 0x0000D8, "Member 'USidewaysStateComponent_Player::SidewaysMaterialParameterCollection' has a wrong offset!");
static_assert(offsetof(USidewaysStateComponent_Player, SidewaysBubbleLocationParameterNamesForLocalPlayers) == 0x000100, "Member 'USidewaysStateComponent_Player::SidewaysBubbleLocationParameterNamesForLocalPlayers' has a wrong offset!");
static_assert(offsetof(USidewaysStateComponent_Player, SidewaysBubbleRadiusParameterNamesForLocalPlayers) == 0x000110, "Member 'USidewaysStateComponent_Player::SidewaysBubbleRadiusParameterNamesForLocalPlayers' has a wrong offset!");
static_assert(offsetof(USidewaysStateComponent_Player, ExtraCorruptionRadius) == 0x000120, "Member 'USidewaysStateComponent_Player::ExtraCorruptionRadius' has a wrong offset!");
static_assert(offsetof(USidewaysStateComponent_Player, MinRadiusToHaveAnyCorruption) == 0x000124, "Member 'USidewaysStateComponent_Player::MinRadiusToHaveAnyCorruption' has a wrong offset!");
static_assert(offsetof(USidewaysStateComponent_Player, MaxRadiusForScalingExtraCorruptionRadius) == 0x000128, "Member 'USidewaysStateComponent_Player::MaxRadiusForScalingExtraCorruptionRadius' has a wrong offset!");
static_assert(offsetof(USidewaysStateComponent_Player, UpdateFrequency) == 0x00012C, "Member 'USidewaysStateComponent_Player::UpdateFrequency' has a wrong offset!");
...
static_assert(sizeof(ASidewaysVolume) == 0x0002A0, "Wrong size on ASidewaysVolume");
