...
public:
	...
	struct FFortBaseWeaponStats                   CallFunc_GetDataTableRowFromName_OutRow;           // 0x0010(0x0168)()
	...
	bool                                          CallFunc_EvaluateAttributeValueWithTagsAndBase_bSuccess; // 0x01A4(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_1A5[0x3];                                      // 0x01A5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         CallFunc_EvaluateAttributeValueWithTagsAndBase_ReturnValue; // 0x01A8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(GA_Ninja_Tactical_MeleeHitsHeal_C_SetupAbility) == 0x0001B0, "Wrong size on GA_Ninja_Tactical_MeleeHitsHeal_C_SetupAbility");
...
static_assert(offsetof(GA_Ninja_Tactical_MeleeHitsHeal_C_SetupAbility, CallFunc_GetDataTableRowFromName_ReturnValue) == 0x000178, "Member 'GA_Ninja_Tactical_MeleeHitsHeal_C_SetupAbility::CallFunc_GetDataTableRowFromName_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_Ninja_Tactical_MeleeHitsHeal_C_SetupAbility, CallFunc_MakeLiteralGameplayTagContainer_ReturnValue) == 0x000180, "Member 'GA_Ninja_Tactical_MeleeHitsHeal_C_SetupAbility::CallFunc_MakeLiteralGameplayTagContainer_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_Ninja_Tactical_MeleeHitsHeal_C_SetupAbility, CallFunc_Multiply_FloatFloat_ReturnValue) == 0x0001A0, "Member 'GA_Ninja_Tactical_MeleeHitsHeal_C_SetupAbility::CallFunc_Multiply_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_Ninja_Tactical_MeleeHitsHeal_C_SetupAbility, CallFunc_EvaluateAttributeValueWithTagsAndBase_bSuccess) == 0x0001A4, "Member 'GA_Ninja_Tactical_MeleeHitsHeal_C_SetupAbility::CallFunc_EvaluateAttributeValueWithTagsAndBase_bSuccess' has a wrong offset!");
static_assert(offsetof(GA_Ninja_Tactical_MeleeHitsHeal_C_SetupAbility, CallFunc_EvaluateAttributeValueWithTagsAndBase_ReturnValue) == 0x0001A8, "Member 'GA_Ninja_Tactical_MeleeHitsHeal_C_SetupAbility::CallFunc_EvaluateAttributeValueWithTagsAndBase_ReturnValue' has a wrong offset!");
