...
{
public:
	TArray<struct FWarEffortMutatorChoiceData>    WeaponChoices;                                     // 0x03D8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TArray<struct FPrimaryAssetId>                PreloadedWarEffortWeapons;                         // 0x03E8(0x0010)(Net, ZeroConstructor, RepNotify, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AFortAthenaMutator_WarEffort) == 0x000450, "Wrong size on AFortAthenaMutator_WarEffort");
static_assert(offsetof(AFortAthenaMutator_WarEffort, WeaponChoices) == 0x0003D8, "Member 'AFortAthenaMutator_WarEffort::WeaponChoices' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_WarEffort, PreloadedWarEffortWeapons) == 0x0003E8, "Member 'AFortAthenaMutator_WarEffort::PreloadedWarEffortWeapons' has a wrong offset!");
