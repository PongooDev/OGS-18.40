...
{
public:
	struct FScriptedObjectMovement_StaticPathStepData StepData;                                          // 0x0000(0x0090)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FortScriptedObjectMovement_MovableObjectBase_BeginMovingToStaticPathNode) == 0x000090, "Wrong size on FortScriptedObjectMovement_MovableObjectBase_BeginMovingToStaticPathNode");
...
{
public:
	struct FVector                                OutBoxExtent;                                      // 0x0000(0x000C)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FortScriptedObjectMovement_MovableObjectBase_GetStaticPathTravelingBounds) == 0x000004, "Wrong alignment on FortScriptedObjectMovement_MovableObjectBase_GetStaticPathTravelingBounds");
static_assert(sizeof(FortScriptedObjectMovement_MovableObjectBase_GetStaticPathTravelingBounds) == 0x00000C, "Wrong size on FortScriptedObjectMovement_MovableObjectBase_GetStaticPathTravelingBounds");
