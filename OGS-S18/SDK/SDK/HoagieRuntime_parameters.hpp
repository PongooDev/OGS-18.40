...
{
public:
	struct FHitResult                             RotorHit;                                          // 0x0000(0x0088)(ConstParm, Parm, ReferenceParm, IsPlainOldData, NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FortHoagieVehicle_MulticastRotorImpulse) == 0x000088, "Wrong size on FortHoagieVehicle_MulticastRotorImpulse");
...
public:
	...
	bool                                          bInner;                                            // 0x0088(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FortHoagieVehicle_OnRotorDamageDealt) == 0x00008C, "Wrong size on FortHoagieVehicle_OnRotorDamageDealt");
...
static_assert(offsetof(FortHoagieVehicle_OnRotorDamageDealt, bInner) == 0x000088, "Member 'FortHoagieVehicle_OnRotorDamageDealt::bInner' has a wrong offset!");
...
static_assert(sizeof(FortHoagieVehicle_OnRotorDamageDealtInner) == 0x000088, "Wrong size on FortHoagieVehicle_OnRotorDamageDealtInner");
...
static_assert(sizeof(FortHoagieVehicle_OnRotorDamageDealtOuter) == 0x000088, "Wrong size on FortHoagieVehicle_OnRotorDamageDealtOuter");
...
static_assert(sizeof(FortHoagieVehicle_OnRotorDamagePlayer) == 0x000088, "Wrong size on FortHoagieVehicle_OnRotorDamagePlayer");
...
// Function HoagieRuntime.FortHoagieVehicle.GetKillerController
// 0x0008 (0x0008 - 0x0000)
struct FortHoagieVehicle_GetKillerController final
{
public:
...
static_assert(alignof(FortHoagieVehicle_GetKillerController) == 0x000008, "Wrong alignment on FortHoagieVehicle_GetKillerController");
static_assert(sizeof(FortHoagieVehicle_GetKillerController) == 0x000008, "Wrong size on FortHoagieVehicle_GetKillerController");
static_assert(offsetof(FortHoagieVehicle_GetKillerController, ReturnValue) == 0x000000, "Member 'FortHoagieVehicle_GetKillerController::ReturnValue' has a wrong offset!");
