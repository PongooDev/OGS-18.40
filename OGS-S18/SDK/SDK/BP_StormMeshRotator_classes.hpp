...
public:
	...
	bool                                          isMobileStormEnabled;                              // 0x0265(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	bool                                          areStormEffectsEnabled;                            // 0x0266(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
...
static_assert(offsetof(ABP_StormMeshRotator_C, isMobileStormEnabled) == 0x000265, "Member 'ABP_StormMeshRotator_C::isMobileStormEnabled' has a wrong offset!");
static_assert(offsetof(ABP_StormMeshRotator_C, areStormEffectsEnabled) == 0x000266, "Member 'ABP_StormMeshRotator_C::areStormEffectsEnabled' has a wrong offset!");
