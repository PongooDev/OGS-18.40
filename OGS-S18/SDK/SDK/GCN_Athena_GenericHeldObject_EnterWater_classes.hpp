...
static_assert(sizeof(UGCN_Athena_GenericHeldObject_EnterWater_C) == 0x0001C8, "Wrong size on UGCN_Athena_GenericHeldObject_EnterWater_C");
static_assert(offsetof(UGCN_Athena_GenericHeldObject_EnterWater_C, Sound_To_Play) == 0x0001C0, "Member 'UGCN_Athena_GenericHeldObject_EnterWater_C::Sound_To_Play' has a wrong offset!");
