...
static_assert(alignof(FGoopAudioMapRangeClamped) == 0x000004, "Wrong alignment on FGoopAudioMapRangeClamped");
static_assert(sizeof(FGoopAudioMapRangeClamped) == 0x000010, "Wrong size on FGoopAudioMapRangeClamped");
...
static_assert(offsetof(FGoopAudioMapRangeClamped, OutRange) == 0x000008, "Member 'FGoopAudioMapRangeClamped::OutRange' has a wrong offset!");
