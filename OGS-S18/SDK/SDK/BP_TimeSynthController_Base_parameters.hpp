...
public:
	...
	TDelegate<void(ETimeSynthEventQuantization QuantizationType, int32 NumBars, float Beat)> K2Node_CreateDelegate_OutputDelegate;              // 0x0004(0x0010)(ZeroConstructor, NoDestructor)
	TDelegate<void(ETimeSynthEventQuantization QuantizationType, int32 NumBars, float Beat)> K2Node_CreateDelegate_OutputDelegate_1;            // 0x0014(0x0010)(ZeroConstructor, NoDestructor)
	int32                                         K2Node_CustomEvent_Index;                          // 0x0024(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         K2Node_CustomEvent_Volume_Multiplier;              // 0x0028(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_MapRangeClamped_ReturnValue;              // 0x002C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UTimeSynthVolumeGroup*                  CallFunc_Array_Get_Item;                           // 0x0030(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(BP_TimeSynthController_Base_C_ExecuteUbergraph_BP_TimeSynthController_Base) == 0x000038, "Wrong size on BP_TimeSynthController_Base_C_ExecuteUbergraph_BP_TimeSynthController_Base");
...
static_assert(offsetof(BP_TimeSynthController_Base_C_ExecuteUbergraph_BP_TimeSynthController_Base, K2Node_CreateDelegate_OutputDelegate_1) == 0x000014, "Member 'BP_TimeSynthController_Base_C_ExecuteUbergraph_BP_TimeSynthController_Base::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(BP_TimeSynthController_Base_C_ExecuteUbergraph_BP_TimeSynthController_Base, K2Node_CustomEvent_Index) == 0x000024, "Member 'BP_TimeSynthController_Base_C_ExecuteUbergraph_BP_TimeSynthController_Base::K2Node_CustomEvent_Index' has a wrong offset!");
static_assert(offsetof(BP_TimeSynthController_Base_C_ExecuteUbergraph_BP_TimeSynthController_Base, K2Node_CustomEvent_Volume_Multiplier) == 0x000028, "Member 'BP_TimeSynthController_Base_C_ExecuteUbergraph_BP_TimeSynthController_Base::K2Node_CustomEvent_Volume_Multiplier' has a wrong offset!");
static_assert(offsetof(BP_TimeSynthController_Base_C_ExecuteUbergraph_BP_TimeSynthController_Base, CallFunc_MapRangeClamped_ReturnValue) == 0x00002C, "Member 'BP_TimeSynthController_Base_C_ExecuteUbergraph_BP_TimeSynthController_Base::CallFunc_MapRangeClamped_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_TimeSynthController_Base_C_ExecuteUbergraph_BP_TimeSynthController_Base, CallFunc_Array_Get_Item) == 0x000030, "Member 'BP_TimeSynthController_Base_C_ExecuteUbergraph_BP_TimeSynthController_Base::CallFunc_Array_Get_Item' has a wrong offset!");
