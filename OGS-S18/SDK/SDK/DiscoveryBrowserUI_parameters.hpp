...
// Function DiscoveryBrowserUI.FortActivityBrowserView.OnMoviePlayingChanged
// 0x0001 (0x0001 - 0x0000)
struct FortActivityBrowserView_OnMoviePlayingChanged final
{
public:
...
static_assert(alignof(FortActivityBrowserView_OnMoviePlayingChanged) == 0x000001, "Wrong alignment on FortActivityBrowserView_OnMoviePlayingChanged");
static_assert(sizeof(FortActivityBrowserView_OnMoviePlayingChanged) == 0x000001, "Wrong size on FortActivityBrowserView_OnMoviePlayingChanged");
static_assert(offsetof(FortActivityBrowserView_OnMoviePlayingChanged, bIsPlaying) == 0x000000, "Member 'FortActivityBrowserView_OnMoviePlayingChanged::bIsPlaying' has a wrong offset!");
...
static_assert(alignof(FortActivityBrowserView_OnPreviewImageChanged) == 0x000008, "Wrong alignment on FortActivityBrowserView_OnPreviewImageChanged");
static_assert(sizeof(FortActivityBrowserView_OnPreviewImageChanged) == 0x000010, "Wrong size on FortActivityBrowserView_OnPreviewImageChanged");
static_assert(offsetof(FortActivityBrowserView_OnPreviewImageChanged, bIsLoading) == 0x000000, "Member 'FortActivityBrowserView_OnPreviewImageChanged::bIsLoading' has a wrong offset!");
static_assert(offsetof(FortActivityBrowserView_OnPreviewImageChanged, Texture) == 0x000008, "Member 'FortActivityBrowserView_OnPreviewImageChanged::Texture' has a wrong offset!");
...
// Function DiscoveryBrowserUI.FortActivityBrowserView.IsShowingPromotedContent
// 0x0001 (0x0001 - 0x0000)
struct FortActivityBrowserView_IsShowingPromotedContent final
{
public:
	bool                                          ReturnValue;                                       // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FortActivityBrowserView_IsShowingPromotedContent) == 0x000001, "Wrong alignment on FortActivityBrowserView_IsShowingPromotedContent");
static_assert(sizeof(FortActivityBrowserView_IsShowingPromotedContent) == 0x000001, "Wrong size on FortActivityBrowserView_IsShowingPromotedContent");
static_assert(offsetof(FortActivityBrowserView_IsShowingPromotedContent, ReturnValue) == 0x000000, "Member 'FortActivityBrowserView_IsShowingPromotedContent::ReturnValue' has a wrong offset!");
