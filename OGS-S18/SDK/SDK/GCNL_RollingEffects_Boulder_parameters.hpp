...
static_assert(sizeof(GCNL_RollingEffects_Boulder_C_ExecuteUbergraph_GCNL_RollingEffects_Boulder) == 0x0001C0, "Wrong size on GCNL_RollingEffects_Boulder_C_ExecuteUbergraph_GCNL_RollingEffects_Boulder");
...
static_assert(offsetof(GCNL_RollingEffects_Boulder_C_ExecuteUbergraph_GCNL_RollingEffects_Boulder, CallFunc_GetMovingStateData_OutLinearSpeed) == 0x0001B8, "Member 'GCNL_RollingEffects_Boulder_C_ExecuteUbergraph_GCNL_RollingEffects_Boulder::CallFunc_GetMovingStateData_OutLinearSpeed' has a wrong offset!");
static_assert(offsetof(GCNL_RollingEffects_Boulder_C_ExecuteUbergraph_GCNL_RollingEffects_Boulder, CallFunc_GetMovingStateData_OutMovementState) == 0x0001BC, "Member 'GCNL_RollingEffects_Boulder_C_ExecuteUbergraph_GCNL_RollingEffects_Boulder::CallFunc_GetMovingStateData_OutMovementState' has a wrong offset!");
static_assert(offsetof(GCNL_RollingEffects_Boulder_C_ExecuteUbergraph_GCNL_RollingEffects_Boulder, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x0001BD, "Member 'GCNL_RollingEffects_Boulder_C_ExecuteUbergraph_GCNL_RollingEffects_Boulder::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
