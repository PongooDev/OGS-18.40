...
public:
	...
	class UBorder*                                Background;                                        // 0x0C30(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(USettingsRotator_C) == 0x000C38, "Wrong size on USettingsRotator_C");
static_assert(offsetof(USettingsRotator_C, UberGraphFrame) == 0x000C28, "Member 'USettingsRotator_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(USettingsRotator_C, Background) == 0x000C30, "Member 'USettingsRotator_C::Background' has a wrong offset!");
