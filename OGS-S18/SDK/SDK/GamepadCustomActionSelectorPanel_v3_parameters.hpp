...
public:
	...
	class UFortInputData*                         CallFunc_GetFortInputDataForBlueprint_ReturnValue; // 0x0068(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsValid_ReturnValue;                      // 0x0070(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_71[0x7];                                       // 0x0071(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   CallFunc_GetScreenLabel_ReturnValue;               // 0x0078(0x0018)()
	class UGamepadKeyTextButton_C*                CallFunc_Create_ReturnValue;                       // 0x0090(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(GamepadCustomActionSelectorPanel_v3_C_CreateCustomListItem, CallFunc_GetCustomGamepadInputPresetName_ReturnValue) == 0x000048, "Member 'GamepadCustomActionSelectorPanel_v3_C_CreateCustomListItem::CallFunc_GetCustomGamepadInputPresetName_ReturnValue' has a wrong offset!");
static_assert(offsetof(GamepadCustomActionSelectorPanel_v3_C_CreateCustomListItem, CallFunc_Conv_StringToName_ReturnValue) == 0x000058, "Member 'GamepadCustomActionSelectorPanel_v3_C_CreateCustomListItem::CallFunc_Conv_StringToName_ReturnValue' has a wrong offset!");
static_assert(offsetof(GamepadCustomActionSelectorPanel_v3_C_CreateCustomListItem, CallFunc_GetContext_ReturnValue_1) == 0x000060, "Member 'GamepadCustomActionSelectorPanel_v3_C_CreateCustomListItem::CallFunc_GetContext_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(GamepadCustomActionSelectorPanel_v3_C_CreateCustomListItem, CallFunc_GetFortInputDataForBlueprint_ReturnValue) == 0x000068, "Member 'GamepadCustomActionSelectorPanel_v3_C_CreateCustomListItem::CallFunc_GetFortInputDataForBlueprint_ReturnValue' has a wrong offset!");
static_assert(offsetof(GamepadCustomActionSelectorPanel_v3_C_CreateCustomListItem, CallFunc_IsValid_ReturnValue) == 0x000070, "Member 'GamepadCustomActionSelectorPanel_v3_C_CreateCustomListItem::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(GamepadCustomActionSelectorPanel_v3_C_CreateCustomListItem, CallFunc_GetScreenLabel_ReturnValue) == 0x000078, "Member 'GamepadCustomActionSelectorPanel_v3_C_CreateCustomListItem::CallFunc_GetScreenLabel_ReturnValue' has a wrong offset!");
static_assert(offsetof(GamepadCustomActionSelectorPanel_v3_C_CreateCustomListItem, CallFunc_Create_ReturnValue) == 0x000090, "Member 'GamepadCustomActionSelectorPanel_v3_C_CreateCustomListItem::CallFunc_Create_ReturnValue' has a wrong offset!");
