...
public:
	...
	TArray<class AVaultWorld_C*>                  CallFunc_GetAllActorsOfClass_OutActors;            // 0x0018(0x0010)(ReferenceParm)
...
static_assert(alignof(FrontendCamera_VaultRotator_C_OnActivated) == 0x000008, "Wrong alignment on FrontendCamera_VaultRotator_C_OnActivated");
static_assert(sizeof(FrontendCamera_VaultRotator_C_OnActivated) == 0x000008, "Wrong size on FrontendCamera_VaultRotator_C_OnActivated");
static_assert(offsetof(FrontendCamera_VaultRotator_C_OnActivated, PlayerController) == 0x000000, "Member 'FrontendCamera_VaultRotator_C_OnActivated::PlayerController' has a wrong offset!");
...
static_assert(alignof(FrontendCamera_VaultRotator_C_OnDeactivated) == 0x000008, "Wrong alignment on FrontendCamera_VaultRotator_C_OnDeactivated");
static_assert(sizeof(FrontendCamera_VaultRotator_C_OnDeactivated) == 0x000008, "Wrong size on FrontendCamera_VaultRotator_C_OnDeactivated");
static_assert(offsetof(FrontendCamera_VaultRotator_C_OnDeactivated, PlayerController) == 0x000000, "Member 'FrontendCamera_VaultRotator_C_OnDeactivated::PlayerController' has a wrong offset!");
