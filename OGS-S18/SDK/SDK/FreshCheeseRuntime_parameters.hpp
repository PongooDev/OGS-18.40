...
static_assert(sizeof(FriendChestNative_OnTriggerComponentBeginOverlap) == 0x0000A8, "Wrong size on FriendChestNative_OnTriggerComponentBeginOverlap");
...
{
public:
	struct FXPEventInfo                           XPEvent;                                           // 0x0000(0x0070)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
};
static_assert(alignof(FriendChestNative_OnXpEvent) == 0x000008, "Wrong alignment on FriendChestNative_OnXpEvent");
static_assert(sizeof(FriendChestNative_OnXpEvent) == 0x000070, "Wrong size on FriendChestNative_OnXpEvent");
