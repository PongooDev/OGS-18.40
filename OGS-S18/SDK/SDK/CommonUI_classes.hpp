...
public:
	...
	struct FUserWidgetPool                        GeneratedWidgetsPool;                              // 0x0128(0x0088)(Transient, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UCommonActivatableWidgetContainerBase) == 0x000210, "Wrong size on UCommonActivatableWidgetContainerBase");
...
{
public:
	TSubclassOf<class UCommonActivatableWidget>   RootContentWidgetClass;                            // 0x0210(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UCommonActivatableWidget*               RootContentWidget;                                 // 0x0218(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UCommonActivatableWidgetStack) == 0x000220, "Wrong size on UCommonActivatableWidgetStack");
static_assert(offsetof(UCommonActivatableWidgetStack, RootContentWidgetClass) == 0x000210, "Member 'UCommonActivatableWidgetStack::RootContentWidgetClass' has a wrong offset!");
static_assert(offsetof(UCommonActivatableWidgetStack, RootContentWidget) == 0x000218, "Member 'UCommonActivatableWidgetStack::RootContentWidget' has a wrong offset!");
...
{
public:
	bool                                          bDisplayInActionBar;                               // 0x0260(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bConsumePointerInput;                              // 0x0261(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_262[0x26];                                     // 0x0262(0x0026)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UCommonUserWidget, bDisplayInActionBar) == 0x000260, "Member 'UCommonUserWidget::bDisplayInActionBar' has a wrong offset!");
static_assert(offsetof(UCommonUserWidget, bConsumePointerInput) == 0x000261, "Member 'UCommonUserWidget::bConsumePointerInput' has a wrong offset!");
...
static_assert(sizeof(UCommonTileView) == 0x000860, "Wrong size on UCommonTileView");

// Class CommonUI.CommonButtonBase
// 0x0948 (0x0BD0 - 0x0288)
...
public:
	...
	uint8                                         Pad_AF9[0xCF];                                     // 0x0AF9(0x00CF)(Fixing Size After Last Property [ Dumper-7 ])
	class UCommonActionWidget*                    InputActionWidget;                                 // 0x0BC8(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UCommonButtonBase) == 0x000BD0, "Wrong size on UCommonButtonBase");
...
static_assert(offsetof(UCommonButtonBase, InputActionWidget) == 0x000BC8, "Member 'UCommonButtonBase::InputActionWidget' has a wrong offset!");
...
public:
	...
	TArray<TWeakObjectPtr<class UCommonActivatableWidget>> VisibilityBoundWidgets;                            // 0x02C0(0x0010)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UCommonActivatableWidget) == 0x000348, "Wrong size on UCommonActivatableWidget");
...
static_assert(offsetof(UCommonActivatableWidget, VisibilityBoundWidgets) == 0x0002C0, "Member 'UCommonActivatableWidget::VisibilityBoundWidgets' has a wrong offset!");
...
static_assert(sizeof(UCommonActivatableWidgetQueue) == 0x000210, "Wrong size on UCommonActivatableWidgetQueue");
...
{
public:
	TSubclassOf<class UCommonBoundActionButton>   ActionButtonClass;                                 // 0x01E0(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bDisplayOwningPlayerActionsOnly;                   // 0x01E8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bIgnoreDuplicateActions;                           // 0x01E9(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UCommonBoundActionBar) == 0x0001F0, "Wrong size on UCommonBoundActionBar");
static_assert(offsetof(UCommonBoundActionBar, ActionButtonClass) == 0x0001E0, "Member 'UCommonBoundActionBar::ActionButtonClass' has a wrong offset!");
static_assert(offsetof(UCommonBoundActionBar, bDisplayOwningPlayerActionsOnly) == 0x0001E8, "Member 'UCommonBoundActionBar::bDisplayOwningPlayerActionsOnly' has a wrong offset!");
static_assert(offsetof(UCommonBoundActionBar, bIgnoreDuplicateActions) == 0x0001E9, "Member 'UCommonBoundActionBar::bIgnoreDuplicateActions' has a wrong offset!");
...
// 0x0000 (0x0028 - 0x0028)
class UDataDrivenInputActionProcessor final : public UCommonInputActionDataProcessor
{
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"DataDrivenInputActionProcessor">();
	}
	static class UDataDrivenInputActionProcessor* GetDefaultObj()
	{
		return GetDefaultObjImpl<UDataDrivenInputActionProcessor>();
	}
};
static_assert(alignof(UDataDrivenInputActionProcessor) == 0x000008, "Wrong alignment on UDataDrivenInputActionProcessor");
static_assert(sizeof(UDataDrivenInputActionProcessor) == 0x000028, "Wrong size on UDataDrivenInputActionProcessor");
...
{
public:
	class UCommonTextBlock*                       Text_ActionName;                                   // 0x0BD0(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UCommonBoundActionButton) == 0x000BE0, "Wrong size on UCommonBoundActionButton");
static_assert(offsetof(UCommonBoundActionButton, Text_ActionName) == 0x000BD0, "Member 'UCommonBoundActionButton::Text_ActionName' has a wrong offset!");
...
static_assert(sizeof(UCommonListView) == 0x000840, "Wrong size on UCommonListView");
...
public:
	...
	TMulticastInlineDelegate<void(int32 Value)>   OnRotated;                                         // 0x0BE0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_BF0[0x18];                                     // 0x0BF0(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	class UCommonTextBlock*                       MyText;                                            // 0x0C08(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UCommonRotator) == 0x000C28, "Wrong size on UCommonRotator");
static_assert(offsetof(UCommonRotator, OnRotated) == 0x000BE0, "Member 'UCommonRotator::OnRotated' has a wrong offset!");
static_assert(offsetof(UCommonRotator, MyText) == 0x000C08, "Member 'UCommonRotator::MyText' has a wrong offset!");
...
static_assert(sizeof(UCommonTreeView) == 0x000898, "Wrong size on UCommonTreeView");
...
static_assert(alignof(UUCommonVisibilityWidgetBase) == 0x000008, "Wrong alignment on UUCommonVisibilityWidgetBase");
static_assert(sizeof(UUCommonVisibilityWidgetBase) == 0x0002E8, "Wrong size on UUCommonVisibilityWidgetBase");
static_assert(offsetof(UUCommonVisibilityWidgetBase, VisibilityControls) == 0x000290, "Member 'UUCommonVisibilityWidgetBase::VisibilityControls' has a wrong offset!");
static_assert(offsetof(UUCommonVisibilityWidgetBase, bShowForGamepad) == 0x0002E0, "Member 'UUCommonVisibilityWidgetBase::bShowForGamepad' has a wrong offset!");
static_assert(offsetof(UUCommonVisibilityWidgetBase, bShowForMouseAndKeyboard) == 0x0002E1, "Member 'UUCommonVisibilityWidgetBase::bShowForMouseAndKeyboard' has a wrong offset!");
static_assert(offsetof(UUCommonVisibilityWidgetBase, bShowForTouch) == 0x0002E2, "Member 'UUCommonVisibilityWidgetBase::bShowForTouch' has a wrong offset!");
static_assert(offsetof(UUCommonVisibilityWidgetBase, VisibleType) == 0x0002E3, "Member 'UUCommonVisibilityWidgetBase::VisibleType' has a wrong offset!");
static_assert(offsetof(UUCommonVisibilityWidgetBase, HiddenType) == 0x0002E4, "Member 'UUCommonVisibilityWidgetBase::HiddenType' has a wrong offset!");
