...
static_assert(sizeof(FCubeMovement_CorruptionGenerationSplinePointData) == 0x000040, "Wrong size on FCubeMovement_CorruptionGenerationSplinePointData");
...
static_assert(offsetof(FCubeMovement_CorruptionGenerationSplinePointData, SplinePercentComplete) == 0x000030, "Member 'FCubeMovement_CorruptionGenerationSplinePointData::SplinePercentComplete' has a wrong offset!");
