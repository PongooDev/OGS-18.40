...
static_assert(sizeof(USoundCueTemplate) == 0x000550, "Wrong size on USoundCueTemplate");
...
static_assert(sizeof(USoundCueContainer) == 0x000550, "Wrong size on USoundCueContainer");
...
static_assert(sizeof(USoundCueDistanceCrossfade) == 0x000550, "Wrong size on USoundCueDistanceCrossfade");
