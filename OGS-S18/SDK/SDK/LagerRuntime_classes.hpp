...
public:
	...
	struct FFortAthenaLivingWorldPlayerTracker    PlayerTracker;                                     // 0x02A0(0x00B0)(Transient, NativeAccessSpecifierPrivate)
	uint8                                         Pad_350[0x1E8];                                    // 0x0350(0x01E8)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class AActor*>                         RuntimePointProviderList;                          // 0x0538(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPrivate)
	TSet<class AActor*>                           RuntimePointProviderOwners;                        // 0x0548(0x0050)(Transient, NativeAccessSpecifierPrivate)
	uint8                                         Pad_598[0x1A0];                                    // 0x0598(0x01A0)(Fixing Size After Last Property [ Dumper-7 ])
	class AActor*                                 EQSHelper;                                         // 0x0738(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFortAthenaLivingWorldManager) == 0x000740, "Wrong size on UFortAthenaLivingWorldManager");
...
static_assert(offsetof(UFortAthenaLivingWorldManager, RunningEncounterInstances) == 0x000278, "Member 'UFortAthenaLivingWorldManager::RunningEncounterInstances' has a wrong offset!");
static_assert(offsetof(UFortAthenaLivingWorldManager, CachedSeasonalEventManager) == 0x000288, "Member 'UFortAthenaLivingWorldManager::CachedSeasonalEventManager' has a wrong offset!");
static_assert(offsetof(UFortAthenaLivingWorldManager, ActorClassToPreloadOnClient) == 0x000290, "Member 'UFortAthenaLivingWorldManager::ActorClassToPreloadOnClient' has a wrong offset!");
static_assert(offsetof(UFortAthenaLivingWorldManager, PlayerTracker) == 0x0002A0, "Member 'UFortAthenaLivingWorldManager::PlayerTracker' has a wrong offset!");
static_assert(offsetof(UFortAthenaLivingWorldManager, RuntimePointProviderList) == 0x000538, "Member 'UFortAthenaLivingWorldManager::RuntimePointProviderList' has a wrong offset!");
static_assert(offsetof(UFortAthenaLivingWorldManager, RuntimePointProviderOwners) == 0x000548, "Member 'UFortAthenaLivingWorldManager::RuntimePointProviderOwners' has a wrong offset!");
static_assert(offsetof(UFortAthenaLivingWorldManager, EQSHelper) == 0x000738, "Member 'UFortAthenaLivingWorldManager::EQSHelper' has a wrong offset!");
...
public:
	...
	class UFortAthenaLivingWorldManager*          CachedLivingWorldManager;                          // 0x03C0(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_3C8[0x118];                                    // 0x03C8(0x0118)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AFortAthenaLivingWorldVolume) == 0x0004E0, "Wrong size on AFortAthenaLivingWorldVolume");
...
static_assert(offsetof(AFortAthenaLivingWorldVolume, DeactivationTagsQuery) == 0x000288, "Member 'AFortAthenaLivingWorldVolume::DeactivationTagsQuery' has a wrong offset!");
static_assert(offsetof(AFortAthenaLivingWorldVolume, DeactivationTagsRange) == 0x0002D0, "Member 'AFortAthenaLivingWorldVolume::DeactivationTagsRange' has a wrong offset!");
...
static_assert(offsetof(AFortAthenaLivingWorldVolume, CachedLivingWorldManager) == 0x0003C0, "Member 'AFortAthenaLivingWorldVolume::CachedLivingWorldManager' has a wrong offset!");
