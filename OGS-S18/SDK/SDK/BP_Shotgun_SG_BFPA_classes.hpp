...
static_assert(offsetof(UBP_Shotgun_SG_BFPA_C, AnimGraphNode_Root) == 0x0002C8, "Member 'UBP_Shotgun_SG_BFPA_C::AnimGraphNode_Root' has a wrong offset!");
static_assert(offsetof(UBP_Shotgun_SG_BFPA_C, AnimGraphNode_Slot) == 0x0002F8, "Member 'UBP_Shotgun_SG_BFPA_C::AnimGraphNode_Slot' has a wrong offset!");
static_assert(offsetof(UBP_Shotgun_SG_BFPA_C, AnimGraphNode_LocalRefPose) == 0x000340, "Member 'UBP_Shotgun_SG_BFPA_C::AnimGraphNode_LocalRefPose' has a wrong offset!");
