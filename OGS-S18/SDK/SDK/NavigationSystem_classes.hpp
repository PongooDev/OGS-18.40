...
public:
	...
	TMulticastInlineDelegate<void(class ANavigationData* NavData)> OnNavDataRegisteredEvent;                          // 0x00C8(0x0010)(ZeroConstructor, Transient, InstancedReference, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class ANavigationData* NavData)> OnNavigationGenerationFinishedDelegate;            // 0x00D8(0x0010)(ZeroConstructor, Transient, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_E8[0xDC];                                      // 0x00E8(0x00DC)(Fixing Size After Last Property [ Dumper-7 ])
	EFNavigationSystemRunMode                     OperationMode;                                     // 0x01C4(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_1C5[0x13FF];                                   // 0x01C5(0x13FF)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         DirtyAreasUpdateFreq;                              // 0x15C4(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_15C8[0x20];                                    // 0x15C8(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UNavigationSystemV1) == 0x0015E8, "Wrong size on UNavigationSystemV1");
...
static_assert(offsetof(UNavigationSystemV1, OnNavDataRegisteredEvent) == 0x0000C8, "Member 'UNavigationSystemV1::OnNavDataRegisteredEvent' has a wrong offset!");
static_assert(offsetof(UNavigationSystemV1, OnNavigationGenerationFinishedDelegate) == 0x0000D8, "Member 'UNavigationSystemV1::OnNavigationGenerationFinishedDelegate' has a wrong offset!");
static_assert(offsetof(UNavigationSystemV1, OperationMode) == 0x0001C4, "Member 'UNavigationSystemV1::OperationMode' has a wrong offset!");
static_assert(offsetof(UNavigationSystemV1, DirtyAreasUpdateFreq) == 0x0015C4, "Member 'UNavigationSystemV1::DirtyAreasUpdateFreq' has a wrong offset!");
...
public:
	...
	TArray<struct FNavigationLink>                Links;                                             // 0x0450(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UNavLinkComponent, Links) == 0x000450, "Member 'UNavLinkComponent::Links' has a wrong offset!");
