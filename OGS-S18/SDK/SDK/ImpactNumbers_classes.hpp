...
static_assert(sizeof(AImpactNumbers_C) == 0x000470, "Wrong size on AImpactNumbers_C");
static_assert(offsetof(AImpactNumbers_C, UberGraphFrame) == 0x000460, "Member 'AImpactNumbers_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AImpactNumbers_C, DefaultSceneRoot) == 0x000468, "Member 'AImpactNumbers_C::DefaultSceneRoot' has a wrong offset!");
