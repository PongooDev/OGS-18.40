...
public:
	...
	bool                                          K2Node_Event_bShowFloor;                           // 0x0089(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_Event_bShowEffects;                         // 0x008A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_Event_bShowItemDetails;                     // 0x008B(0x0001)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(sizeof(VaultWorld_C_ExecuteUbergraph_VaultWorld) == 0x000090, "Wrong size on VaultWorld_C_ExecuteUbergraph_VaultWorld");
...
static_assert(offsetof(VaultWorld_C_ExecuteUbergraph_VaultWorld, K2Node_Event_LoadedBackgroundTexture) == 0x000020, "Member 'VaultWorld_C_ExecuteUbergraph_VaultWorld::K2Node_Event_LoadedBackgroundTexture' has a wrong offset!");
static_assert(offsetof(VaultWorld_C_ExecuteUbergraph_VaultWorld, K2Node_Event_BackgroundInfo) == 0x000028, "Member 'VaultWorld_C_ExecuteUbergraph_VaultWorld::K2Node_Event_BackgroundInfo' has a wrong offset!");
static_assert(offsetof(VaultWorld_C_ExecuteUbergraph_VaultWorld, K2Node_Event_bPlayForward) == 0x000088, "Member 'VaultWorld_C_ExecuteUbergraph_VaultWorld::K2Node_Event_bPlayForward' has a wrong offset!");
static_assert(offsetof(VaultWorld_C_ExecuteUbergraph_VaultWorld, K2Node_Event_bShowFloor) == 0x000089, "Member 'VaultWorld_C_ExecuteUbergraph_VaultWorld::K2Node_Event_bShowFloor' has a wrong offset!");
static_assert(offsetof(VaultWorld_C_ExecuteUbergraph_VaultWorld, K2Node_Event_bShowEffects) == 0x00008A, "Member 'VaultWorld_C_ExecuteUbergraph_VaultWorld::K2Node_Event_bShowEffects' has a wrong offset!");
static_assert(offsetof(VaultWorld_C_ExecuteUbergraph_VaultWorld, K2Node_Event_bShowItemDetails) == 0x00008B, "Member 'VaultWorld_C_ExecuteUbergraph_VaultWorld::K2Node_Event_bShowItemDetails' has a wrong offset!");
