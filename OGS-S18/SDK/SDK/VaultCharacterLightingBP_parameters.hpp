...
public:
	...
	bool                                          CallFunc_IsErebus_ReturnValue_1;                   // 0x0038(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_BooleanOR_ReturnValue_3;                  // 0x0039(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsErebus_ReturnValue_2;                   // 0x003A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(offsetof(VaultCharacterLightingBP_C_ExecuteUbergraph_VaultCharacterLightingBP, CallFunc_IsErebus_ReturnValue_1) == 0x000038, "Member 'VaultCharacterLightingBP_C_ExecuteUbergraph_VaultCharacterLightingBP::CallFunc_IsErebus_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(VaultCharacterLightingBP_C_ExecuteUbergraph_VaultCharacterLightingBP, CallFunc_BooleanOR_ReturnValue_3) == 0x000039, "Member 'VaultCharacterLightingBP_C_ExecuteUbergraph_VaultCharacterLightingBP::CallFunc_BooleanOR_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(VaultCharacterLightingBP_C_ExecuteUbergraph_VaultCharacterLightingBP, CallFunc_IsErebus_ReturnValue_2) == 0x00003A, "Member 'VaultCharacterLightingBP_C_ExecuteUbergraph_VaultCharacterLightingBP::CallFunc_IsErebus_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(VaultCharacterLightingBP_C_ExecuteUbergraph_VaultCharacterLightingBP, CallFunc_BooleanOR_ReturnValue_4) == 0x00003B, "Member 'VaultCharacterLightingBP_C_ExecuteUbergraph_VaultCharacterLightingBP::CallFunc_BooleanOR_ReturnValue_4' has a wrong offset!");
