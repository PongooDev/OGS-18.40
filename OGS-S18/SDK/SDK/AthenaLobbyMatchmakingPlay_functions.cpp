...
void UAthenaLobbyMatchmakingPlay_C::Pick_Matchmaking_Succeeded_Sound(class USoundBase** SelectedMatchmakingSucceededSound)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AthenaLobbyMatchmakingPlay_C", "Pick Matchmaking Succeeded Sound");

	Params::AthenaLobbyMatchmakingPlay_C_Pick_Matchmaking_Succeeded_Sound Parms{};
