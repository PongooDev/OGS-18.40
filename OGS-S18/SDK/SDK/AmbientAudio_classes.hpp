...
static_assert(sizeof(UAmbientAudioComponent) == 0x0000D0, "Wrong size on UAmbientAudioComponent");
static_assert(offsetof(UAmbientAudioComponent, AmbientAsset) == 0x0000C0, "Member 'UAmbientAudioComponent::AmbientAsset' has a wrong offset!");
static_assert(offsetof(UAmbientAudioComponent, Priority) == 0x0000C8, "Member 'UAmbientAudioComponent::Priority' has a wrong offset!");
static_assert(offsetof(UAmbientAudioComponent, CrossfadeTime) == 0x0000CC, "Member 'UAmbientAudioComponent::CrossfadeTime' has a wrong offset!");
...
static_assert(offsetof(UAmbientAudioSubsystem, GlobalVolumes) == 0x000058, "Member 'UAmbientAudioSubsystem::GlobalVolumes' has a wrong offset!");
