...
static_assert(sizeof(URadioContentSourceItemDefinition) == 0x0003E0, "Wrong size on URadioContentSourceItemDefinition");
static_assert(offsetof(URadioContentSourceItemDefinition, ResourceID) == 0x0003C8, "Member 'URadioContentSourceItemDefinition::ResourceID' has a wrong offset!");
static_assert(offsetof(URadioContentSourceItemDefinition, MediaSource) == 0x0003D8, "Member 'URadioContentSourceItemDefinition::MediaSource' has a wrong offset!");
...
static_assert(sizeof(UStreamingRadioPlayerComponent) == 0x000448, "Wrong size on UStreamingRadioPlayerComponent");
...
static_assert(offsetof(UStreamingRadioPlayerComponent, DefaultSoundSubmix) == 0x000378, "Member 'UStreamingRadioPlayerComponent::DefaultSoundSubmix' has a wrong offset!");
static_assert(offsetof(UStreamingRadioPlayerComponent, LicensedSoundSubmix) == 0x000380, "Member 'UStreamingRadioPlayerComponent::LicensedSoundSubmix' has a wrong offset!");
static_assert(offsetof(UStreamingRadioPlayerComponent, LastMediaSource) == 0x000388, "Member 'UStreamingRadioPlayerComponent::LastMediaSource' has a wrong offset!");
static_assert(offsetof(UStreamingRadioPlayerComponent, IncomingMediaSource) == 0x000390, "Member 'UStreamingRadioPlayerComponent::IncomingMediaSource' has a wrong offset!");
static_assert(offsetof(UStreamingRadioPlayerComponent, CurrentMode) == 0x000398, "Member 'UStreamingRadioPlayerComponent::CurrentMode' has a wrong offset!");
static_assert(offsetof(UStreamingRadioPlayerComponent, MaximumRetries) == 0x00039C, "Member 'UStreamingRadioPlayerComponent::MaximumRetries' has a wrong offset!");
static_assert(offsetof(UStreamingRadioPlayerComponent, FadeoutWhenUnpoweredInMS) == 0x0003A0, "Member 'UStreamingRadioPlayerComponent::FadeoutWhenUnpoweredInMS' has a wrong offset!");
static_assert(offsetof(UStreamingRadioPlayerComponent, FadeoutWhenOwnerBeingDestroyedInMS) == 0x0003A4, "Member 'UStreamingRadioPlayerComponent::FadeoutWhenOwnerBeingDestroyedInMS' has a wrong offset!");
static_assert(offsetof(UStreamingRadioPlayerComponent, MaxFadeoutTimeMS) == 0x0003A8, "Member 'UStreamingRadioPlayerComponent::MaxFadeoutTimeMS' has a wrong offset!");
static_assert(offsetof(UStreamingRadioPlayerComponent, DefaultPlayingIndex) == 0x0003AC, "Member 'UStreamingRadioPlayerComponent::DefaultPlayingIndex' has a wrong offset!");
static_assert(offsetof(UStreamingRadioPlayerComponent, SoundMixInside) == 0x0003B0, "Member 'UStreamingRadioPlayerComponent::SoundMixInside' has a wrong offset!");
static_assert(offsetof(UStreamingRadioPlayerComponent, SoundMixOutside) == 0x0003B8, "Member 'UStreamingRadioPlayerComponent::SoundMixOutside' has a wrong offset!");
static_assert(offsetof(UStreamingRadioPlayerComponent, ActivationRadius) == 0x0003C4, "Member 'UStreamingRadioPlayerComponent::ActivationRadius' has a wrong offset!");
static_assert(offsetof(UStreamingRadioPlayerComponent, ComponentToAttachTo) == 0x0003C8, "Member 'UStreamingRadioPlayerComponent::ComponentToAttachTo' has a wrong offset!");
static_assert(offsetof(UStreamingRadioPlayerComponent, ComponentSocketAttachTo) == 0x0003D0, "Member 'UStreamingRadioPlayerComponent::ComponentSocketAttachTo' has a wrong offset!");
static_assert(offsetof(UStreamingRadioPlayerComponent, MediaSource) == 0x0003D8, "Member 'UStreamingRadioPlayerComponent::MediaSource' has a wrong offset!");
static_assert(offsetof(UStreamingRadioPlayerComponent, RadioStationList) == 0x0003E0, "Member 'UStreamingRadioPlayerComponent::RadioStationList' has a wrong offset!");
static_assert(offsetof(UStreamingRadioPlayerComponent, DelegateContextObject) == 0x0003F0, "Member 'UStreamingRadioPlayerComponent::DelegateContextObject' has a wrong offset!");
static_assert(offsetof(UStreamingRadioPlayerComponent, MediaStartTimeFromInit) == 0x0003F8, "Member 'UStreamingRadioPlayerComponent::MediaStartTimeFromInit' has a wrong offset!");
