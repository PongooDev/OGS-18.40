...
static_assert(sizeof(UFortGameplayCinematicHostWidget) == 0x000300, "Wrong size on UFortGameplayCinematicHostWidget");
static_assert(offsetof(UFortGameplayCinematicHostWidget, IntroWidgetEntryName) == 0x0002C8, "Member 'UFortGameplayCinematicHostWidget::IntroWidgetEntryName' has a wrong offset!");
static_assert(offsetof(UFortGameplayCinematicHostWidget, WidgetEntries) == 0x0002D0, "Member 'UFortGameplayCinematicHostWidget::WidgetEntries' has a wrong offset!");
static_assert(offsetof(UFortGameplayCinematicHostWidget, LoadingScreenDefinition) == 0x0002E0, "Member 'UFortGameplayCinematicHostWidget::LoadingScreenDefinition' has a wrong offset!");
...
static_assert(sizeof(UFortGameplayCinematicWidget) == 0x000368, "Wrong size on UFortGameplayCinematicWidget");
static_assert(offsetof(UFortGameplayCinematicWidget, bSkipCinematics) == 0x000350, "Member 'UFortGameplayCinematicWidget::bSkipCinematics' has a wrong offset!");
...
static_assert(sizeof(UFortGameplayIntroPanelWidget) == 0x000368, "Wrong size on UFortGameplayIntroPanelWidget");
