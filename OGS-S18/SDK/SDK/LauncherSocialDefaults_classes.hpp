...
{
public:
	struct FChatMarkupStyle                       Style;                                             // 0x0030(0x0698)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USocialChatMarkupStyleDataAsset) == 0x0006C8, "Wrong size on USocialChatMarkupStyleDataAsset");
...
static_assert(sizeof(USocialChatStyleDataAsset) == 0x0013A0, "Wrong size on USocialChatStyleDataAsset");
...
static_assert(sizeof(USocialListStyleDataAsset) == 0x002730, "Wrong size on USocialListStyleDataAsset");
...
public:
	...
	uint8                                         Pad_C0[0x6838];                                    // 0x00C0(0x6838)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USocialStyleDataAsset) == 0x0068F8, "Wrong size on USocialStyleDataAsset");
