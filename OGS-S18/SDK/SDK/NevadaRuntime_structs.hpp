...
{
public:
	uint8                                         Pad_10[0x338];                                     // 0x0010(0x0338)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FNevadaOutPersistent) == 0x000008, "Wrong alignment on FNevadaOutPersistent");
static_assert(sizeof(FNevadaOutPersistent) == 0x000348, "Wrong size on FNevadaOutPersistent");
