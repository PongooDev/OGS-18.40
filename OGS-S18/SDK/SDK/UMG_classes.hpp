...
public:
	...
	bool                                          bEnableRightClickScrolling;                        // 0x0115(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bEnableFixedLineOffset;                            // 0x0116(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	bool                                          bAllowDragging;                                    // 0x011C(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	struct FUserWidgetPool                        EntryWidgetPool;                                   // 0x0140(0x0088)(Transient, ContainsInstancedReference, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UListViewBase) == 0x000220, "Wrong size on UListViewBase");
...
static_assert(offsetof(UListViewBase, bEnableRightClickScrolling) == 0x000115, "Member 'UListViewBase::bEnableRightClickScrolling' has a wrong offset!");
static_assert(offsetof(UListViewBase, bEnableFixedLineOffset) == 0x000116, "Member 'UListViewBase::bEnableFixedLineOffset' has a wrong offset!");
...
static_assert(offsetof(UListViewBase, bAllowDragging) == 0x00011C, "Member 'UListViewBase::bAllowDragging' has a wrong offset!");
...
// Class UMG.ListView
// 0x0620 (0x0840 - 0x0220)
class UListView : public UListViewBase
{
public:
	uint8                                         Pad_220[0xC0];                                     // 0x0220(0x00C0)(Fixing Size After Last Property [ Dumper-7 ])
	struct FScrollBarStyle                        ScrollBarStyle;                                    // 0x02E0(0x04D0)(Edit, BlueprintVisible, BlueprintReadOnly, Protected, NativeAccessSpecifierProtected)
	EOrientation                                  Orientation;                                       // 0x07B0(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	ESelectionMode                                SelectionMode;                                     // 0x07B1(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EConsumeMouseWheel                            ConsumeMouseWheel;                                 // 0x07B2(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bClearSelectionOnClick;                            // 0x07B3(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bIsFocusable;                                      // 0x07B4(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_7B5[0x3];                                      // 0x07B5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         EntrySpacing;                                      // 0x07B8(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bReturnFocusToSelection;                           // 0x07BC(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_7BD[0x3];                                      // 0x07BD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UObject*>                        ListItems;                                         // 0x07C0(0x0010)(ZeroConstructor, Transient, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_7D0[0x10];                                     // 0x07D0(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	TMulticastInlineDelegate<void(class UObject* Item, class UUserWidget* Widget)> BP_OnEntryInitialized;                             // 0x07E0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
	TMulticastInlineDelegate<void(class UObject* Item)> BP_OnItemClicked;                                  // 0x07F0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
	TMulticastInlineDelegate<void(class UObject* Item)> BP_OnItemDoubleClicked;                            // 0x0800(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
	TMulticastInlineDelegate<void(class UObject* Item, bool bIsHovered)> BP_OnItemIsHoveredChanged;                         // 0x0810(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
	TMulticastInlineDelegate<void(class UObject* Item, bool bIsSelected)> BP_OnItemSelectionChanged;                         // 0x0820(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
	TMulticastInlineDelegate<void(class UObject* Item, class UUserWidget* Widget)> BP_OnItemScrolledIntoView;                         // 0x0830(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UListView) == 0x000840, "Wrong size on UListView");
static_assert(offsetof(UListView, ScrollBarStyle) == 0x0002E0, "Member 'UListView::ScrollBarStyle' has a wrong offset!");
static_assert(offsetof(UListView, Orientation) == 0x0007B0, "Member 'UListView::Orientation' has a wrong offset!");
static_assert(offsetof(UListView, SelectionMode) == 0x0007B1, "Member 'UListView::SelectionMode' has a wrong offset!");
static_assert(offsetof(UListView, ConsumeMouseWheel) == 0x0007B2, "Member 'UListView::ConsumeMouseWheel' has a wrong offset!");
static_assert(offsetof(UListView, bClearSelectionOnClick) == 0x0007B3, "Member 'UListView::bClearSelectionOnClick' has a wrong offset!");
static_assert(offsetof(UListView, bIsFocusable) == 0x0007B4, "Member 'UListView::bIsFocusable' has a wrong offset!");
static_assert(offsetof(UListView, EntrySpacing) == 0x0007B8, "Member 'UListView::EntrySpacing' has a wrong offset!");
static_assert(offsetof(UListView, bReturnFocusToSelection) == 0x0007BC, "Member 'UListView::bReturnFocusToSelection' has a wrong offset!");
static_assert(offsetof(UListView, ListItems) == 0x0007C0, "Member 'UListView::ListItems' has a wrong offset!");
static_assert(offsetof(UListView, BP_OnEntryInitialized) == 0x0007E0, "Member 'UListView::BP_OnEntryInitialized' has a wrong offset!");
static_assert(offsetof(UListView, BP_OnItemClicked) == 0x0007F0, "Member 'UListView::BP_OnItemClicked' has a wrong offset!");
static_assert(offsetof(UListView, BP_OnItemDoubleClicked) == 0x000800, "Member 'UListView::BP_OnItemDoubleClicked' has a wrong offset!");
static_assert(offsetof(UListView, BP_OnItemIsHoveredChanged) == 0x000810, "Member 'UListView::BP_OnItemIsHoveredChanged' has a wrong offset!");
static_assert(offsetof(UListView, BP_OnItemSelectionChanged) == 0x000820, "Member 'UListView::BP_OnItemSelectionChanged' has a wrong offset!");
static_assert(offsetof(UListView, BP_OnItemScrolledIntoView) == 0x000830, "Member 'UListView::BP_OnItemScrolledIntoView' has a wrong offset!");
...
public:
	...
	struct FUserWidgetPool                        EntryWidgetPool;                                   // 0x0158(0x0088)(Transient, ContainsInstancedReference, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UDynamicEntryBoxBase) == 0x0001E0, "Wrong size on UDynamicEntryBoxBase");
...
public:
	...
	bool                                          BackPadScrolling;                                  // 0x0847(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          FrontPadScrolling;                                 // 0x0848(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAnimateWheelScrolling;                            // 0x0849(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EDescendantScrollDestination                  NavigationDestination;                             // 0x084A(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UScrollBox, BackPadScrolling) == 0x000847, "Member 'UScrollBox::BackPadScrolling' has a wrong offset!");
static_assert(offsetof(UScrollBox, FrontPadScrolling) == 0x000848, "Member 'UScrollBox::FrontPadScrolling' has a wrong offset!");
static_assert(offsetof(UScrollBox, bAnimateWheelScrolling) == 0x000849, "Member 'UScrollBox::bAnimateWheelScrolling' has a wrong offset!");
static_assert(offsetof(UScrollBox, NavigationDestination) == 0x00084A, "Member 'UScrollBox::NavigationDestination' has a wrong offset!");
...
{
public:
	float                                         EntryHeight;                                       // 0x0840(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         EntryWidth;                                        // 0x0844(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EListItemAlignment                            TileAlignment;                                     // 0x0848(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bWrapHorizontalNavigation;                         // 0x0849(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_84A[0x16];                                     // 0x084A(0x0016)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UTileView) == 0x000860, "Wrong size on UTileView");
static_assert(offsetof(UTileView, EntryHeight) == 0x000840, "Member 'UTileView::EntryHeight' has a wrong offset!");
static_assert(offsetof(UTileView, EntryWidth) == 0x000844, "Member 'UTileView::EntryWidth' has a wrong offset!");
static_assert(offsetof(UTileView, TileAlignment) == 0x000848, "Member 'UTileView::TileAlignment' has a wrong offset!");
static_assert(offsetof(UTileView, bWrapHorizontalNavigation) == 0x000849, "Member 'UTileView::bWrapHorizontalNavigation' has a wrong offset!");
...
public:
	...
	TDelegate<void(class UObject* Item, TArray<class UObject*>* Children)> BP_OnGetItemChildren;                              // 0x0850(0x0010)(Edit, ZeroConstructor, InstancedReference, NoDestructor, NativeAccessSpecifierPrivate)
	TMulticastInlineDelegate<void(class UObject* Item, bool bIsExpanded)> BP_OnItemExpansionChanged;                         // 0x0860(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
	uint8                                         Pad_870[0x28];                                     // 0x0870(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UTreeView) == 0x000898, "Wrong size on UTreeView");
static_assert(offsetof(UTreeView, BP_OnGetItemChildren) == 0x000850, "Member 'UTreeView::BP_OnGetItemChildren' has a wrong offset!");
static_assert(offsetof(UTreeView, BP_OnItemExpansionChanged) == 0x000860, "Member 'UTreeView::BP_OnItemExpansionChanged' has a wrong offset!");
...
static_assert(offsetof(UWidgetComponent, Space) == 0x000470, "Member 'UWidgetComponent::Space' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, TimingPolicy) == 0x000471, "Member 'UWidgetComponent::TimingPolicy' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, WidgetClass) == 0x000478, "Member 'UWidgetComponent::WidgetClass' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, DrawSize) == 0x000480, "Member 'UWidgetComponent::DrawSize' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bManuallyRedraw) == 0x000488, "Member 'UWidgetComponent::bManuallyRedraw' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bRedrawRequested) == 0x000489, "Member 'UWidgetComponent::bRedrawRequested' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, RedrawTime) == 0x00048C, "Member 'UWidgetComponent::RedrawTime' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, CurrentDrawSize) == 0x000498, "Member 'UWidgetComponent::CurrentDrawSize' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bDrawAtDesiredSize) == 0x0004A0, "Member 'UWidgetComponent::bDrawAtDesiredSize' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, Pivot) == 0x0004A4, "Member 'UWidgetComponent::Pivot' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bReceiveHardwareInput) == 0x0004AC, "Member 'UWidgetComponent::bReceiveHardwareInput' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bWindowFocusable) == 0x0004AD, "Member 'UWidgetComponent::bWindowFocusable' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, WindowVisibility) == 0x0004AE, "Member 'UWidgetComponent::WindowVisibility' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bApplyGammaCorrection) == 0x0004AF, "Member 'UWidgetComponent::bApplyGammaCorrection' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, OwnerPlayer) == 0x0004B0, "Member 'UWidgetComponent::OwnerPlayer' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, BackgroundColor) == 0x0004B8, "Member 'UWidgetComponent::BackgroundColor' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, TintColorAndOpacity) == 0x0004C8, "Member 'UWidgetComponent::TintColorAndOpacity' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, OpacityFromTexture) == 0x0004D8, "Member 'UWidgetComponent::OpacityFromTexture' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, BlendMode) == 0x0004DC, "Member 'UWidgetComponent::BlendMode' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bIsTwoSided) == 0x0004DD, "Member 'UWidgetComponent::bIsTwoSided' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, TickWhenOffscreen) == 0x0004DE, "Member 'UWidgetComponent::TickWhenOffscreen' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, BodySetup) == 0x0004E0, "Member 'UWidgetComponent::BodySetup' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, TranslucentMaterial) == 0x0004E8, "Member 'UWidgetComponent::TranslucentMaterial' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, TranslucentMaterial_OneSided) == 0x0004F0, "Member 'UWidgetComponent::TranslucentMaterial_OneSided' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, OpaqueMaterial) == 0x0004F8, "Member 'UWidgetComponent::OpaqueMaterial' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, OpaqueMaterial_OneSided) == 0x000500, "Member 'UWidgetComponent::OpaqueMaterial_OneSided' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, MaskedMaterial) == 0x000508, "Member 'UWidgetComponent::MaskedMaterial' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, MaskedMaterial_OneSided) == 0x000510, "Member 'UWidgetComponent::MaskedMaterial_OneSided' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, RenderTarget) == 0x000518, "Member 'UWidgetComponent::RenderTarget' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, MaterialInstance) == 0x000520, "Member 'UWidgetComponent::MaterialInstance' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bAddedToScreen) == 0x000528, "Member 'UWidgetComponent::bAddedToScreen' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bEditTimeUsable) == 0x000529, "Member 'UWidgetComponent::bEditTimeUsable' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, SharedLayerName) == 0x00052C, "Member 'UWidgetComponent::SharedLayerName' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, LayerZOrder) == 0x000534, "Member 'UWidgetComponent::LayerZOrder' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, GeometryMode) == 0x000538, "Member 'UWidgetComponent::GeometryMode' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, CylinderArcAngle) == 0x00053C, "Member 'UWidgetComponent::CylinderArcAngle' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, TickMode) == 0x000540, "Member 'UWidgetComponent::TickMode' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, Widget) == 0x000568, "Member 'UWidgetComponent::Widget' has a wrong offset!");
...
{
public:
	TSubclassOf<class UUserWidget>                EntryWidgetClass;                                  // 0x01E0(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UDynamicEntryBox, EntryWidgetClass) == 0x0001E0, "Member 'UDynamicEntryBox::EntryWidgetClass' has a wrong offset!");
...
{
public:
	TMap<TWeakObjectPtr<class UUserWidget>, struct FSequenceTickManagerWidgetData> WeakUserWidgetData;                                // 0x0028(0x0050)(Transient, NativeAccessSpecifierPrivate)
...
{
public:
	class UWidgetTree*                            WidgetTree;                                        // 0x0330(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         bClassRequiresNativeTick : 1;                      // 0x0338(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
...
static_assert(sizeof(UWidgetBlueprintGeneratedClass) == 0x000370, "Wrong size on UWidgetBlueprintGeneratedClass");
...
public:
	...
	float                                         WrapSize;                                          // 0x0128(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bExplicitWrapSize;                                 // 0x012C(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EHorizontalAlignment                          HorizontalAlignment;                               // 0x012D(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EOrientation                                  Orientation;                                       // 0x012E(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_12F[0x11];                                     // 0x012F(0x0011)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UWrapBox, WrapSize) == 0x000128, "Member 'UWrapBox::WrapSize' has a wrong offset!");
static_assert(offsetof(UWrapBox, bExplicitWrapSize) == 0x00012C, "Member 'UWrapBox::bExplicitWrapSize' has a wrong offset!");
static_assert(offsetof(UWrapBox, HorizontalAlignment) == 0x00012D, "Member 'UWrapBox::HorizontalAlignment' has a wrong offset!");
static_assert(offsetof(UWrapBox, Orientation) == 0x00012E, "Member 'UWrapBox::Orientation' has a wrong offset!");
