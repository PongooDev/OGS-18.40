...
public:
	...
	class UCommonButtonLegacy*                    K2Node_ComponentBoundEvent_Button_2;               // 0x0020(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UCommonButtonLegacy*                    K2Node_ComponentBoundEvent_Button_1;               // 0x0028(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
{
public:
	bool                                          CallFunc_ShouldShowVideo_ReturnValue;              // 0x0000(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_1[0x7];                                        // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UFortGlobalUIContext*                   CallFunc_GetContext_ReturnValue;                   // 0x0008(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class ULegacy_MovieWidget_C*                  K2Node_DynamicCast_AsLegacy_Movie_Widget;          // 0x0010(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(FireModeSelectTile_C_PlayMovie) == 0x000020, "Wrong size on FireModeSelectTile_C_PlayMovie");
static_assert(offsetof(FireModeSelectTile_C_PlayMovie, CallFunc_ShouldShowVideo_ReturnValue) == 0x000000, "Member 'FireModeSelectTile_C_PlayMovie::CallFunc_ShouldShowVideo_ReturnValue' has a wrong offset!");
static_assert(offsetof(FireModeSelectTile_C_PlayMovie, CallFunc_GetContext_ReturnValue) == 0x000008, "Member 'FireModeSelectTile_C_PlayMovie::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(FireModeSelectTile_C_PlayMovie, K2Node_DynamicCast_AsLegacy_Movie_Widget) == 0x000010, "Member 'FireModeSelectTile_C_PlayMovie::K2Node_DynamicCast_AsLegacy_Movie_Widget' has a wrong offset!");
static_assert(offsetof(FireModeSelectTile_C_PlayMovie, K2Node_DynamicCast_bSuccess) == 0x000018, "Member 'FireModeSelectTile_C_PlayMovie::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(FireModeSelectTile_C_PlayMovie, CallFunc_IsInZone_ReturnValue) == 0x000019, "Member 'FireModeSelectTile_C_PlayMovie::CallFunc_IsInZone_ReturnValue' has a wrong offset!");
static_assert(offsetof(FireModeSelectTile_C_PlayMovie, CallFunc_IsValid_ReturnValue) == 0x00001A, "Member 'FireModeSelectTile_C_PlayMovie::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(FireModeSelectTile_C_StopMovie) == 0x000018, "Wrong size on FireModeSelectTile_C_StopMovie");
static_assert(offsetof(FireModeSelectTile_C_StopMovie, CallFunc_ShouldShowVideo_ReturnValue) == 0x000000, "Member 'FireModeSelectTile_C_StopMovie::CallFunc_ShouldShowVideo_ReturnValue' has a wrong offset!");
static_assert(offsetof(FireModeSelectTile_C_StopMovie, K2Node_DynamicCast_AsLegacy_Movie_Widget) == 0x000008, "Member 'FireModeSelectTile_C_StopMovie::K2Node_DynamicCast_AsLegacy_Movie_Widget' has a wrong offset!");
static_assert(offsetof(FireModeSelectTile_C_StopMovie, K2Node_DynamicCast_bSuccess) == 0x000010, "Member 'FireModeSelectTile_C_StopMovie::K2Node_DynamicCast_bSuccess' has a wrong offset!");
...
public:
	...
	bool                                          CallFunc_ShouldShowVideo_ReturnValue;              // 0x0029(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(offsetof(FireModeSelectTile_C_HandleSelectionBorderFeedback, CallFunc_ShouldShowVideo_ReturnValue) == 0x000029, "Member 'FireModeSelectTile_C_HandleSelectionBorderFeedback::CallFunc_ShouldShowVideo_ReturnValue' has a wrong offset!");
static_assert(offsetof(FireModeSelectTile_C_HandleSelectionBorderFeedback, Temp_bool_Variable) == 0x00002A, "Member 'FireModeSelectTile_C_HandleSelectionBorderFeedback::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(FireModeSelectTile_C_HandleSelectionBorderFeedback, CallFunc_BooleanAND_ReturnValue_1) == 0x00002B, "Member 'FireModeSelectTile_C_HandleSelectionBorderFeedback::CallFunc_BooleanAND_ReturnValue_1' has a wrong offset!");
