...
static_assert(sizeof(UGA_Exit_SpookyMist_C) == 0x000AF0, "Wrong size on UGA_Exit_SpookyMist_C");
static_assert(offsetof(UGA_Exit_SpookyMist_C, UberGraphFrame) == 0x000AA8, "Member 'UGA_Exit_SpookyMist_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGA_Exit_SpookyMist_C, PlayerPawn) == 0x000AB0, "Member 'UGA_Exit_SpookyMist_C::PlayerPawn' has a wrong offset!");
static_assert(offsetof(UGA_Exit_SpookyMist_C, ExitRecovery) == 0x000AB8, "Member 'UGA_Exit_SpookyMist_C::ExitRecovery' has a wrong offset!");
static_assert(offsetof(UGA_Exit_SpookyMist_C, DelayExit) == 0x000AC0, "Member 'UGA_Exit_SpookyMist_C::DelayExit' has a wrong offset!");
static_assert(offsetof(UGA_Exit_SpookyMist_C, SpookyHolster) == 0x000AE8, "Member 'UGA_Exit_SpookyMist_C::SpookyHolster' has a wrong offset!");
