...
public:
	...
	bool                                          bAuthRequired;                                     // 0x0254(0x0001)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_255[0x3];                                      // 0x0255(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	uint32                                        MaxAuthTokenSize;                                  // 0x0258(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_25C[0x54];                                     // 0x025C(0x0054)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class AOnlineBeaconClient*>            ClientActors;                                      // 0x02B0(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(AOnlineBeaconHost) == 0x000360, "Wrong size on AOnlineBeaconHost");
static_assert(offsetof(AOnlineBeaconHost, ListenPort) == 0x000250, "Member 'AOnlineBeaconHost::ListenPort' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconHost, bAuthRequired) == 0x000254, "Member 'AOnlineBeaconHost::bAuthRequired' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconHost, MaxAuthTokenSize) == 0x000258, "Member 'AOnlineBeaconHost::MaxAuthTokenSize' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconHost, ClientActors) == 0x0002B0, "Member 'AOnlineBeaconHost::ClientActors' has a wrong offset!");
...
{
public:
	uint8                                         Pad_3178[0x50];                                    // 0x3178(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         SocketErrorDisconnectDelay;                        // 0x31C8(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_31CC[0x54];                                    // 0x31CC(0x0054)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UIpConnection) == 0x003220, "Wrong size on UIpConnection");
static_assert(offsetof(UIpConnection, SocketErrorDisconnectDelay) == 0x0031C8, "Member 'UIpConnection::SocketErrorDisconnectDelay' has a wrong offset!");
