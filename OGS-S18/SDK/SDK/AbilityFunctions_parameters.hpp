...
public:
	...
	struct FFortAbilityTargetSelection            CallFunc_Array_Get_Item;                           // 0x00D0(0x0118)()
	float                                         CallFunc_GetValueAtLevel_ReturnValue;              // 0x01E8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(AbilityFunctions_C_GetRangeFromGameplayEffectContainerSpec) == 0x0001F0, "Wrong size on AbilityFunctions_C_GetRangeFromGameplayEffectContainerSpec");
...
static_assert(offsetof(AbilityFunctions_C_GetRangeFromGameplayEffectContainerSpec, CallFunc_GetValueAtLevel_ReturnValue) == 0x0001E8, "Member 'AbilityFunctions_C_GetRangeFromGameplayEffectContainerSpec::CallFunc_GetValueAtLevel_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(AbilityFunctions_C_GetRangeFromGameplayEffectContainer) == 0x0001F0, "Wrong size on AbilityFunctions_C_GetRangeFromGameplayEffectContainer");
...
static_assert(offsetof(AbilityFunctions_C_GetRangeFromGameplayEffectContainer, CallFunc_GetValueAtLevel_ReturnValue) == 0x0001E8, "Member 'AbilityFunctions_C_GetRangeFromGameplayEffectContainer::CallFunc_GetValueAtLevel_ReturnValue' has a wrong offset!");
...
public:
	...
	bool                                          Owns_T02;                                          // 0x0050(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          Should_Override_T01;                               // 0x0051(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
