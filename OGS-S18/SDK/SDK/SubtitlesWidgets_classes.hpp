...
public:
	...
	struct FTextBlockStyle                        GeneratedStyle;                                    // 0x0138(0x0270)(Transient, NativeAccessSpecifierPrivate)
	struct FSlateBrush                            GeneratedBackgroundBorder;                         // 0x03A8(0x0088)(Transient, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(USubtitleDisplay) == 0x000440, "Wrong size on USubtitleDisplay");
...
static_assert(offsetof(USubtitleDisplay, GeneratedBackgroundBorder) == 0x0003A8, "Member 'USubtitleDisplay::GeneratedBackgroundBorder' has a wrong offset!");
...
public:
	...
	struct FSlateBrush                            BackgroundBrush;                                   // 0x00E0(0x0088)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USubtitleDisplayOptions) == 0x000168, "Wrong size on USubtitleDisplayOptions");
