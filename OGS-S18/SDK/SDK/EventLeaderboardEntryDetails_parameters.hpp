...
public:
	...
	struct FFortTournamentDisplayInfo             K2Node_CustomEvent_TournamentDisplayInfo;          // 0x0008(0x01B8)()
	...
	class UFortGlobalUIContext*                   CallFunc_GetContext_ReturnValue;                   // 0x01D0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsUsingGamepad_ReturnValue;               // 0x01D8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class UOverlaySlot*                           CallFunc_SlotAsOverlaySlot_ReturnValue;            // 0x01E8(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UEventLeaderboardDetails_Stat_C*        K2Node_DynamicCast_AsEvent_Leaderboard_Details_Stat; // 0x01F0(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UCommonButtonLegacy*                    K2Node_ComponentBoundEvent_Button_5;               // 0x0208(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UUMGSequencePlayer*                     CallFunc_PlayAnimationTimeRange_ReturnValue_1;     // 0x0228(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UEventPlayerStatProfileSelector_C*      CallFunc_Create_ReturnValue;                       // 0x0230(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UAthenaStatsTab_C*                      CallFunc_Create_ReturnValue_1;                     // 0x0238(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TArray<class FString>                         CallFunc_GetTeammateDisplayNames_DisplayNames;     // 0x0240(0x0010)(ReferenceParm)
	class FString                                 CallFunc_GetTeamAccountId_ReturnValue;             // 0x0250(0x0010)(ConstParm, ZeroConstructor, HasGetValueTypeHash)
	...
	int32                                         CallFunc_GetNumTeammates_ReturnValue;              // 0x0288(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_EqualEqual_IntInt_ReturnValue;            // 0x028C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_28D[0x3];                                      // 0x028D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector4                               CallFunc_GetSafeZonePadding_SafePadding;           // 0x0290(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector2D                              CallFunc_GetSafeZonePadding_SafePaddingScale;      // 0x02A0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_2A8[0x8];                                      // 0x02A8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector4                               CallFunc_GetSafeZonePadding_SpillOverPadding;      // 0x02B0(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_BreakVector2D_X;                          // 0x02C0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_BreakVector2D_Y;                          // 0x02C4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UFortRuntimeOptions*                    CallFunc_GetRuntimeOptions_ReturnValue_1;          // 0x0308(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UCommonButtonLegacy*                    K2Node_ComponentBoundEvent_Button_4;               // 0x0310(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UCommonButtonLegacy*                    K2Node_ComponentBoundEvent_Button_3;               // 0x0318(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          Temp_bool_Variable;                                // 0x0320(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_321[0x7];                                      // 0x0321(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UUMGSequencePlayer*                     CallFunc_PlayAnimationReverse_ReturnValue;         // 0x0328(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector2D                              CallFunc_MakeVector2D_ReturnValue;                 // 0x033C(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_344[0x4];                                      // 0x0344(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FFontOutlineSettings                   K2Node_MakeStruct_FontOutlineSettings;             // 0x0348(0x0020)(NoDestructor, HasGetValueTypeHash)
	struct FSlateFontInfo                         K2Node_MakeStruct_SlateFontInfo;                   // 0x0368(0x0058)(HasGetValueTypeHash)
	struct FSlateColor                            K2Node_MakeStruct_SlateColor;                      // 0x03C0(0x0028)()
	struct FSlateColor                            K2Node_MakeStruct_SlateColor_1;                    // 0x03E8(0x0028)()
	class UCommonButtonLegacy*                    K2Node_ComponentBoundEvent_Button_2;               // 0x0410(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UCommonButtonLegacy*                    K2Node_ComponentBoundEvent_Button_1;               // 0x0418(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UCommonButtonLegacy*                    K2Node_ComponentBoundEvent_Button;                 // 0x0420(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class APlayerController*                      CallFunc_GetOwningPlayer_ReturnValue_1;            // 0x0428(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UUMGSequencePlayer*                     CallFunc_PlayAnimationReverse_ReturnValue_1;       // 0x0430(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UEventTeamMatchHistoryModal_C*          CallFunc_Create_ReturnValue_2;                     // 0x0438(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UUMGSequencePlayer*                     CallFunc_PlayAnimationForward_ReturnValue_1;       // 0x0440(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         K2Node_Select_Default_1;                           // 0x0454(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails) == 0x000460, "Wrong size on EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails");
...
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_GetDynamicMaterial_ReturnValue) == 0x0001C0, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_GetDynamicMaterial_ReturnValue' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_Add_FloatFloat_ReturnValue) == 0x0001C8, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_Add_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, Temp_int_Variable) == 0x0001CC, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::Temp_int_Variable' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_GetContext_ReturnValue) == 0x0001D0, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_IsUsingGamepad_ReturnValue) == 0x0001D8, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_IsUsingGamepad_ReturnValue' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_Add_IntInt_ReturnValue) == 0x0001DC, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_GetChildAt_ReturnValue) == 0x0001E0, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_GetChildAt_ReturnValue' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_SlotAsOverlaySlot_ReturnValue) == 0x0001E8, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_SlotAsOverlaySlot_ReturnValue' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, K2Node_DynamicCast_AsEvent_Leaderboard_Details_Stat) == 0x0001F0, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::K2Node_DynamicCast_AsEvent_Leaderboard_Details_Stat' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, K2Node_DynamicCast_bSuccess) == 0x0001F8, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_GetChildrenCount_ReturnValue) == 0x0001FC, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_GetChildrenCount_ReturnValue' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, Temp_float_Variable) == 0x000200, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::Temp_float_Variable' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_LessEqual_IntInt_ReturnValue) == 0x000204, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_LessEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, K2Node_ComponentBoundEvent_Button_5) == 0x000208, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::K2Node_ComponentBoundEvent_Button_5' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_PlayAnimationTimeRange_ReturnValue) == 0x000210, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_PlayAnimationTimeRange_ReturnValue' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_GetEndTime_ReturnValue) == 0x000218, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_GetEndTime_ReturnValue' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_GetOwningPlayer_ReturnValue) == 0x000220, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_GetOwningPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_PlayAnimationTimeRange_ReturnValue_1) == 0x000228, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_PlayAnimationTimeRange_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_Create_ReturnValue) == 0x000230, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_Create_ReturnValue' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_Create_ReturnValue_1) == 0x000238, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_Create_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_GetTeammateDisplayNames_DisplayNames) == 0x000240, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_GetTeammateDisplayNames_DisplayNames' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_GetTeamAccountId_ReturnValue) == 0x000250, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_GetTeamAccountId_ReturnValue' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_Array_Get_Item) == 0x000260, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_Conv_StringToText_ReturnValue) == 0x000270, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_Conv_StringToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_GetNumTeammates_ReturnValue) == 0x000288, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_GetNumTeammates_ReturnValue' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x00028C, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_GetSafeZonePadding_SafePadding) == 0x000290, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_GetSafeZonePadding_SafePadding' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_GetSafeZonePadding_SafePaddingScale) == 0x0002A0, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_GetSafeZonePadding_SafePaddingScale' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_GetSafeZonePadding_SpillOverPadding) == 0x0002B0, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_GetSafeZonePadding_SpillOverPadding' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_BreakVector2D_X) == 0x0002C0, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_BreakVector2D_X' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_BreakVector2D_Y) == 0x0002C4, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_BreakVector2D_Y' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_Multiply_FloatFloat_ReturnValue) == 0x0002C8, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_Multiply_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_Multiply_FloatFloat_ReturnValue_1) == 0x0002CC, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_Multiply_FloatFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_Add_FloatFloat_ReturnValue_1) == 0x0002D0, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_Add_FloatFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_Subtract_FloatFloat_ReturnValue) == 0x0002D4, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_Subtract_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_Multiply_FloatFloat_ReturnValue_2) == 0x0002D8, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_Multiply_FloatFloat_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_Multiply_FloatFloat_ReturnValue_3) == 0x0002DC, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_Multiply_FloatFloat_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_Subtract_FloatFloat_ReturnValue_1) == 0x0002E0, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_Subtract_FloatFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_Subtract_FloatFloat_ReturnValue_2) == 0x0002E4, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_Subtract_FloatFloat_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_Multiply_FloatFloat_ReturnValue_4) == 0x0002E8, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_Multiply_FloatFloat_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_Subtract_FloatFloat_ReturnValue_3) == 0x0002EC, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_Subtract_FloatFloat_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, K2Node_MakeStruct_Margin) == 0x0002F0, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::K2Node_MakeStruct_Margin' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_GetRuntimeOptions_ReturnValue) == 0x000300, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_GetRuntimeOptions_ReturnValue' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_GetRuntimeOptions_ReturnValue_1) == 0x000308, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_GetRuntimeOptions_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, K2Node_ComponentBoundEvent_Button_4) == 0x000310, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::K2Node_ComponentBoundEvent_Button_4' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, K2Node_ComponentBoundEvent_Button_3) == 0x000318, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::K2Node_ComponentBoundEvent_Button_3' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, Temp_bool_Variable) == 0x000320, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_PlayAnimationReverse_ReturnValue) == 0x000328, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_PlayAnimationReverse_ReturnValue' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_PlayAnimationForward_ReturnValue) == 0x000330, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_PlayAnimationForward_ReturnValue' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, K2Node_Select_Default) == 0x000338, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_MakeVector2D_ReturnValue) == 0x00033C, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_MakeVector2D_ReturnValue' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, K2Node_MakeStruct_FontOutlineSettings) == 0x000348, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::K2Node_MakeStruct_FontOutlineSettings' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, K2Node_MakeStruct_SlateFontInfo) == 0x000368, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::K2Node_MakeStruct_SlateFontInfo' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, K2Node_MakeStruct_SlateColor) == 0x0003C0, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::K2Node_MakeStruct_SlateColor' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, K2Node_MakeStruct_SlateColor_1) == 0x0003E8, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::K2Node_MakeStruct_SlateColor_1' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, K2Node_ComponentBoundEvent_Button_2) == 0x000410, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::K2Node_ComponentBoundEvent_Button_2' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, K2Node_ComponentBoundEvent_Button_1) == 0x000418, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::K2Node_ComponentBoundEvent_Button_1' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, K2Node_ComponentBoundEvent_Button) == 0x000420, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::K2Node_ComponentBoundEvent_Button' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_GetOwningPlayer_ReturnValue_1) == 0x000428, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_GetOwningPlayer_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_PlayAnimationReverse_ReturnValue_1) == 0x000430, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_PlayAnimationReverse_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_Create_ReturnValue_2) == 0x000438, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_Create_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, CallFunc_PlayAnimationForward_ReturnValue_1) == 0x000440, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::CallFunc_PlayAnimationForward_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, Temp_float_Variable_1) == 0x000448, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::Temp_float_Variable_1' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, Temp_float_Variable_2) == 0x00044C, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::Temp_float_Variable_2' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, Temp_bool_Variable_1) == 0x000450, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::Temp_bool_Variable_1' has a wrong offset!");
static_assert(offsetof(EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails, K2Node_Select_Default_1) == 0x000454, "Member 'EventLeaderboardEntryDetails_C_ExecuteUbergraph_EventLeaderboardEntryDetails::K2Node_Select_Default_1' has a wrong offset!");
...
{
public:
	struct FFortTournamentDisplayInfo             TournamentDisplayInfo;                             // 0x0000(0x01B8)(BlueprintVisible, BlueprintReadOnly, Parm)
};
...
static_assert(sizeof(EventLeaderboardEntryDetails_C_EventColorize) == 0x0001B8, "Wrong size on EventLeaderboardEntryDetails_C_EventColorize");
