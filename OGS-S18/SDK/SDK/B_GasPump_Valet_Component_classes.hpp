...
static_assert(sizeof(UB_GasPump_Valet_Component_C) == 0x0000D0, "Wrong size on UB_GasPump_Valet_Component_C");
...
static_assert(offsetof(UB_GasPump_Valet_Component_C, Gas_Pump_Icon_Enabled) == 0x0000B8, "Member 'UB_GasPump_Valet_Component_C::Gas_Pump_Icon_Enabled' has a wrong offset!");
static_assert(offsetof(UB_GasPump_Valet_Component_C, Gas_Pump_IndicatorManager_Class) == 0x0000C0, "Member 'UB_GasPump_Valet_Component_C::Gas_Pump_IndicatorManager_Class' has a wrong offset!");
static_assert(offsetof(UB_GasPump_Valet_Component_C, Gas_Pump_IndicatorManager) == 0x0000C8, "Member 'UB_GasPump_Valet_Component_C::Gas_Pump_IndicatorManager' has a wrong offset!");
