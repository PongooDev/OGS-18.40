...
static_assert(sizeof(UToastDisplayArea_C) == 0x000310, "Wrong size on UToastDisplayArea_C");
static_assert(offsetof(UToastDisplayArea_C, UberGraphFrame) == 0x000300, "Member 'UToastDisplayArea_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UToastDisplayArea_C, SafeZone_0) == 0x000308, "Member 'UToastDisplayArea_C::SafeZone_0' has a wrong offset!");
