...
// 0x0440 (0x06C8 - 0x0288)
struct FCommonInputActionData final : public FCommonInputActionDataBase
{
public:
	TMap<ECommonGamepadType, struct FCommonInputTypeInfo> GamepadInputTypeInfoOverrides;                     // 0x0288(0x0050)(Edit, Protected, NativeAccessSpecifierProtected)
	struct FCommonInputTypeInfo                   GamepadInputTypeInfos[0x6];                        // 0x02D8(0x00A8)(Deprecated, Protected, NativeAccessSpecifierProtected)
};
static_assert(alignof(FCommonInputActionData) == 0x000008, "Wrong alignment on FCommonInputActionData");
static_assert(sizeof(FCommonInputActionData) == 0x0006C8, "Wrong size on FCommonInputActionData");
static_assert(offsetof(FCommonInputActionData, GamepadInputTypeInfoOverrides) == 0x000288, "Member 'FCommonInputActionData::GamepadInputTypeInfoOverrides' has a wrong offset!");
static_assert(offsetof(FCommonInputActionData, GamepadInputTypeInfos) == 0x0002D8, "Member 'FCommonInputActionData::GamepadInputTypeInfos' has a wrong offset!");
