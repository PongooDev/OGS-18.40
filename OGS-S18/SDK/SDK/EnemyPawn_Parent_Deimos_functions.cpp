...
void AEnemyPawn_Parent_Deimos_C::OnWaterDeepNavMeshEnter()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("EnemyPawn_Parent_Deimos_C", "OnWaterDeepNavMeshEnter");
...
void AEnemyPawn_Parent_Deimos_C::OnBeginDeepWaterInteraction(const struct FVector& WaterSurfaceLocation, float WaterDepth)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("EnemyPawn_Parent_Deimos_C", "OnBeginDeepWaterInteraction");
...
void AEnemyPawn_Parent_Deimos_C::TriggerDeathFX()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("EnemyPawn_Parent_Deimos_C", "TriggerDeathFX");
...
void AEnemyPawn_Parent_Deimos_C::PlaySoundLibraryAudio(const struct FGameplayTag& Event_Name)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("EnemyPawn_Parent_Deimos_C", "PlaySoundLibraryAudio");
