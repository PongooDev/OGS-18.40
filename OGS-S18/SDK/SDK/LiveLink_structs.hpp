...
{
public:
	struct FAnimNode_LiveLinkPose                 PoseNode;                                          // 0x0760(0x0050)(Edit, NativeAccessSpecifierPublic)
};
...
static_assert(offsetof(FLiveLinkInstanceProxy, PoseNode) == 0x000760, "Member 'FLiveLinkInstanceProxy::PoseNode' has a wrong offset!");
