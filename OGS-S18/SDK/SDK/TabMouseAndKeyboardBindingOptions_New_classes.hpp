...
static_assert(sizeof(UTabMouseAndKeyboardBindingOptions_New_C) == 0x000398, "Wrong size on UTabMouseAndKeyboardBindingOptions_New_C");
static_assert(offsetof(UTabMouseAndKeyboardBindingOptions_New_C, UberGraphFrame) == 0x000390, "Member 'UTabMouseAndKeyboardBindingOptions_New_C::UberGraphFrame' has a wrong offset!");
