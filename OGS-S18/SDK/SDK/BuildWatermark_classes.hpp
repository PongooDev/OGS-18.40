...
static_assert(sizeof(UBuildWatermark_C) == 0x0002E8, "Wrong size on UBuildWatermark_C");
static_assert(offsetof(UBuildWatermark_C, UberGraphFrame) == 0x0002E0, "Member 'UBuildWatermark_C::UberGraphFrame' has a wrong offset!");
