...
bool ADownloadOnDemandDirector::CanShowRemoveButton()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("DownloadOnDemandDirector", "CanShowRemoveButton");

	Params::DownloadOnDemandDirector_CanShowRemoveButton Parms{};
...
bool ADownloadOnDemandDirector::LoadLinkCodeMetaData(const class FString& InLinkCode, const class FString& InProjectId, class AFortPlayerControllerAthena* InFortPlayerControllerAthena)
{
	static class UFunction* Func = nullptr;
