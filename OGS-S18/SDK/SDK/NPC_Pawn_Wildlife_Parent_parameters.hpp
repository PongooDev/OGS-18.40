...
public:
	...
	bool                                          CallFunc_NPC_CanBeInteractedWith_CanInteract;      // 0x0004(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_NPC_UpdateInteract_EnabledInteract;       // 0x0005(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	struct FHitResult                             K2Node_Event_HitInfo;                              // 0x00A4(0x0088)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	bool                                          K2Node_Event_Success_;                             // 0x0164(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_165[0x3];                                      // 0x0165(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class AActor*                                 K2Node_Event_Leader;                               // 0x0168(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_GetConsoleVariableIntValue_ReturnValue;   // 0x0170(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_HasAuthority_ReturnValue;                 // 0x0174(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_EqualEqual_IntInt_ReturnValue;            // 0x0175(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_176[0x2];                                      // 0x0176(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSoundLibraryPlaySoundResult           K2Node_ComponentBoundEvent_Results;                // 0x0178(0x0030)(ConstParm, ContainsInstancedReference)
	const class USoundLibraryContext*             K2Node_ComponentBoundEvent_Context;                // 0x01A8(0x0008)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_Event_bControlled;                          // 0x01B0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class UClass*                                 K2Node_ClassDynamicCast_AsAnim_Instance;           // 0x01C0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(NPC_Pawn_Wildlife_Parent_C_ExecuteUbergraph_NPC_Pawn_Wildlife_Parent) == 0x0001D8, "Wrong size on NPC_Pawn_Wildlife_Parent_C_ExecuteUbergraph_NPC_Pawn_Wildlife_Parent");
...
static_assert(offsetof(NPC_Pawn_Wildlife_Parent_C_ExecuteUbergraph_NPC_Pawn_Wildlife_Parent, CallFunc_NPC_CanBeInteractedWith_CanInteract) == 0x000004, "Member 'NPC_Pawn_Wildlife_Parent_C_ExecuteUbergraph_NPC_Pawn_Wildlife_Parent::CallFunc_NPC_CanBeInteractedWith_CanInteract' has a wrong offset!");
static_assert(offsetof(NPC_Pawn_Wildlife_Parent_C_ExecuteUbergraph_NPC_Pawn_Wildlife_Parent, CallFunc_NPC_UpdateInteract_EnabledInteract) == 0x000005, "Member 'NPC_Pawn_Wildlife_Parent_C_ExecuteUbergraph_NPC_Pawn_Wildlife_Parent::CallFunc_NPC_UpdateInteract_EnabledInteract' has a wrong offset!");
...
static_assert(offsetof(NPC_Pawn_Wildlife_Parent_C_ExecuteUbergraph_NPC_Pawn_Wildlife_Parent, K2Node_Event_InstigatedBy) == 0x000130, "Member 'NPC_Pawn_Wildlife_Parent_C_ExecuteUbergraph_NPC_Pawn_Wildlife_Parent::K2Node_Event_InstigatedBy' has a wrong offset!");
static_assert(offsetof(NPC_Pawn_Wildlife_Parent_C_ExecuteUbergraph_NPC_Pawn_Wildlife_Parent, K2Node_Event_DamageCauser) == 0x000138, "Member 'NPC_Pawn_Wildlife_Parent_C_ExecuteUbergraph_NPC_Pawn_Wildlife_Parent::K2Node_Event_DamageCauser' has a wrong offset!");
static_assert(offsetof(NPC_Pawn_Wildlife_Parent_C_ExecuteUbergraph_NPC_Pawn_Wildlife_Parent, K2Node_Event_EffectContext) == 0x000140, "Member 'NPC_Pawn_Wildlife_Parent_C_ExecuteUbergraph_NPC_Pawn_Wildlife_Parent::K2Node_Event_EffectContext' has a wrong offset!");
static_assert(offsetof(NPC_Pawn_Wildlife_Parent_C_ExecuteUbergraph_NPC_Pawn_Wildlife_Parent, CallFunc_K2_GetActorLocation_ReturnValue) == 0x000158, "Member 'NPC_Pawn_Wildlife_Parent_C_ExecuteUbergraph_NPC_Pawn_Wildlife_Parent::CallFunc_K2_GetActorLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(NPC_Pawn_Wildlife_Parent_C_ExecuteUbergraph_NPC_Pawn_Wildlife_Parent, K2Node_Event_Success_) == 0x000164, "Member 'NPC_Pawn_Wildlife_Parent_C_ExecuteUbergraph_NPC_Pawn_Wildlife_Parent::K2Node_Event_Success_' has a wrong offset!");
static_assert(offsetof(NPC_Pawn_Wildlife_Parent_C_ExecuteUbergraph_NPC_Pawn_Wildlife_Parent, K2Node_Event_Leader) == 0x000168, "Member 'NPC_Pawn_Wildlife_Parent_C_ExecuteUbergraph_NPC_Pawn_Wildlife_Parent::K2Node_Event_Leader' has a wrong offset!");
static_assert(offsetof(NPC_Pawn_Wildlife_Parent_C_ExecuteUbergraph_NPC_Pawn_Wildlife_Parent, CallFunc_GetConsoleVariableIntValue_ReturnValue) == 0x000170, "Member 'NPC_Pawn_Wildlife_Parent_C_ExecuteUbergraph_NPC_Pawn_Wildlife_Parent::CallFunc_GetConsoleVariableIntValue_ReturnValue' has a wrong offset!");
static_assert(offsetof(NPC_Pawn_Wildlife_Parent_C_ExecuteUbergraph_NPC_Pawn_Wildlife_Parent, CallFunc_HasAuthority_ReturnValue) == 0x000174, "Member 'NPC_Pawn_Wildlife_Parent_C_ExecuteUbergraph_NPC_Pawn_Wildlife_Parent::CallFunc_HasAuthority_ReturnValue' has a wrong offset!");
static_assert(offsetof(NPC_Pawn_Wildlife_Parent_C_ExecuteUbergraph_NPC_Pawn_Wildlife_Parent, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x000175, "Member 'NPC_Pawn_Wildlife_Parent_C_ExecuteUbergraph_NPC_Pawn_Wildlife_Parent::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(NPC_Pawn_Wildlife_Parent_C_ExecuteUbergraph_NPC_Pawn_Wildlife_Parent, K2Node_ComponentBoundEvent_Results) == 0x000178, "Member 'NPC_Pawn_Wildlife_Parent_C_ExecuteUbergraph_NPC_Pawn_Wildlife_Parent::K2Node_ComponentBoundEvent_Results' has a wrong offset!");
static_assert(offsetof(NPC_Pawn_Wildlife_Parent_C_ExecuteUbergraph_NPC_Pawn_Wildlife_Parent, K2Node_ComponentBoundEvent_Context) == 0x0001A8, "Member 'NPC_Pawn_Wildlife_Parent_C_ExecuteUbergraph_NPC_Pawn_Wildlife_Parent::K2Node_ComponentBoundEvent_Context' has a wrong offset!");
static_assert(offsetof(NPC_Pawn_Wildlife_Parent_C_ExecuteUbergraph_NPC_Pawn_Wildlife_Parent, K2Node_Event_bControlled) == 0x0001B0, "Member 'NPC_Pawn_Wildlife_Parent_C_ExecuteUbergraph_NPC_Pawn_Wildlife_Parent::K2Node_Event_bControlled' has a wrong offset!");
static_assert(offsetof(NPC_Pawn_Wildlife_Parent_C_ExecuteUbergraph_NPC_Pawn_Wildlife_Parent, Temp_class_Variable) == 0x0001B8, "Member 'NPC_Pawn_Wildlife_Parent_C_ExecuteUbergraph_NPC_Pawn_Wildlife_Parent::Temp_class_Variable' has a wrong offset!");
static_assert(offsetof(NPC_Pawn_Wildlife_Parent_C_ExecuteUbergraph_NPC_Pawn_Wildlife_Parent, K2Node_ClassDynamicCast_AsAnim_Instance) == 0x0001C0, "Member 'NPC_Pawn_Wildlife_Parent_C_ExecuteUbergraph_NPC_Pawn_Wildlife_Parent::K2Node_ClassDynamicCast_AsAnim_Instance' has a wrong offset!");
static_assert(offsetof(NPC_Pawn_Wildlife_Parent_C_ExecuteUbergraph_NPC_Pawn_Wildlife_Parent, K2Node_ClassDynamicCast_bSuccess) == 0x0001C8, "Member 'NPC_Pawn_Wildlife_Parent_C_ExecuteUbergraph_NPC_Pawn_Wildlife_Parent::K2Node_ClassDynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(NPC_Pawn_Wildlife_Parent_C_ExecuteUbergraph_NPC_Pawn_Wildlife_Parent, CallFunc_Not_PreBool_ReturnValue) == 0x0001C9, "Member 'NPC_Pawn_Wildlife_Parent_C_ExecuteUbergraph_NPC_Pawn_Wildlife_Parent::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(NPC_Pawn_Wildlife_Parent_C_ExecuteUbergraph_NPC_Pawn_Wildlife_Parent, K2Node_CustomEvent_Loaded) == 0x0001D0, "Member 'NPC_Pawn_Wildlife_Parent_C_ExecuteUbergraph_NPC_Pawn_Wildlife_Parent::K2Node_CustomEvent_Loaded' has a wrong offset!");
...
{
public:
	bool                                          bControlled;                                       // 0x0000(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
public:
	...
	bool                                          CallFunc_NPC_CanBeInteractedWith_CanInteract;      // 0x0001(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
{
public:
	bool                                          EnableTaming;                                      // 0x0000(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_NPC_CanBeInteractedWith_CanInteract;      // 0x0001(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
