...
public:
	...
	bool                                          CallFunc_HasPermissionToEditWorld_ReturnValue;     // 0x00B8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	bool                                          CallFunc_CanPlaceInstanceOfClass_ReturnValue;      // 0x00C8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
public:
	...
	bool                                          CallFunc_AcceptsEmoteSprays_ReturnValue;           // 0x01EA(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(GAB_Spray_Generic_C_TargetLineTrace) == 0x000208, "Wrong size on GAB_Spray_Generic_C_TargetLineTrace");
...
static_assert(offsetof(GAB_Spray_Generic_C_TargetLineTrace, CallFunc_IsValid_ReturnValue) == 0x0001D1, "Member 'GAB_Spray_Generic_C_TargetLineTrace::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(GAB_Spray_Generic_C_TargetLineTrace, CallFunc_HasMatchingGameplayTag_self_CastInput) == 0x0001D8, "Member 'GAB_Spray_Generic_C_TargetLineTrace::CallFunc_HasMatchingGameplayTag_self_CastInput' has a wrong offset!");
static_assert(offsetof(GAB_Spray_Generic_C_TargetLineTrace, CallFunc_HasMatchingGameplayTag_ReturnValue) == 0x0001E8, "Member 'GAB_Spray_Generic_C_TargetLineTrace::CallFunc_HasMatchingGameplayTag_ReturnValue' has a wrong offset!");
static_assert(offsetof(GAB_Spray_Generic_C_TargetLineTrace, CallFunc_Not_PreBool_ReturnValue) == 0x0001E9, "Member 'GAB_Spray_Generic_C_TargetLineTrace::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(GAB_Spray_Generic_C_TargetLineTrace, CallFunc_AcceptsEmoteSprays_ReturnValue) == 0x0001EA, "Member 'GAB_Spray_Generic_C_TargetLineTrace::CallFunc_AcceptsEmoteSprays_ReturnValue' has a wrong offset!");
static_assert(offsetof(GAB_Spray_Generic_C_TargetLineTrace, CallFunc_HasMatchingGameplayTag_self_CastInput_1) == 0x0001F0, "Member 'GAB_Spray_Generic_C_TargetLineTrace::CallFunc_HasMatchingGameplayTag_self_CastInput_1' has a wrong offset!");
static_assert(offsetof(GAB_Spray_Generic_C_TargetLineTrace, CallFunc_HasMatchingGameplayTag_ReturnValue_1) == 0x000200, "Member 'GAB_Spray_Generic_C_TargetLineTrace::CallFunc_HasMatchingGameplayTag_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(GAB_Spray_Generic_C_TargetLineTrace, CallFunc_BooleanAND_ReturnValue) == 0x000201, "Member 'GAB_Spray_Generic_C_TargetLineTrace::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(GAB_Spray_Generic_C_TargetLineTrace, CallFunc_Not_PreBool_ReturnValue_1) == 0x000202, "Member 'GAB_Spray_Generic_C_TargetLineTrace::CallFunc_Not_PreBool_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(GAB_Spray_Generic_C_TargetLineTrace, CallFunc_BooleanAND_ReturnValue_1) == 0x000203, "Member 'GAB_Spray_Generic_C_TargetLineTrace::CallFunc_BooleanAND_ReturnValue_1' has a wrong offset!");
