...
static_assert(sizeof(UTargetingSelectionTask_Trace) == 0x0000A8, "Wrong size on UTargetingSelectionTask_Trace");
...
static_assert(offsetof(UTargetingSelectionTask_Trace, DefaultTraceLength) == 0x000060, "Member 'UTargetingSelectionTask_Trace::DefaultTraceLength' has a wrong offset!");
static_assert(offsetof(UTargetingSelectionTask_Trace, DefaultSourceOffset) == 0x000088, "Member 'UTargetingSelectionTask_Trace::DefaultSourceOffset' has a wrong offset!");
static_assert(offsetof(UTargetingSelectionTask_Trace, ExplicitTraceDirection) == 0x000094, "Member 'UTargetingSelectionTask_Trace::ExplicitTraceDirection' has a wrong offset!");
...
static_assert(sizeof(UTargetingSelectionTask_AOE) == 0x0000A0, "Wrong size on UTargetingSelectionTask_AOE");
...
static_assert(offsetof(UTargetingSelectionTask_AOE, Radius) == 0x000048, "Member 'UTargetingSelectionTask_AOE::Radius' has a wrong offset!");
static_assert(offsetof(UTargetingSelectionTask_AOE, HalfHeight) == 0x000070, "Member 'UTargetingSelectionTask_AOE::HalfHeight' has a wrong offset!");
static_assert(offsetof(UTargetingSelectionTask_AOE, ComponentTag) == 0x000098, "Member 'UTargetingSelectionTask_AOE::ComponentTag' has a wrong offset!");
