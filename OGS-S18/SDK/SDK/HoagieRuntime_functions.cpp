...
class AController* AFortHoagieVehicle::GetKillerController() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortHoagieVehicle", "GetKillerController");

	Params::FortHoagieVehicle_GetKillerController Parms{};
