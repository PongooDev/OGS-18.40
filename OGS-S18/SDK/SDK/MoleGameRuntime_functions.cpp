...
void UMoleState_Gameplay::GetAllMoleFreshlyKilledGhosts(class UObject* WorldContext, TArray<class APlayerState*>* OutFreshlyKilledGhosts)
{
	static class UFunction* Func = nullptr;
...
bool UMoleState_Gameplay::IsEmergencyMeetingActive(class UObject* WorldContext)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("MoleState_Gameplay", "IsEmergencyMeetingActive");

	Params::MoleState_Gameplay_IsEmergencyMeetingActive Parms{};
...
bool UMoleState_Gameplay::RequestEmergencyMeeting(class UObject* WorldContext, const struct FMoleEmergencyMeetingData& MeetingData)
{
	static class UFunction* Func = nullptr;
...
int32 UMoleStateMachine::GetMoleRemainingSaboteurCount(class UObject* WorldContextObject)
{
	static class UFunction* Func = nullptr;
...
int32 UMoleStateMachine::GetMoleStartOfMatchPlayerCount(const class UObject* WorldContextObject)
{
	static class UFunction* Func = nullptr;
