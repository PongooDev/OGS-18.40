...
static_assert(sizeof(AGCN_Loop_Ice_Feet_Creative_C) == 0x000858, "Wrong size on AGCN_Loop_Ice_Feet_Creative_C");
static_assert(offsetof(AGCN_Loop_Ice_Feet_Creative_C, UberGraphFrame) == 0x000808, "Member 'AGCN_Loop_Ice_Feet_Creative_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_Ice_Feet_Creative_C, TargetPlayer) == 0x000810, "Member 'AGCN_Loop_Ice_Feet_Creative_C::TargetPlayer' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_Ice_Feet_Creative_C, SC_Footstep_Local) == 0x000818, "Member 'AGCN_Loop_Ice_Feet_Creative_C::SC_Footstep_Local' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_Ice_Feet_Creative_C, SC_Footstep_Remote) == 0x000820, "Member 'AGCN_Loop_Ice_Feet_Creative_C::SC_Footstep_Remote' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_Ice_Feet_Creative_C, SC_Collision) == 0x000828, "Member 'AGCN_Loop_Ice_Feet_Creative_C::SC_Collision' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_Ice_Feet_Creative_C, CollisionAudioComp) == 0x000830, "Member 'AGCN_Loop_Ice_Feet_Creative_C::CollisionAudioComp' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_Ice_Feet_Creative_C, SpawnedAudioComps) == 0x000838, "Member 'AGCN_Loop_Ice_Feet_Creative_C::SpawnedAudioComps' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_Ice_Feet_Creative_C, SC_OnJumpOrBeginFalling) == 0x000848, "Member 'AGCN_Loop_Ice_Feet_Creative_C::SC_OnJumpOrBeginFalling' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_Ice_Feet_Creative_C, SC_OnLand) == 0x000850, "Member 'AGCN_Loop_Ice_Feet_Creative_C::SC_OnLand' has a wrong offset!");
