...
public:
	...
	EJumpBoostPackState                           K2Node_Event_InPreviousState;                      // 0x00B8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	EJumpBoostPackState                           K2Node_Event_InCurrentState;                       // 0x00B9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AFortPlayerPawn*                        K2Node_CustomEvent_PreviousPawn;                   // 0x00D0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AFortPlayerPawn*                        K2Node_CustomEvent_NewPawn;                        // 0x00D8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AFortPlayerController*                  K2Node_DynamicCast_AsFort_Player_Controller_1;     // 0x0110(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess_1;                     // 0x0118(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_119[0x3];                                      // 0x0119(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void(struct FHitResult& Hit)>       K2Node_CreateDelegate_OutputDelegate_1;            // 0x011C(0x0010)(ZeroConstructor, NoDestructor)
	TDelegate<void(struct FHitResult& Hit)>       K2Node_CreateDelegate_OutputDelegate_2;            // 0x012C(0x0010)(ZeroConstructor, NoDestructor)
	bool                                          CallFunc_EqualEqual_GameplayTag_ReturnValue;       // 0x013C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_EqualEqual_GameplayTag_ReturnValue_1;     // 0x013D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_EqualEqual_GameplayTag_ReturnValue_2;     // 0x013E(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_BooleanOR_ReturnValue;                    // 0x013F(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_EqualEqual_GameplayTag_ReturnValue_3;     // 0x0140(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_141[0x3];                                      // 0x0141(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate_3;            // 0x0144(0x0010)(ZeroConstructor, NoDestructor)
	struct FHitResult                             K2Node_CustomEvent_Hit;                            // 0x0154(0x0088)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
...
static_assert(sizeof(GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack) == 0x0001F0, "Wrong size on GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack");
...
static_assert(offsetof(GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack, K2Node_Event_InPreviousState) == 0x0000B8, "Member 'GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack::K2Node_Event_InPreviousState' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack, K2Node_Event_InCurrentState) == 0x0000B9, "Member 'GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack::K2Node_Event_InCurrentState' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack, K2Node_CreateDelegate_OutputDelegate) == 0x0000BC, "Member 'GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x0000CC, "Member 'GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack, K2Node_CustomEvent_PreviousPawn) == 0x0000D0, "Member 'GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack::K2Node_CustomEvent_PreviousPawn' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack, K2Node_CustomEvent_NewPawn) == 0x0000D8, "Member 'GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack::K2Node_CustomEvent_NewPawn' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack, CallFunc_GetController_ReturnValue) == 0x0000E0, "Member 'GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack::CallFunc_GetController_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack, CallFunc_IsValid_ReturnValue) == 0x0000E8, "Member 'GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack, K2Node_DynamicCast_AsFort_Player_Controller) == 0x0000F0, "Member 'GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack::K2Node_DynamicCast_AsFort_Player_Controller' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack, K2Node_DynamicCast_bSuccess) == 0x0000F8, "Member 'GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack, CallFunc_GetController_ReturnValue_1) == 0x000100, "Member 'GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack::CallFunc_GetController_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack, CallFunc_IsValid_ReturnValue_1) == 0x000108, "Member 'GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack, K2Node_DynamicCast_AsFort_Player_Controller_1) == 0x000110, "Member 'GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack::K2Node_DynamicCast_AsFort_Player_Controller_1' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack, K2Node_DynamicCast_bSuccess_1) == 0x000118, "Member 'GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack, K2Node_CreateDelegate_OutputDelegate_1) == 0x00011C, "Member 'GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack, K2Node_CreateDelegate_OutputDelegate_2) == 0x00012C, "Member 'GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack::K2Node_CreateDelegate_OutputDelegate_2' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack, CallFunc_EqualEqual_GameplayTag_ReturnValue) == 0x00013C, "Member 'GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack::CallFunc_EqualEqual_GameplayTag_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack, CallFunc_EqualEqual_GameplayTag_ReturnValue_1) == 0x00013D, "Member 'GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack::CallFunc_EqualEqual_GameplayTag_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack, CallFunc_EqualEqual_GameplayTag_ReturnValue_2) == 0x00013E, "Member 'GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack::CallFunc_EqualEqual_GameplayTag_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack, CallFunc_BooleanOR_ReturnValue) == 0x00013F, "Member 'GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack, CallFunc_EqualEqual_GameplayTag_ReturnValue_3) == 0x000140, "Member 'GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack::CallFunc_EqualEqual_GameplayTag_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack, K2Node_CreateDelegate_OutputDelegate_3) == 0x000144, "Member 'GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack::K2Node_CreateDelegate_OutputDelegate_3' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack, K2Node_CustomEvent_Hit) == 0x000154, "Member 'GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack::K2Node_CustomEvent_Hit' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack, K2Node_CreateDelegate_OutputDelegate_4) == 0x0001DC, "Member 'GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack::K2Node_CreateDelegate_OutputDelegate_4' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack, CallFunc_BooleanAND_ReturnValue) == 0x0001EC, "Member 'GA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
...
{
public:
	struct FGameplayCueParameters                 CallFunc_MakeGameplayCueParameters_ReturnValue;    // 0x0000(0x00C0)(ContainsInstancedReference)
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate;              // 0x00C0(0x0010)(ZeroConstructor, NoDestructor)
	class AFortPlayerPawn*                        CallFunc_SetJumpHeight_Pawn_Out;                   // 0x00D0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_SetJumpHeight_Jump_Height;                // 0x00D8(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(GA_BoostJumpPack_C_HandleBoostJump) == 0x000008, "Wrong alignment on GA_BoostJumpPack_C_HandleBoostJump");
static_assert(sizeof(GA_BoostJumpPack_C_HandleBoostJump) == 0x0000E8, "Wrong size on GA_BoostJumpPack_C_HandleBoostJump");
...
static_assert(offsetof(GA_BoostJumpPack_C_HandleBoostJump, K2Node_CreateDelegate_OutputDelegate) == 0x0000C0, "Member 'GA_BoostJumpPack_C_HandleBoostJump::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_HandleBoostJump, CallFunc_SetJumpHeight_Pawn_Out) == 0x0000D0, "Member 'GA_BoostJumpPack_C_HandleBoostJump::CallFunc_SetJumpHeight_Pawn_Out' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_HandleBoostJump, CallFunc_SetJumpHeight_Jump_Height) == 0x0000D8, "Member 'GA_BoostJumpPack_C_HandleBoostJump::CallFunc_SetJumpHeight_Jump_Height' has a wrong offset!");
...
public:
	...
	TScriptInterface<class IGameplayTagAssetInterface> CallFunc_HasAnyMatchingGameplayTags_self_CastInput; // 0x0008(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_HasAnyMatchingGameplayTags_ReturnValue;   // 0x0018(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsSurfaceSwimming_ReturnValue;            // 0x0019(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	bool                                          CallFunc_IsSwimming_ReturnValue;                   // 0x001C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_MatchesTag_ReturnValue;                   // 0x001D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_Not_PreBool_ReturnValue_2;                // 0x001E(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsMovingOnGround_ReturnValue;             // 0x001F(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	bool                                          CallFunc_MatchesAnyTags_ReturnValue_1;             // 0x0031(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(GA_BoostJumpPack_C_ProcessTriggerData) == 0x000038, "Wrong size on GA_BoostJumpPack_C_ProcessTriggerData");
...
static_assert(offsetof(GA_BoostJumpPack_C_ProcessTriggerData, CallFunc_HasAnyMatchingGameplayTags_self_CastInput) == 0x000008, "Member 'GA_BoostJumpPack_C_ProcessTriggerData::CallFunc_HasAnyMatchingGameplayTags_self_CastInput' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ProcessTriggerData, CallFunc_HasAnyMatchingGameplayTags_ReturnValue) == 0x000018, "Member 'GA_BoostJumpPack_C_ProcessTriggerData::CallFunc_HasAnyMatchingGameplayTags_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ProcessTriggerData, CallFunc_IsSurfaceSwimming_ReturnValue) == 0x000019, "Member 'GA_BoostJumpPack_C_ProcessTriggerData::CallFunc_IsSurfaceSwimming_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ProcessTriggerData, CallFunc_Not_PreBool_ReturnValue) == 0x00001A, "Member 'GA_BoostJumpPack_C_ProcessTriggerData::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ProcessTriggerData, CallFunc_Not_PreBool_ReturnValue_1) == 0x00001B, "Member 'GA_BoostJumpPack_C_ProcessTriggerData::CallFunc_Not_PreBool_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ProcessTriggerData, CallFunc_IsSwimming_ReturnValue) == 0x00001C, "Member 'GA_BoostJumpPack_C_ProcessTriggerData::CallFunc_IsSwimming_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ProcessTriggerData, CallFunc_MatchesTag_ReturnValue) == 0x00001D, "Member 'GA_BoostJumpPack_C_ProcessTriggerData::CallFunc_MatchesTag_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ProcessTriggerData, CallFunc_Not_PreBool_ReturnValue_2) == 0x00001E, "Member 'GA_BoostJumpPack_C_ProcessTriggerData::CallFunc_Not_PreBool_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ProcessTriggerData, CallFunc_IsMovingOnGround_ReturnValue) == 0x00001F, "Member 'GA_BoostJumpPack_C_ProcessTriggerData::CallFunc_IsMovingOnGround_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ProcessTriggerData, CallFunc_Not_PreBool_ReturnValue_3) == 0x000020, "Member 'GA_BoostJumpPack_C_ProcessTriggerData::CallFunc_Not_PreBool_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ProcessTriggerData, CallFunc_BooleanAND_ReturnValue) == 0x000021, "Member 'GA_BoostJumpPack_C_ProcessTriggerData::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ProcessTriggerData, CallFunc_BooleanAND_ReturnValue_1) == 0x000022, "Member 'GA_BoostJumpPack_C_ProcessTriggerData::CallFunc_BooleanAND_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ProcessTriggerData, CallFunc_Subtract_IntInt_ReturnValue) == 0x000024, "Member 'GA_BoostJumpPack_C_ProcessTriggerData::CallFunc_Subtract_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ProcessTriggerData, CallFunc_Max_ReturnValue) == 0x000028, "Member 'GA_BoostJumpPack_C_ProcessTriggerData::CallFunc_Max_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ProcessTriggerData, CallFunc_Add_IntInt_ReturnValue) == 0x00002C, "Member 'GA_BoostJumpPack_C_ProcessTriggerData::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ProcessTriggerData, CallFunc_MatchesAnyTags_ReturnValue) == 0x000030, "Member 'GA_BoostJumpPack_C_ProcessTriggerData::CallFunc_MatchesAnyTags_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ProcessTriggerData, CallFunc_MatchesAnyTags_ReturnValue_1) == 0x000031, "Member 'GA_BoostJumpPack_C_ProcessTriggerData::CallFunc_MatchesAnyTags_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ProcessTriggerData, CallFunc_BooleanAND_ReturnValue_2) == 0x000032, "Member 'GA_BoostJumpPack_C_ProcessTriggerData::CallFunc_BooleanAND_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ProcessTriggerData, CallFunc_BooleanOR_ReturnValue) == 0x000033, "Member 'GA_BoostJumpPack_C_ProcessTriggerData::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_ProcessTriggerData, CallFunc_BooleanAND_ReturnValue_3) == 0x000034, "Member 'GA_BoostJumpPack_C_ProcessTriggerData::CallFunc_BooleanAND_ReturnValue_3' has a wrong offset!");
...
static_assert(sizeof(GA_BoostJumpPack_C_Handle_Jetpack_Equipped) == 0x0000D0, "Wrong size on GA_BoostJumpPack_C_Handle_Jetpack_Equipped");
...
public:
	...
	bool                                          CallFunc_MatchesTag_ReturnValue_1;                 // 0x0029(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsInGhostMode_ReturnValue;                // 0x002A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(offsetof(GA_BoostJumpPack_C_Reasons_To_Reset_on_Transition, CallFunc_MatchesTag_ReturnValue_1) == 0x000029, "Member 'GA_BoostJumpPack_C_Reasons_To_Reset_on_Transition::CallFunc_MatchesTag_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_C_Reasons_To_Reset_on_Transition, CallFunc_IsInGhostMode_ReturnValue) == 0x00002A, "Member 'GA_BoostJumpPack_C_Reasons_To_Reset_on_Transition::CallFunc_IsInGhostMode_ReturnValue' has a wrong offset!");
