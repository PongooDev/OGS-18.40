...
public:
	...
	TScriptInterface<class IFortScriptedObjectMovement_GridProviderInterface> GridProvider;                                      // 0x0010(0x0010)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, UObjectWrapper, NativeAccessSpecifierPublic)
...
struct alignas(0x08) FScriptedObjectMovement_Grid final
{
public:
	uint8                                         Pad_0[0x50];                                       // 0x0000(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                CellSize;                                          // 0x0050(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(FScriptedObjectMovement_Grid) == 0x000090, "Wrong size on FScriptedObjectMovement_Grid");
...
{
public:
	struct FTransform                             StartWorldTransform;                               // 0x0000(0x0030)(BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FTransform                             EndWorldTransform;                                 // 0x0030(0x0030)(BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	int32                                         MasterPathStartSplinePoint;                        // 0x0060(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         SubSplineStartPoint;                               // 0x0064(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MoveAtServerTimeSecs;                              // 0x0068(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_6C[0x4];                                       // 0x006C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class AFortScriptedObjectMovement_MovableObjectBase* PathTraveler;                                      // 0x0070(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_78[0x8];                                       // 0x0078(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTag                           MoveStyleTag;                                      // 0x0080(0x0008)(BlueprintVisible, BlueprintReadOnly, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bTeleport;                                         // 0x0088(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsSkipStep;                                       // 0x0089(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FScriptedObjectMovement_StaticPathStepData) == 0x000090, "Wrong size on FScriptedObjectMovement_StaticPathStepData");
...
static_assert(offsetof(FScriptedObjectMovement_StaticPathStepData, EndWorldTransform) == 0x000030, "Member 'FScriptedObjectMovement_StaticPathStepData::EndWorldTransform' has a wrong offset!");
static_assert(offsetof(FScriptedObjectMovement_StaticPathStepData, MasterPathStartSplinePoint) == 0x000060, "Member 'FScriptedObjectMovement_StaticPathStepData::MasterPathStartSplinePoint' has a wrong offset!");
static_assert(offsetof(FScriptedObjectMovement_StaticPathStepData, SubSplineStartPoint) == 0x000064, "Member 'FScriptedObjectMovement_StaticPathStepData::SubSplineStartPoint' has a wrong offset!");
static_assert(offsetof(FScriptedObjectMovement_StaticPathStepData, MoveAtServerTimeSecs) == 0x000068, "Member 'FScriptedObjectMovement_StaticPathStepData::MoveAtServerTimeSecs' has a wrong offset!");
static_assert(offsetof(FScriptedObjectMovement_StaticPathStepData, PathTraveler) == 0x000070, "Member 'FScriptedObjectMovement_StaticPathStepData::PathTraveler' has a wrong offset!");
static_assert(offsetof(FScriptedObjectMovement_StaticPathStepData, MoveStyleTag) == 0x000080, "Member 'FScriptedObjectMovement_StaticPathStepData::MoveStyleTag' has a wrong offset!");
static_assert(offsetof(FScriptedObjectMovement_StaticPathStepData, bTeleport) == 0x000088, "Member 'FScriptedObjectMovement_StaticPathStepData::bTeleport' has a wrong offset!");
static_assert(offsetof(FScriptedObjectMovement_StaticPathStepData, bIsSkipStep) == 0x000089, "Member 'FScriptedObjectMovement_StaticPathStepData::bIsSkipStep' has a wrong offset!");
...
public:
	...
	struct FVector                                TravelerBounds;                                    // 0x0044(0x000C)(Edit, ZeroConstructor, DisableEditOnTemplate, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FScriptedObjectMovement_StaticPathTravelerData) == 0x0000B0, "Wrong size on FScriptedObjectMovement_StaticPathTravelerData");
...
static_assert(offsetof(FScriptedObjectMovement_StaticPathTravelerData, TravelerBounds) == 0x000044, "Member 'FScriptedObjectMovement_StaticPathTravelerData::TravelerBounds' has a wrong offset!");
