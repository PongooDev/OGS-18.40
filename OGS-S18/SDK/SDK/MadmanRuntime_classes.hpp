...
static_assert(sizeof(AFortAthenaMutator_Madman) == 0x0006D0, "Wrong size on AFortAthenaMutator_Madman");
...
public:
	...
	class UObject*                                SpawnCampingDetectionConsumerObject;               // 0x04C0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(AFortAthenaMutator_SpawnCampingDetection) == 0x000518, "Wrong size on AFortAthenaMutator_SpawnCampingDetection");
...
static_assert(offsetof(AFortAthenaMutator_SpawnCampingDetection, SpawnCampingDetectionConsumerObject) == 0x0004C0, "Member 'AFortAthenaMutator_SpawnCampingDetection::SpawnCampingDetectionConsumerObject' has a wrong offset!");
...
{
public:
	float                                         StartingSpawnYawAngle;                             // 0x02A0(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AFortPoiVolume_Madman) == 0x0002A8, "Wrong size on AFortPoiVolume_Madman");
static_assert(offsetof(AFortPoiVolume_Madman, StartingSpawnYawAngle) == 0x0002A0, "Member 'AFortPoiVolume_Madman::StartingSpawnYawAngle' has a wrong offset!");
