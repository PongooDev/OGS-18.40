...
static_assert(sizeof(AAthenaFrontEndMiniMapManager_C) == 0x000458, "Wrong size on AAthenaFrontEndMiniMapManager_C");
static_assert(offsetof(AAthenaFrontEndMiniMapManager_C, DefaultSceneRoot) == 0x000450, "Member 'AAthenaFrontEndMiniMapManager_C::DefaultSceneRoot' has a wrong offset!");
