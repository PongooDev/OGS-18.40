...
static_assert(sizeof(FPhysicsImpactData) == 0x000020, "Wrong size on FPhysicsImpactData");
...
static_assert(offsetof(FPhysicsImpactData, PitchOutput) == 0x000008, "Member 'FPhysicsImpactData::PitchOutput' has a wrong offset!");
static_assert(offsetof(FPhysicsImpactData, Variations) == 0x000010, "Member 'FPhysicsImpactData::Variations' has a wrong offset!");
...
static_assert(sizeof(FPhysicsStateData) == 0x000058, "Wrong size on FPhysicsStateData");
...
static_assert(offsetof(FPhysicsStateData, PitchOutput) == 0x000010, "Member 'FPhysicsStateData::PitchOutput' has a wrong offset!");
static_assert(offsetof(FPhysicsStateData, CrossfadeInputSlow) == 0x000018, "Member 'FPhysicsStateData::CrossfadeInputSlow' has a wrong offset!");
static_assert(offsetof(FPhysicsStateData, SlowLoop) == 0x000030, "Member 'FPhysicsStateData::SlowLoop' has a wrong offset!");
static_assert(offsetof(FPhysicsStateData, CrossfadeInputFast) == 0x000038, "Member 'FPhysicsStateData::CrossfadeInputFast' has a wrong offset!");
static_assert(offsetof(FPhysicsStateData, FastLoop) == 0x000050, "Member 'FPhysicsStateData::FastLoop' has a wrong offset!");
