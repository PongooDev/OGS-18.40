...
public:
	...
	double                                        PlatformUserInviteCooldown;                        // 0x0170(0x0008)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	double                                        PrimaryUserInviteCooldown;                         // 0x0178(0x0008)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_180[0x70];                                     // 0x0180(0x0070)(Fixing Size After Last Property [ Dumper-7 ])
	class APartyBeaconClient*                     ReservationBeaconClient;                           // 0x01F0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1F8[0x8];                                      // 0x01F8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class ASpectatorBeaconClient*                 SpectatorBeaconClient;                             // 0x0200(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(USocialParty) == 0x000330, "Wrong size on USocialParty");
...
static_assert(offsetof(USocialParty, PlatformUserInviteCooldown) == 0x000170, "Member 'USocialParty::PlatformUserInviteCooldown' has a wrong offset!");
static_assert(offsetof(USocialParty, PrimaryUserInviteCooldown) == 0x000178, "Member 'USocialParty::PrimaryUserInviteCooldown' has a wrong offset!");
static_assert(offsetof(USocialParty, ReservationBeaconClient) == 0x0001F0, "Member 'USocialParty::ReservationBeaconClient' has a wrong offset!");
static_assert(offsetof(USocialParty, SpectatorBeaconClient) == 0x000200, "Member 'USocialParty::SpectatorBeaconClient' has a wrong offset!");
...
static_assert(sizeof(USocialUser) == 0x000180, "Wrong size on USocialUser");
